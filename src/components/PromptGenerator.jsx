...
2. Qué opción de texto en pantalla para los primeros 6 segundos prefiere:
   ...
   - Opción B (Generado por IA en Clip 1): El texto en pantalla va exclusivamente en el prompt del Clip 1 de 4s (tipo comienzo de documental cinematográfico), NO en el prompt de la Imagen 1 (que lleva 'no text'). Luego en edición el usuario baja la velocidad del Clip 1 y lo lleva a 6 segundos. El Clip 2 arranca en el timeline en el segundo 6 (00:06 - 00:16) y comienza inmediatamente con la voz narrativa en el segundo 6 de video.
...
[?OPCION_TEXTO_PANTALLA=CAPCUT_MANUAL]
  ...
  4. Prompt de Movimiento de Video con Audio Foley Integrado (en inglés para Omni Flash, estrictamente sin música ni voz / 'no music, no speech', con 'no text', comenzando obligatoriamente con el tiempo que cubre en formato (##:## - ##:##) y la orden en inglés "Create a video": "Clip 1 (00:00 - 00:04): Create a video [prompt...]", incluyendo obligatoriamente tiempo y lugar como referencia visual).
...
- Slogan Completo Oficial y Promesa en Párrafo Aparte Antes del Segundo 30 de Video (~segundos 20–30): Antes del segundo 30 de video (~segundos 20–30 de metraje), TODO el bloque del Slogan Completo (desde "En los próximos minutos..." hasta "...Aquí seguimos sus rastros.") DEBE COLOCARSE OBLIGATORIAMENTE EN UN PÁRRAFO APARTE dentro del guion de locución, estructurado internamente en tres partes secuenciales unificadas:
  ...
  [Párrafo 3 - Inicio de la historia principal]: Desarrollo cronológico y temático con micro-ganchos cada 90 segundos...).
...
- Regla Estricta de un Solo '@' por Cada Prompt de Referencia: En los prompts de imágenes modelo de referencia (Personas, Lugares y Objetos), SOLO PUEDE HABER UN ÚNICO SÍMBOLO '@' POR CADA PROMPT. Cada prompt modela exclusivamente un solo elemento (una sola persona, un solo lugar o un solo objeto). Queda terminantemente prohibido colocar múltiples '@' en un mismo prompt de referencia (ej. en el prompt del lugar '@Whitechapel', se escribe 'London, England' estrictamente sin '@'; en el prompt del personaje '@Jack The Ripper', se describe su vestimenta y entorno en 'Whitechapel, London' estrictamente sin '@'; en el prompt del objeto '@Scalpel', se describe sin añadir '@' a personas o lugares). Cada imagen modelo de referencia lleva única y exclusivamente el '@' correspondiente a su propio nombre o identificador. (Nota: En los clips y fotos de la Etapa 5 sí se combinan múltiples referencias con '@' para situar a los personajes en sus escenarios).
...
[?OPCION_TEXTO_PANTALLA=CAPCUT_MANUAL]
  ...
  * Clip 2: Cobertura temporal de 00:04 a 00:14 (10 segundos de duración). Sus primeros 2 segundos (00:04 - 00:06) continúan sin voz en off con diseño Foley, y exactamente en el segundo 00:06 del video da comienzo la voz narrativa continua.
  * Clips subsiguientes (Clip 3 en adelante): Clips de 10 segundos cada uno (00:14 - 00:24, 00:24 - 00:34, etc.), decidiendo la IA con criterio cinematográfico si cada clip es de un solo shot continuo de 10s o de dos shots de 5s + 5s.
...
[?OPCION_TEXTO_PANTALLA=IA_CLIP_1]
  ...
  * Clip 2: Cobertura temporal en timeline de 00:06 a 00:16 (10 segundos de duración). Al haberse llevado el Clip 1 a 6 segundos en edición, el Clip 2 arranca en el timeline de CapCut en el segundo 6 de video (00:06) y da comienzo de inmediato a la voz narrativa continua en el segundo 00:06 (sin los 2 segundos de foley mudo iniciales de Clip 2, cubriendo los 10 segundos del Clip 2 con locución continua).
  * Clips subsiguientes (Clip 3 en adelante): Clips de 10 segundos cada uno (Clip 3: 00:16 - 00:26, Clip 4: 00:26 - 00:36, etc.), decidiendo la IA con criterio cinematográfico si cada clip es de un solo shot continuo de 10s o de dos shots de 5s + 5s.
...
- Protocolo Obligatorio de Entrega en Bloques de 10 Clips (Alto entre Bloques):
  ...
  * Si la producción tiene 10 clips o menos en total (ej. un video de 60s con 7 clips), la IA entregará la totalidad de los clips en un único bloque y se detendrá con el ALTO INQUEBRANTABLE antes de pasar a la siguiente etapa (Etapa 6: Texto en Pantalla).
...
[?OPCION_TEXTO_PANTALLA=CAPCUT_MANUAL]
  ...
  Clip 1 (00:00 - 00:04): Create a video [prompt técnico en inglés para Omni Flash de 4s de duración (Hook de apertura de impacto con puro diseño sonoro Foley ambiental, estrictamente sin voz en off), indicando obligatoriamente TIEMPO y LUGAR con prefijo '@' para referencia visual (ej. 'in a dark cobblestone alley in @Whitechapel, @London, @England, 1888...'), cerrando con: strictly no music, no speech, cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music.]
[/?OPCION_TEXTO_PANTALLA]
[?OPCION_TEXTO_PANTALLA=IA_CLIP_1]
  Image 1: Create an image [prompt en inglés optimizado para Banana Pro en formato [?SUB_OPCION_REELS=9X16]vertical 9:16[/?SUB_OPCION_REELS][?SUB_OPCION_REELS=16X9]horizontal 16:9[/?SUB_OPCION_REELS] estrictamente con 'no text' (el texto en pantalla de los primeros 6 segundos va exclusivamente en el prompt del Clip 1 de video, NO en el prompt de la Imagen 1), indicando obligatoriamente TIEMPO y LUGAR con prefijo '@' para referencia visual (ej. 'in @Whitechapel, @London, @England, 1888...'), encuadre centrado, sujeto, atmósfera, iluminación y óptica, cerrando con: cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music.]
  Clip 1 (00:00 - 00:04): Create a video [prompt técnico en inglés para Omni Flash de 4s de duración (Hook de apertura de impacto sensorial visual con puro diseño sonoro Foley ambiental, estrictamente sin voz en off), indicando obligatoriamente TIEMPO y LUGAR con prefijo '@' para referencia visual (ej. 'in a dark cobblestone alley in @Whitechapel, @London, @England, 1888...'), integrando en el prompt el texto en pantalla tipo comienzo de un documental cinematográfico con tipografía cinematográfica (con Ciudad, País, Tiempo [año en números o siglo en romanos] en la primera línea y justo debajo el Gancho intrigante), cerrando con: strictly no music, no speech, cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no speech, no music. (Nota para edición: luego en edición el usuario baja la velocidad del Clip 1 y lo lleva a 6 segundos).]
[/?OPCION_TEXTO_PANTALLA]

  Image 2: Create an image [prompt en inglés para Banana Pro [?SUB_OPCION_REELS=9X16]9:16[/?SUB_OPCION_REELS][?SUB_OPCION_REELS=16X9]16:9[/?SUB_OPCION_REELS] con 'no text', indicando obligatoriamente TIEMPO y LUGAR con prefijo '@' para referencia visual...]
[?VOZ_NARRATIVA_EN_CLIPS=INCLUIR]
[?OPCION_TEXTO_PANTALLA=CAPCUT_MANUAL]
  Clip 2 (00:04 - 00:14): Create a video [prompt técnico en inglés para Omni Flash de 10s de duración (primeros 2s de 00:04 a 00:06 sin voz en off con diseño Foley, la locución entra exactamente en el segundo 00:06, 1 shot de 10s o 2 shots de 5s+5s según dinamismo, con Foley ambiental integrado), indicando obligatoriamente TIEMPO y LUGAR con prefijo '@' para referencia visual (ej. 'in @Whitechapel, @London, @England, 1888...'), sujeto (@Persona si aplica), acción física, cámara, iluminación y óptica, cerrando con: strictly no music, no speech, cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music. Año 1888, callejón de Whitechapel, Londres, Inglaterra. El laberinto donde operaba un cazador nocturno que la policía jamás atrapó.]

  (Continuar consecutivamente con Image 3: Create an image [prompt con tiempo y lugar con '@'], Clip 3 (00:14 - 00:24): Create a video [prompt técnico en inglés con tiempo, lugar con '@', foley, sufijo, y la porción de locución que cubre este clip anexada al final como una oración más sin comillas ni paréntesis]... Image 4: Create an image [prompt con tiempo y lugar con '@'], Clip 4 (00:24 - 00:34): Create a video [prompt técnico en inglés con tiempo, lugar con '@', foley, sufijo, y la locución correspondiente como una oración más sin comillas ni paréntesis]... indicando siempre tras la numeración "Create an image" en imágenes estáticas, y tras la numeración y el timestamp (##:## - ##:##) "Create a video" en clips de video, con todos los prompts técnicos redactados al 100% en idioma inglés, incluyendo tiempo y lugar con '@' en personas y lugares, cerrando el clip con el sufijo de barrera sonora y colocando la locución al final como una oración más sin comillas ni paréntesis hasta completar el bloque de 10 clips [Clips 1 al 10]).
[/?OPCION_TEXTO_PANTALLA]
[?OPCION_TEXTO_PANTALLA=IA_CLIP_1]
  Clip 2 (00:06 - 00:16): Create a video [prompt técnico en inglés para Omni Flash de 10s de duración (al haberse llevado el Clip 1 a 6s en edición, el Clip 2 arranca en el timeline de CapCut en el segundo 6 [00:06] y comienza inmediatamente con la voz narrativa en el segundo 00:06, 1 shot de 10s o 2 shots de 5s+5s según dinamismo, con Foley ambiental integrado), indicando obligatoriamente TIEMPO y LUGAR con prefijo '@' para referencia visual (ej. 'in @Whitechapel, @London, @England, 1888...'), sujeto (@Persona si aplica), acción física, cámara, iluminación y óptica, cerrando con: strictly no music, no speech, cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music. Año 1888, callejón de Whitechapel, Londres, Inglaterra. El laberinto donde operaba un cazador nocturno que la policía jamás atrapó.]

  (Continuar consecutivamente con Image 3: Create an image [prompt con tiempo y lugar con '@'], Clip 3 (00:16 - 00:26): Create a video [prompt técnico en inglés con tiempo, lugar con '@', foley, sufijo, y la porción de locución que cubre este clip anexada al final como una oración más sin comillas ni paréntesis]... Image 4: Create an image [prompt con tiempo y lugar con '@'], Clip 4 (00:26 - 00:36): Create a video [prompt técnico en inglés con tiempo, lugar con '@', foley, sufijo, y la locución correspondiente como una oración más sin comillas ni paréntesis]... indicando siempre tras la numeración "Create an image" en imágenes estáticas, y tras la numeración y el timestamp (##:## - ##:##) "Create a video" en clips de video, con todos los prompts técnicos redactados al 100% en idioma inglés, incluyendo tiempo y lugar con '@' en personas y lugares, cerrando el clip con el sufijo de barrera sonora y colocando la locución al final como una oración más sin comillas ni paréntesis hasta completar el bloque de 10 clips [Clips 1 al 10]).
[/?OPCION_TEXTO_PANTALLA]
[/?VOZ_NARRATIVA_EN_CLIPS]
[?VOZ_NARRATIVA_EN_CLIPS=EXCLUIR]
[?OPCION_TEXTO_PANTALLA=CAPCUT_MANUAL]
  Clip 2 (00:04 - 00:14): Create a video [prompt técnico en inglés para Omni Flash de 10s de duración (primeros 2s de 00:04 a 00:06 sin voz en off con diseño Foley, la locución entra exactamente en el segundo 00:06 en edición, 1 shot de 10s o 2 shots de 5s+5s según dinamismo, con Foley ambiental integrado), indicando obligatoriamente TIEMPO y LUGAR con prefijo '@' para referencia visual (ej. 'in @Whitechapel, @London, @England, 1888...'), sujeto (@Persona si aplica), acción física, cámara, iluminación y óptica, cerrando limpiamente con: strictly no music, no speech, cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music.]

  (Continuar consecutivamente con Image 3: Create an image [prompt con tiempo y lugar con '@'], Clip 3 (00:14 - 00:24): Create a video [prompt técnico en inglés con tiempo, lugar con '@', foley y sufijo de barrera sonora sin locución]... Image 4: Create an image [prompt con tiempo y lugar con '@'], Clip 4 (00:24 - 00:34): Create a video [prompt técnico en inglés con tiempo, lugar con '@', foley y sufijo de barrera sonora sin locución]... indicando siempre tras la numeración "Create an image" en imágenes estáticas, y tras la numeración y el timestamp (##:## - ##:##) "Create a video" en clips de video, con todos los prompts técnicos redactados al 100% en idioma inglés, incluyendo tiempo y lugar con '@' en personas y lugares, cerrando limpiamente cada clip con el sufijo de barrera sonora [...no text, no speech, no music.] excluyendo la voz narrativa hasta completar el bloque de 10 clips [Clips 1 al 10]).
[/?OPCION_TEXTO_PANTALLA]
[?OPCION_TEXTO_PANTALLA=IA_CLIP_1]
  Clip 2 (00:06 - 00:16): Create a video [prompt técnico en inglés para Omni Flash de 10s de duración (al haberse llevado el Clip 1 a 6s en edición, el Clip 2 arranca en el timeline de CapCut en el segundo 6 [00:06] donde arranca la voz narrativa, 1 shot de 10s o 2 shots de 5s+5s según dinamismo, con Foley ambiental integrado), indicando obligatoriamente TIEMPO y LUGAR con prefijo '@' para referencia visual (ej. 'in @Whitechapel, @London, @England, 1888...'), sujeto (@Persona si aplica), acción física, cámara, iluminación y óptica, cerrando limpiamente con: strictly no music, no speech, cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music.]
...
[/?TIPO_PRODUCCION]
[?OPCION_TEXTO_PANTALLA=CAPCUT_MANUAL]
Opción de Texto en Pantalla (Primeros 6s): Edición manual en CapCut (Prompts con 'no text', texto consultado y colocado manualmente en CapCut durante Clip 1 [4s] + Clip 2 [primeros 2s]).
[/?OPCION_TEXTO_PANTALLA]
[?OPCION_TEXTO_PANTALLA=IA_CLIP_1]
Opción de Texto en Pantalla (Primeros 6s): Generado por IA en Clip 1 (El texto en pantalla va solo en el prompt del Clip 1 [4s], NO en la Imagen 1 ['no text'], tipo comienzo de documental cinematográfico; luego en edición se baja la velocidad del Clip 1 y se lleva a 6 segundos. En esta opción, el Clip 2 comienza en el timeline de CapCut en el segundo 6 [00:06] arrancando directamente con la voz narrativa en el segundo 6 de video).
[/?OPCION_TEXTO_PANTALLA]
[?VOZ_NARRATIVA_EN_CLIPS=INCLUIR]
...
[?TIPO_PRODUCCION=TIMELAPSE]
Capítulo 2: La Promesa Narrativa y el Slogan Completo en Párrafo Aparte antes del Segundo 30, el Slogan Corto al Final y los Micro-Ganchos cada 90 Segundos
...
[?OPCION_TEXTO_PANTALLA=IA_CLIP_1]
    ...
    4. Prompt de Movimiento de Video con Texto Integrado (con Audio Foley Integrado): En idioma inglés para 'omni flash' (comenzando obligatoriamente con la numeración, el timestamp y la orden en inglés: "Clip 1 (00:00 - 00:04): Create a video ", con diseño foley acústico integrado, tiempo y lugar como referencia visual, integrando el texto cinematográfico de apertura tipo comienzo de documental cinematográfico). En edición posterior se baja la velocidad a 6 segundos.
...
Usa omni flash para videos y banana pro para imágenes iniciales de cada clip.
Crea las imágenes primero y luego los clips usando cada imagen como fotograma inicial.
(Esta orden operativa NO se repite en el Bloque 2 ni en bloques posteriores). Seguida obligatoriamente de la secuencia de prompts en formato limpio y consecutivo: [?OPCION_TEXTO_PANTALLA=CAPCUT_MANUAL]Image 1: Create an image [prompt], Clip 1 (00:00 - 00:04): Create a video [prompt de 4s de duración], Image 2: Create an image [prompt], Clip 2 (00:04 - 00:14): Create a video [prompt], etc.[/?OPCION_TEXTO_PANTALLA][?OPCION_TEXTO_PANTALLA=IA_CLIP_1]Image 1: Create an image [prompt], Clip 1 (00:00 - 00:04): Create a video [prompt de 4s con texto integrado (bajar a 6s en edición)], Image 2: Create an image [prompt], Clip 2 (00:06 - 00:16): Create a video [prompt de 10s comenzando con la voz narrativa en el segundo 6], etc.[/?OPCION_TEXTO_PANTALLA] Prompt visual para generar la imagen inicial estática utilizando el modelo "banana pro" ([?SUB_OPCION_REELS=9X16]9:16[/?SUB_OPCION_REELS][?SUB_OPCION_REELS=16X9]16:9[/?SUB_OPCION_REELS] con 'no text', redactado al 100% en inglés, comenzando obligatoriamente tras la numeración con "Image [número]: Create an image [prompt]" o "Imagen [número]: Create an image [prompt]", incluyendo obligatoriamente tiempo y lugar como anclaje y referencia visual histórica con prefijo '@' en personas y lugares), y prompt técnico de movimiento con Foley integrado para generar el clip de video utilizando el modelo "omni flash" (redactado al 100% en inglés, comenzando obligatoriamente con la numeración, el intervalo de tiempo exacto que cubre cada clip en el timeline de CapCut en formato (##:## - ##:##) y la orden de acción obligatoria en inglés "Create a video": "Clip [número] (##:## - ##:##): Create a video [prompt técnico en inglés...]", incluyendo obligatoriamente tiempo y lugar de referencia visual histórica con prefijo '@' en personas y lugares, [?VOZ_NARRATIVA_EN_CLIPS=INCLUIR]cerrando tras el sufijo de barrera sonora en inglés e incluyendo al final de todo el prompt la porción correspondiente de la voz narrativa colocada directamente como una oración más sin comillas ("") ni paréntesis (()), ej. [?OPCION_TEXTO_PANTALLA=CAPCUT_MANUAL]"Clip 2 (00:04 - 00:14): Create a video [prompt en inglés con tiempo, lugar con '@', foley y sufijo]. Año 1888, callejón de Whitechapel, Londres, Inglaterra. El laberinto donde operaba..."[/?OPCION_TEXTO_PANTALLA][?OPCION_TEXTO_PANTALLA=IA_CLIP_1]"Clip 2 (00:06 - 00:16): Create a video [prompt en inglés con tiempo, lugar con '@', foley y sufijo]. Año 1888, callejón de Whitechapel, Londres, Inglaterra. El laberinto donde operaba..."[/?OPCION_TEXTO_PANTALLA], quedando terminantemente prohibido omitir "Create an image" o "Create a video", incluir términos en español en los descriptores técnicos del prompt, omitir tiempo y lugar, o encerrar la voz narrativa entre comillas o paréntesis[/?VOZ_NARRATIVA_EN_CLIPS][?VOZ_NARRATIVA_EN_CLIPS=EXCLUIR]cerrando limpiamente tras el sufijo de barrera sonora en inglés (...no text, no speech, no music.), excluyendo terminantemente el texto de la voz narrativa de los prompts de video, ej. [?OPCION_TEXTO_PANTALLA=CAPCUT_MANUAL]"Clip 2 (00:04 - 00:14): Create a video [prompt en inglés con tiempo, lugar con '@', foley y sufijo]."[/?OPCION_TEXTO_PANTALLA][?OPCION_TEXTO_PANTALLA=IA_CLIP_1]"Clip 2 (00:06 - 00:16): Create a video [prompt en inglés con tiempo, lugar con '@', foley y sufijo]."[/?OPCION_TEXTO_PANTALLA], quedando terminantemente prohibido omitir "Create an image" o "Create a video", incluir términos en español en los descriptores técnicos del prompt, omitir tiempo y lugar, o añadir texto de locución al final del clip[/?VOZ_NARRATIVA_EN_CLIPS]).
[?OPCION_TEXTO_PANTALLA=CAPCUT_MANUAL]
...
[?VOZ_NARRATIVA_EN_CLIPS=INCLUIR]
Regla Inquebrantable: Inclusión de la Voz Narrativa al Final como una Oración Más (Sin Comillas ni Paréntesis): En cada prompt de clip de video entregado que tenga locución asignada (Clip 2 en adelante), la IA debe incluir la parte exacta de la voz narrativa que le corresponde según el intervalo de tiempo del timeline de CapCut (##:## - ##:##) compensando los +6 segundos. Dicho texto de locución DEBE COLOCARSE OBLIGATORIA Y ESTRICTAMENTE AL FINAL DE TODO EL PROMPT como una oración más, cerrando inmediatamente después del sufijo de barrera sonora en inglés (...no text, no speech, no music. [Texto de la locución]). Queda TERMINANTEMENTE PROHIBIDO encerrar la voz narrativa entre comillas (""), ponerla entre paréntesis (()), o anteponer etiquetas burocráticas como '(Voz narrativa: ...)'. El texto del guion se añade limpiamente como una última oración continua. Para clips sin locución (Clip 1 de 00:00 - 00:04 con duración obligatoria de 4 segundos), el prompt concluye directamente con el sufijo de barrera sonora sin oración de voz en off.
[/?VOZ_NARRATIVA_EN_CLIPS]
[?VOZ_NARRATIVA_EN_CLIPS=EXCLUIR]
Regla Estricta: Exclusión de la Voz Narrativa de los Prompts de Clips (Prompts Limpios): En cada prompt de clip de video entregado (Clip 1 en adelante), la IA DEBE EXCLUIR TOTALMENTE el texto de la voz narrativa o locución. El prompt concluye obligatoria y directamente con el sufijo de barrera sonora en inglés (...no text, no speech, no music.). Queda TERMINANTEMENTE PROHIBIDO anexar el texto del guion o voz en off al final de los prompts de video. La voz narrativa permanece exclusivamente en el guion de la Etapa 3 para locución y sincronización manual en el software de edición (CapCut).
[/?VOZ_NARRATIVA_EN_CLIPS]
[?OPCION_TEXTO_PANTALLA=CAPCUT_MANUAL]
Compensación de Timestamps (+6s) en los Intervalos de los Clips (##:## - ##:##): La numeración de los intervalos de tiempo en el timeline de CapCut (##:## - ##:##) debe reflejar con exactitud la sincronización: Clip 1 cubre 00:00 - 00:04 (4s de duración sin voz), Clip 2 cubre 00:04 - 00:14 (primeros 2s sin voz, segundo 6 donde entra la voz), Clip 3 cubre 00:14 - 00:24, etc.
[/?OPCION_TEXTO_PANTALLA]
[?OPCION_TEXTO_PANTALLA=IA_CLIP_1]
Compensación de Timestamps (+6s) en los Intervalos de los Clips (##:## - ##:##): La numeración de los intervalos de tiempo en el timeline de CapCut (##:## - ##:##) debe reflejar con exactitud la sincronización: Clip 1 cubre en el prompt 00:00 - 00:04 (4s de duración sin voz, indicando bajar la velocidad en edición a 6s para cubrir 00:00 - 00:06), Clip 2 cubre 00:06 - 00:16 (al haberse llevado Clip 1 a 6s en edición, el Clip 2 comienza directamente con la voz narrativa en el segundo 6 [00:06]), Clip 3 cubre 00:16 - 00:26, etc.
[/?OPCION_TEXTO_PANTALLA]
...
- Orden Operativa en una Sola Oración para Prompts de Referencia (Etapa 4): Al inicio obligatorio de la entrega de los prompts de imágenes modelo de referencia de personas, lugares y objetos, la IA debe colocar obligatoriamente como preámbulo inicial en una sola oración la siguiente instrucción textual:
  Cambia los nombres y ponles @ seguido del nombre del lugar, persona u objeto correspondiente.
- Regla de un Solo '@' por Cada Prompt de Imagen Modelo de Referencia (Etapa 4): En los prompts de imágenes modelo de referencia de personas, lugares y objetos (Etapa 4), solo puede haber un único símbolo '@' en cada prompt. Cada prompt modela exclusivamente un solo sujeto (ej. solo @Jack The Ripper, solo @Whitechapel o solo @Scalpel). Queda terminantemente prohibido colocar múltiples '@' en un mismo prompt de referencia (ej. ciudades, países o personajes secundarios se escriben sin '@'). En los clips y fotos de la Etapa 5 sí se combinan múltiples referencias con '@' para anclar personajes y escenarios juntos.
...
[?VOZ_NARRATIVA_EN_CLIPS=INCLUIR]
- Prompts de Clips de Video con Intervalo Temporal (##:## - ##:##), "Create a video", Tiempo, Lugar con '@' y Voz Narrativa al Final como una Oración Más: Todo prompt técnico de movimiento para generar el video con Foley integrado debe estar redactado al 100% en idioma inglés para los comandos y la descripción técnica cinematográfica, comenzando obligatoriamente indicando la numeración, el intervalo de tiempo exacto que cubre cada clip en el timeline de CapCut en formato (##:## - ##:##) y la orden de acción literal en inglés "Create a video ": ("Clip [número] (##:## - ##:##): Create a video [prompt técnico en inglés...]"), incluir obligatoriamente dentro de la descripción técnica en inglés el TIEMPO y LUGAR como referencia visual histórica con prefijo '@' en personas y lugares (ej. 'in @Whitechapel, @London, @England, 1888...'), cerrar la descripción con el sufijo obligatorio de barrera sonora (...no text, no speech, no music.), y colocar AL FINAL DE TODO EL PROMPT la porción correspondiente de la voz narrativa como una oración más sin comillas ("") ni paréntesis (()). Queda estrictamente prohibido omitir la orden "Create a video", incluir términos en español en la orden o descripción técnica del video, omitir el tiempo y lugar con '@', o encerrar la voz narrativa entre comillas o paréntesis. (Ejemplos: [?OPCION_TEXTO_PANTALLA=CAPCUT_MANUAL]"Clip 1 (00:00 - 00:04): Create a video [prompt técnico en inglés de 4s de duración con tiempo, lugar con '@', foley y sufijo]", "Clip 2 (00:04 - 00:14): Create a video [prompt técnico en inglés con tiempo, lugar con '@', foley y sufijo]. Año 1888, callejón de Whitechapel, Londres, Inglaterra. El laberinto donde operaba..."[/?OPCION_TEXTO_PANTALLA][?OPCION_TEXTO_PANTALLA=IA_CLIP_1]"Clip 1 (00:00 - 00:04): Create a video [prompt técnico en inglés de 4s con texto cinematográfico, foley y sufijo (en edición bajar a 6s)]", "Clip 2 (00:06 - 00:16): Create a video [prompt técnico en inglés con tiempo, lugar con '@', foley y sufijo]. Año 1888, callejón de Whitechapel, Londres, Inglaterra. El laberinto donde operaba..."[/?OPCION_TEXTO_PANTALLA], etc.).
[/?VOZ_NARRATIVA_EN_CLIPS]
[?VOZ_NARRATIVA_EN_CLIPS=EXCLUIR]
- Prompts de Clips de Video con Intervalo Temporal (##:## - ##:##), "Create a video", Tiempo, Lugar con '@' y Exclusión de Voz Narrativa (Prompts Limpios): Todo prompt técnico de movimiento para generar el video con Foley integrado debe estar redactado al 100% en idioma inglés para los comandos y la descripción técnica cinematográfica, comenzando obligatoriamente indicando la numeración, el intervalo de tiempo exacto que cubre cada clip en el timeline de CapCut en formato (##:## - ##:##) y la orden de acción literal en inglés "Create a video ": ("Clip [número] (##:## - ##:##): Create a video [prompt técnico en inglés...]"), incluir obligatoriamente dentro de la descripción técnica en inglés el TIEMPO y LUGAR como referencia visual histórica con prefijo '@' en personas y lugares (ej. 'in @Whitechapel, @London, @England, 1888...'), y cerrar la descripción estrictamente con el sufijo obligatorio de barrera sonora (...no text, no speech, no music.), excluyendo terminantemente cualquier texto de locución o voz narrativa al final del prompt. Queda estrictamente prohibido omitir la orden "Create a video", incluir términos en español en la orden o descripción técnica del video, omitir el tiempo y lugar con '@', o agregar texto de voz en off al final del clip. (Ejemplos: [?OPCION_TEXTO_PANTALLA=CAPCUT_MANUAL]"Clip 1 (00:00 - 00:04): Create a video [prompt técnico en inglés de 4s de duración con tiempo, lugar con '@', foley y sufijo]", "Clip 2 (00:04 - 00:14): Create a video [prompt técnico en inglés con tiempo, lugar con '@', foley y sufijo]"[/?OPCION_TEXTO_PANTALLA][?OPCION_TEXTO_PANTALLA=IA_CLIP_1]"Clip 1 (00:00 - 00:04): Create a video [prompt técnico en inglés de 4s con texto cinematográfico, foley y sufijo (en edición bajar a 6s)]", "Clip 2 (00:06 - 00:16): Create a video [prompt técnico en inglés con tiempo, lugar con '@', foley y sufijo]"[/?OPCION_TEXTO_PANTALLA], etc.).
[/?VOZ_NARRATIVA_EN_CLIPS]
...
const PromptGenerator = () => {
  ...
  useEffect(() => {
    const key = 'huellas_master_template_v110';
              ...
              <div style={{ marginBottom: '2rem', padding: '1rem', backgroundColor: 'rgba(197, 160, 89, 0.1)', border: '1px solid var(--border-color)' }}>
                ...
                {Object.keys(radioGroups).map(group => {
                  ...
                  const groupTitle = group === 'TIPO_PRODUCCION' ? 'Tipo de Producción' :
                                     ...
                                     group === 'OPCION_TEXTO_PANTALLA' ? 'Texto en Pantalla (Primeros 6 Segundos)' :
                          ...
                          <label key={val} style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', cursor: 'pointer' }}>
                            ...
                            <span>
                              {val === 'REELS' ? 'Reels' :
                               ...
                               val === 'CAPCUT_MANUAL' ? 'Edición manual en CapCut (Prompts con "no text" / Colocar en Clip 1 [4s] + Clip 2 [primeros 2s])' :
                               val === 'IA_CLIP_1' ? 'Generado por IA en Clip 1 (Texto solo en prompt de Clip 1 [4s], no en Imagen 1 / Bajar a 6s en edición / Clip 2 arranca con voz en segundo 6)' :
