...
- Regla Inquebrantable del Prefijo '@' para Nombres de Personas y Lugares: Al referirse a nombres propios de personas o personajes históricos (ej. @Jack The Ripper, @Julio César, @Napoleón Bonaparte) y nombres de lugares, ciudades, países o sitios específicos (ej. @Whitechapel, @Londres, @Inglaterra, @Roma), la IA DEBE ANTEPONER OBLIGATORIAMENTE EL SÍMBOLO '@' AL COMIENZO DE CADA NOMBRE, tanto en los modelos de referencia como en todos los prompts subsiguientes.
- Estructura de Entrega de las Imágenes Modelo de Referencia (en idioma inglés para Banana Pro):
  1. Personas (@Personas): Prompts de modelo de personaje / retrato conceptual (character reference sheet / portrait), detallando rostro, edad histórica, rasgos fisonómicos distintivos, indumentaria de época rigurosamente auténtica, iluminación y textura de la piel, cerrando con: cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music.
  2. Lugares (@Lugares): Prompts de modelo de entorno / arquitectura (establishing shot / environment reference model), detallando materialidad de las calles, edificios, atmósfera, clima e iluminación de época, cerrando con: cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music.
  3. Objetos: Prompts de modelo de primer plano (macro / prop reference model) para objetos, reliquias, armas, herramientas o documentos clave que jueguen un rol determinante en la historia, detallando materiales, desgaste histórico y textura, cerrando con: cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music.
...
-> ALTO INQUEBRANTABLE: La IA entrega exclusivamente los prompts de imágenes modelo de referencia de personas, lugares y objetos, y concluye su respuesta deteniéndose. Espera la confirmación del usuario antes de pasar a la generación de los prompts de imágenes iniciales y clips de video.
...
- Formato Estricto de los Prompts (Orden Operativa EXCLUSIVA en el Primer Bloque):
  ...
  Inmediatamente después de esta orden (en el Bloque 1), la IA entregará la secuencia de prompts correspondiente al bloque (incluyendo obligatoriamente en cada clip de video el tiempo real de CapCut que cubre en formato (##:## - ##:##), aplicando la compensación de +6s respecto a la transcripción de audio, y quedando estrictamente prohibido incluir texto de la voz narrativa en los prompts):
  * Regla Inquebrantable de Prompts 100% en Inglés y Apertura ("Create an image" / "Create a video"): Todos los prompts deben estar redactados obligatoria y estrictamente en idioma INGLÉS. Inmediatamente después de la numeración en las imágenes estáticas, debe colocarse obligatoriamente la orden de acción en inglés "Create an image " ("Image [número]: Create an image [prompt...]" o "Imagen [número]: Create an image [prompt...]"). Inmediatamente después de la numeración y el timestamp en los clips de video, debe colocarse obligatoriamente la orden de acción en inglés "Create a video " ("Clip [número] (##:## - ##:##): Create a video [prompt...]"). Queda estrictamente prohibido usar frases en español (como "Crea una imagen" o "Crea un video") dentro de los prompts.
  ...
  * Regla Inquebrantable de Cero Texto de Voz Narrativa en los Prompts: Queda TERMINANTEMENTE PROHIBIDO incluir texto del guion de locución, fragmentos de la voz en off o leyendas como '(Voz narrativa: ...)' dentro de los prompts de video. Los prompts de video deben terminar de forma limpia y exclusiva cerrando con el sufijo obligatorio de barrera sonora en inglés (...no text, no speech, no music), garantizando que las primeras 6 palabras pertenezcan limpiamente a la numeración, tiempo y descriptores técnicos.
  ...
  (Continuar consecutivamente con Image 3: Create an image [prompt con tiempo y lugar con '@'], Clip 3 (00:16 - 00:26): Create a video [prompt técnico en inglés con tiempo, lugar con '@', foley y sufijo]... Image 4: Create an image [prompt con tiempo y lugar con '@'], Clip 4 (00:26 - 00:36): Create a video [prompt técnico en inglés con tiempo, lugar con '@', foley y sufijo]... indicando siempre tras la numeración "Create an image" en imágenes estáticas, y tras la numeración y el timestamp (##:## - ##:##) "Create a video" en clips de video, con todos los prompts redactados al 100% en idioma inglés, incluyendo tiempo y lugar con '@' en personas y lugares, estrictamente sin incluir texto de la voz narrativa, cerrando limpiamente con el sufijo obligatorio hasta completar el bloque de 10 clips [Clips 1 al 10]).
...
Regla Estricta: Cero Texto de Voz Narrativa en los Prompts de Video: Queda TERMINANTEMENTE PROHIBIDO incluir fragmentos del guion de locución, texto de la voz narrativa o leyendas como '(Voz narrativa: ...)' dentro de los prompts de video. Los prompts de video deben concluir de forma limpia y exclusiva con el sufijo obligatorio de barrera sonora en inglés (...no text, no speech, no music), preservando la pureza técnica de los prompts y asegurando que las primeras 6 palabras pertenezcan limpiamente a la nomenclatura y descripción visual sin contaminación de texto hablado.
Compensación de Timestamps (+6s) en los Intervalos de los Clips (##:## - ##:##): Aunque los prompts no llevan texto de voz narrativa, la numeración de los intervalos de tiempo en el timeline de CapCut (##:## - ##:##) debe reflejar con exactitud la sincronización: Clip 1 cubre 00:00 - 00:06 (6s sin voz), Clip 2 cubre 00:06 - 00:16 (segundo 6 donde entra la voz), Clip 3 cubre 00:16 - 00:26, etc.
...
- Prompts de Clips de Video con Intervalo Temporal (##:## - ##:##), "Create a video", Tiempo y Lugar con '@' y Cero Texto de Voz Narrativa: Todo prompt técnico de movimiento para generar el video con Foley integrado debe estar redactado al 100% en idioma inglés, comenzando obligatoriamente indicando la numeración, el intervalo de tiempo exacto que cubre cada clip en el timeline de CapCut en formato (##:## - ##:##) y la orden de acción literal en inglés "Create a video ": ("Clip [número] (##:## - ##:##): Create a video [prompt técnico en inglés...]"), incluir obligatoriamente dentro de la descripción técnica en inglés el TIEMPO y LUGAR como referencia visual histórica con prefijo '@' en personas y lugares (ej. 'in @Whitechapel, @London, @England, 1888...'), y finalizar LIMPIAMENTE cerrando con el sufijo obligatorio de barrera sonora (...no text, no speech, no music), QUEDANDO TERMINANTEMENTE PROHIBIDO incluir texto de la voz narrativa o leyendas como '(Voz narrativa: ...)' dentro del prompt. Queda estrictamente prohibido omitir la orden "Create a video", incluir términos en español en la orden o descripción del video, u omitir el tiempo y lugar con '@'. (Ejemplos: "Clip 1 (00:00 - 00:06): Create a video [prompt técnico en inglés con tiempo, lugar con '@', foley y sufijo]", "Clip 2 (00:06 - 00:16): Create a video [prompt técnico en inglés con tiempo, lugar con '@', foley y sufijo]", etc.).
...
const PromptGenerator = () => {
  ...
  useEffect(() => {
    const key = 'huellas_master_template_v93';
