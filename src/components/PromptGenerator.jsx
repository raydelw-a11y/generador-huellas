...
- Formato Estricto de los Prompts en Cada Bloque:
  ...
  Inmediatamente después de esta orden, la IA entregará la secuencia de prompts correspondiente al bloque en formato:
  ...
  (Continuar consecutivamente con Imagen 3: prompt, Clip 3: prompt... Imagen 4: prompt, Clip 4: prompt... hasta completar el bloque de 10 clips [Clips 1 al 10]).
...
const PromptGenerator = () => {
  ...
  useEffect(() => {
    const key = 'huellas_master_template_v75';
