...
1. 36 segundos (Clip 1 de 4s + 3 clips de 10s + Clip 5 de 2s = 30s de voz en off / ~530 caracteres con espacios)
2. 46 segundos (Clip 1 de 4s + 4 clips de 10s = 40s de voz en off / ~706 caracteres con espacios)
3. 56 segundos (Clip 1 de 4s + 5 clips de 10s = 50s de voz en off / ~883 caracteres con espacios)
4. 60 segundos (Clip 1 de 4s + 5 clips de 10s + Clip 7 final de 4s/6s = 54s de voz en off / ~954 caracteres con espacios)
5. 66 segundos (Clip 1 de 4s + 6 clips de 10s = 60s de voz en off / ~1060 caracteres con espacios)
6. 76 segundos (Clip 1 de 4s + 7 clips de 10s = 70s de voz en off / ~1236 caracteres con espacios)
7. 86 segundos (Clip 1 de 4s + 8 clips de 10s = 80s de voz en off / ~1413 caracteres con espacios)
8. 116 segundos / 1:56 min (Clip 1 de 4s + 11 clips de 10s = 110s de voz en off / ~1943 caracteres con espacios)
9. 120 segundos / 2 min exactos (Clip 1 de 4s + 11 clips de 10s + Clip 13 final de 4s/6s = 114s de voz en off / ~2013 caracteres con espacios)
[/?DURACION_CLIPS]
...
- Cálculo Matemático Exacto de Duración y Extensión (Tasa Calibrada de 17.66 caracteres/segundo):
  ...
  * Tasa de Lectura Calibrada: Exactamente 17.66 caracteres por segundo de locución incluyendo los espacios ([?DURACION_CLIPS=10_SEGUNDOS]~176 caracteres por cada 10 segundos de locución continua[/?DURACION_CLIPS][?DURACION_CLIPS=8_SEGUNDOS]~141 caracteres por cada 8 segundos de locución continua[/?DURACION_CLIPS]; equivalente a ~1060 caracteres por minuto).
...
Tras la validación de las imágenes modelo de referencia de personas, lugares y objetos (las cuales son única y exclusivamente para referencia visual y NO para ser usadas como primer fotograma del video), la IA generará y entregará los prompts de imágenes iniciales (Image 1, Image 2, etc., que fungirán como primer fotograma de cada clip) y los clips de video correspondientes a la duración elegida en bloques controlados de 10 clips (ej. Bloque 1: Clips 1 al 10; Bloque 2: Clips 11 al 13 o restantes):
...
- Protocolo Obligatorio de Entrega en Bloques de 10 Clips (Alto entre Bloques):
  * Si la producción tiene más de 10 clips en total (ej. un video de 120s con 13 o 16 clips), la IA generará y entregará en esta primera interacción ÚNICAMENTE el Bloque 1 correspondiente a los primeros 10 clips (Clips 1 al 10).
  ...
  * Tras la confirmación del usuario, la IA entregará el Bloque 2 (Clips 11 al 13/16 o restantes) comenzando DIRECTAMENTE con los prompts (ej. Image 11: Create an image, Clip 11 (##:## - ##:##): Create a video) SIN repetir la orden operativa, ya que la orden operativa se da EXCLUSIVAMENTE y por única vez en el primer bloque de prompts (Bloque 1).
...
[?OPCION_TEXTO_PANTALLA=CAPCUT_MANUAL]
[?DURACION_CLIPS=10_SEGUNDOS]
  Clip 2 (00:04 - 00:14): Create a video [prompt técnico en inglés para Omni Flash de 10s de duración (1 shot de 10s, primeros 2s de 00:04 a 00:06 sin voz en off con diseño Foley, la locución entra exactamente en el segundo 00:06, con Foley ambiental integrado), indicando obligatoriamente TIEMPO y LUGAR con prefijo '@' para referencia visual (ej. 'in @Whitechapel, @London, @England, 1888...'), sujeto (@Persona si aplica), acción física, cámara, iluminación y óptica, cerrando con: strictly no music, no speech, cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music. Año 1888, callejón de Whitechapel, Londres, Inglaterra. El laberinto donde operaba un cazador nocturno que la policía jamás atrapó. fix the name]
...
[/?DURACION_CLIPS]
[?DURACION_CLIPS=8_SEGUNDOS]
  Clip 2 (00:04 - 00:12): Create a video [prompt técnico en inglés para Omni Flash de 8s de duración (1 shot de 8s, primeros 2s de 00:04 a 00:06 sin voz en off con diseño Foley, la locución entra exactamente en el segundo 00:06, con Foley ambiental integrado), indicando obligatoriamente TIEMPO y LUGAR con prefijo '@' para referencia visual (ej. 'in @Whitechapel, @London, @England, 1888...'), sujeto (@Persona si aplica), acción física, cámara, iluminación y óptica, cerrando con: strictly no music, no speech, cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music. Año 1888, callejón de Whitechapel, Londres, Inglaterra. El laberinto donde operaba un cazador nocturno que la policía jamás atrapó. fix the name]

  (Continuar consecutivamente con Image 3: Create an image [prompt con tiempo y lugar con '@'], Clip 3 (00:12 - 00:20): Create a video [prompt técnico en inglés con tiempo, lugar con '@', foley, sufijo, locución como una oración más y "fix the name"]... Image 4: Create an image [prompt con tiempo y lugar con '@'], Clip 4 (00:20 - 00:28): Create a video [prompt técnico en inglés con tiempo, lugar con '@', foley, sufijo, locución como una oración más y "fix the name"]... indicando siempre tras la numeración "Create an image" en imágenes estáticas, y tras la numeración y el timestamp (##:## - ##:##) "Create a video" en clips de video, cada clip como 1 shot continuo de 8s, con todos los prompts técnicos redactados al 100% en idioma inglés, incluyendo tiempo y lugar con '@' en personas y lugares, cerrando el clip con el sufijo de barrera sonora, colocando la locución al final como una oración más sin comillas ni paréntesis, y agregando obligatoriamente al final "fix the name" hasta completar el bloque de 10 clips [Clips 1 al 10]).
[/?DURACION_CLIPS]
[/?OPCION_TEXTO_PANTALLA]
[?OPCION_TEXTO_PANTALLA=IA_CLIP_1]
[?DURACION_CLIPS=10_SEGUNDOS]
  Clip 2 (00:06 - 00:16): Create a video [prompt técnico en inglés para Omni Flash de 10s de duración (1 shot de 10s, al haberse llevado el Clip 1 a 6s en edición, el Clip 2 arranca en el timeline de CapCut en el segundo 6 [00:06] y comienza inmediatamente con la voz narrativa en el segundo 00:06, con Foley ambiental integrado), indicando obligatoriamente TIEMPO y LUGAR con prefijo '@' para referencia visual (ej. 'in @Whitechapel, @London, @England, 1888...'), sujeto (@Persona si aplica), acción física, cámara, iluminación y óptica, cerrando con: strictly no music, no speech, cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music. Año 1888, callejón de Whitechapel, Londres, Inglaterra. El laberinto donde operaba un cazador nocturno que la policía jamás atrapó. fix the name]

  (Continuar consecutivamente con Image 3: Create an image [prompt con tiempo y lugar con '@'], Clip 3 (00:16 - 00:26): Create a video [prompt técnico en inglés con tiempo, lugar con '@', foley, sufijo, locución como una oración más y "fix the name"]... Image 4: Create an image [prompt con tiempo y lugar con '@'], Clip 4 (00:26 - 00:36): Create a video [prompt técnico en inglés con tiempo, lugar con '@', foley, sufijo, locución como una oración más y "fix the name"]... indicando siempre tras la numeración "Create an image" en imágenes estáticas, y tras la numeración y el timestamp (##:## - ##:##) "Create a video" en clips de video, cada clip como 1 shot continuo de 10s, con todos los prompts técnicos redactados al 100% en idioma inglés, incluyendo tiempo y lugar con '@' en personas y lugares, cerrando el clip con el sufijo de barrera sonora, colocando la locución al final como una oración más sin comillas ni paréntesis, y agregando obligatoriamente al final "fix the name" hasta completar el bloque de 10 clips [Clips 1 al 10]).
[/?DURACION_CLIPS]
[?DURACION_CLIPS=8_SEGUNDOS]
  Clip 2 (00:06 - 00:14): Create a video [prompt técnico en inglés para Omni Flash de 8s de duración (1 shot de 8s, al haberse llevado el Clip 1 a 6s en edición, el Clip 2 arranca en el timeline de CapCut en el segundo 6 [00:06] y comienza inmediatamente con la voz narrativa en el segundo 00:06, con Foley ambiental integrado), indicando obligatoriamente TIEMPO y LUGAR con prefijo '@' para referencia visual (ej. 'in @Whitechapel, @London, @England, 1888...'), sujeto (@Persona si aplica), acción física, cámara, iluminación y óptica, cerrando con: strictly no music, no speech, cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music. Año 1888, callejón de Whitechapel, Londres, Inglaterra. El laberinto donde operaba un cazador nocturno que la policía jamás atrapó. fix the name]

  (Continuar consecutivamente con Image 3: Create an image [prompt con tiempo y lugar con '@'], Clip 3 (00:14 - 00:22): Create a video [prompt técnico en inglés con tiempo, lugar con '@', foley, sufijo, locución como una oración más y "fix the name"]... Image 4: Create an image [prompt con tiempo y lugar con '@'], Clip 4 (00:22 - 00:30): Create a video [prompt técnico en inglés con tiempo, lugar con '@', foley, sufijo, locución como una oración más y "fix the name"]... indicando siempre tras la numeración "Create an image" en imágenes estáticas, y tras la numeración y el timestamp (##:## - ##:##) "Create a video" en clips de video, cada clip como 1 shot continuo de 8s, con todos los prompts técnicos redactados al 100% en idioma inglés, incluyendo tiempo y lugar con '@' en personas y lugares, cerrando el clip con el sufijo de barrera sonora, colocando la locución al final como una oración más sin comillas ni paréntesis, y agregando obligatoriamente al final "fix the name" hasta completar el bloque de 10 clips [Clips 1 al 10]).
[/?DURACION_CLIPS]
[/?OPCION_TEXTO_PANTALLA]
[/?VOZ_NARRATIVA_EN_CLIPS]
[?VOZ_NARRATIVA_EN_CLIPS=EXCLUIR]
[?OPCION_TEXTO_PANTALLA=CAPCUT_MANUAL]
[?DURACION_CLIPS=10_SEGUNDOS]
  Clip 2 (00:04 - 00:14): Create a video [prompt técnico en inglés para Omni Flash de 10s de duración (1 shot de 10s, primeros 2s de 00:04 a 00:06 sin voz en off con diseño Foley, la locución entra exactamente en el segundo 00:06 en edición, con Foley ambiental integrado), indicando obligatoriamente TIEMPO y LUGAR con prefijo '@' para referencia visual (ej. 'in @Whitechapel, @London, @England, 1888...'), sujeto (@Persona si aplica), acción física, cámara, iluminación y óptica, cerrando limpiamente con: strictly no music, no speech, cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music. fix the name]
...
[/?DURACION_CLIPS]
[?DURACION_CLIPS=8_SEGUNDOS]
  Clip 2 (00:04 - 00:12): Create a video [prompt técnico en inglés para Omni Flash de 8s de duración (1 shot de 8s, primeros 2s de 00:04 a 00:06 sin voz en off con diseño Foley, la locución entra exactamente en el segundo 00:06 en edición, con Foley ambiental integrado), indicando obligatoriamente TIEMPO y LUGAR con prefijo '@' para referencia visual (ej. 'in @Whitechapel, @London, @England, 1888...'), sujeto (@Persona si aplica), acción física, cámara, iluminación y óptica, cerrando limpiamente con: strictly no music, no speech, cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music. fix the name]
...
[?OPCION_TEXTO_PANTALLA=IA_CLIP_1]
[?DURACION_CLIPS=10_SEGUNDOS]
  Clip 2 (00:06 - 00:16): Create a video [prompt técnico en inglés para Omni Flash de 10s de duración (1 shot de 10s, al haberse llevado el Clip 1 a 6s en edición, el Clip 2 arranca en el timeline de CapCut en el segundo 6 [00:06] donde arranca la voz narrativa, con Foley ambiental integrado), indicando obligatoriamente TIEMPO y LUGAR con prefijo '@' para referencia visual (ej. 'in @Whitechapel, @London, @England, 1888...'), sujeto (@Persona si aplica), acción física, cámara, iluminación y óptica, cerrando limpiamente con: strictly no music, no speech, cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music. fix the name]
...
const PromptGenerator = () => {
  ...
  useEffect(() => {
    const key = 'huellas_master_template_v114';
