...
- Para el Clip 1 (Hook de 4s):
  ...
  3. Prompt de Imagen Inicial (en inglés para Banana Pro con 'no text', comenzando obligatoriamente con "Imagen 1: [prompt...]", incluyendo obligatoriamente tiempo y lugar como referencia visual).
  4. Prompt de Movimiento de Video con Audio Foley Integrado (en inglés para Omni Flash, estrictamente sin música ni voz / 'no music, no speech', comenzando obligatoriamente con el tiempo que cubre en formato (##:## - ##:##): "Clip 1 (00:00 - 00:04): [prompt...]", incluyendo obligatoriamente tiempo y lugar como referencia visual).
...
- Para el Clip 2 (8s) y Clip 3 (8s):
  ...
  3. Prompt de Imagen Inicial (en inglés para Banana Pro con 'no text', comenzando obligatoriamente con "Imagen [número]: [prompt...]", incluyendo obligatoriamente tiempo y lugar como referencia visual).
  4. Prompt de Movimiento de Video con Audio Foley Integrado (en inglés para Omni Flash, estrictamente sin música ni voz / 'no music, no speech', comenzando obligatoriamente con el tiempo que cubre en formato (##:## - ##:##): "Clip 2 (00:04 - 00:12): [prompt...]", "Clip 3 (00:12 - 00:20): [prompt...]", incluyendo obligatoriamente tiempo y lugar como referencia visual).
...
- Protocolo Obligatorio de Entrega en Bloques de 10 Clips (Alto entre Bloques):
  ...
  * Tras la confirmación del usuario, la IA entregará el Bloque 2 (Clips 11 al 13 o restantes) comenzando DIRECTAMENTE con los prompts (ej. Imagen 11:, Clip 11:) SIN repetir la orden operativa, ya que la orden operativa se da EXCLUSIVAMENTE y por única vez en el primer bloque de prompts (Bloque 1).
...
- Estructura de Entrega Obligatoria para los 3 Clips:
  * CLIP 1 (HOOK DE 4s):
    ...
    3. Prompt de Imagen Inicial: En idioma inglés para 'banana pro' (con sufijos obligatorios, 'no text' e incluyendo obligatoriamente tiempo y lugar como referencia visual).
    4. Prompt de Movimiento de Video (con Audio Foley Integrado): En idioma inglés para 'omni flash' con diseño foley acústico integrado dentro del propio prompt, incluyendo obligatoriamente tiempo y lugar como referencia visual.
  ...
  * CLIP 2 (8s) y CLIP 3 (8s):
    ...
    3. Prompt de Imagen Inicial: En idioma inglés para 'banana pro' (con sufijos obligatorios, 'no text' e incluyendo obligatoriamente tiempo y lugar como referencia visual).
    4. Prompt de Movimiento de Video (con Audio Foley Integrado): En idioma inglés para 'omni flash', incluyendo obligatoriamente tiempo y lugar como referencia visual.
...
Usa omni flash para videos y banana pro para imágenes iniciales de cada clip.
Crea las imágenes primero y luego los clips usando cada imagen como fotograma inicial.
(Esta orden operativa NO se repite en el Bloque 2 ni en bloques posteriores). Seguida obligatoriamente de la secuencia de prompts en formato limpio y consecutivo: Imagen 1: prompt, Clip 1 (00:00 - 00:06): prompt (Voz narrativa: Sin voz en off / Hook puro Foley), Imagen 2: prompt, Clip 2 (00:06 - 00:16): prompt (Voz narrativa: "[texto del guion]"), etc. Prompt visual para generar la imagen inicial estática utilizando el modelo "banana pro" ([?SUB_OPCION_REELS=9X16]9:16[/?SUB_OPCION_REELS][?SUB_OPCION_REELS=16X9]16:9[/?SUB_OPCION_REELS] con 'no text', comenzando obligatoriamente con "Imagen [número]: [prompt]", incluyendo obligatoriamente tiempo y lugar como anclaje y referencia visual histórica), y prompt técnico de movimiento con Foley integrado para generar el clip de video utilizando el modelo "omni flash" (comenzando obligatoriamente con la numeración y el intervalo de tiempo exacto que cubre cada clip en el timeline de CapCut en formato (##:## - ##:##), seguido del prompt técnico cinematográfico en inglés incluyendo obligatoriamente tiempo y lugar de referencia visual histórica, y finalizando OBLIGATORIAMENTE AL FINAL DE TODO EL PROMPT con la porción de la voz narrativa que le corresponde en formato (Voz narrativa: "[texto]"), ej. "Clip [número] (##:## - ##:##): [prompt en inglés con tiempo, lugar, Foley y sufijo] (Voz narrativa: '[texto del guion]')", quedando terminantemente prohibido omitir tiempo y lugar o situar la voz en off al inicio o en medio del prompt).
...
- Orden Operativa Exclusiva del Primer Bloque de Prompts: Al inicio obligatorio del primer bloque de entrega de prompts de imágenes y videos (Bloque 1: Clips 1 al 10), la IA debe colocar obligatoriamente como preámbulo inicial la siguiente orden operativa textual (quedando estrictamente prohibido repetirla en los bloques subsiguientes):
  ...
  Usa omni flash para videos y banana pro para imágenes iniciales de cada clip.
  Crea las imágenes primero y luego los clips usando cada imagen como fotograma inicial.
- Prompts de Imagen Inicial con Tiempo y Lugar: Todo prompt para generar la imagen fija inicial debe comenzar obligatoriamente con la frase literal y dos puntos: "Imagen [número]: ", e incluir obligatoriamente el TIEMPO y LUGAR como anclaje y referencia visual histórica (ejemplos: "Imagen 1: [prompt con tiempo y lugar...]", "Imagen 2: [prompt con tiempo y lugar...]", etc.).
- Prompts de Clips de Video con Intervalo Temporal (##:## - ##:##), Tiempo, Lugar y Voz Narrativa Obligatoriamente al Final: Todo prompt técnico de movimiento para generar el video con Foley integrado debe comenzar obligatoriamente indicando la numeración y el intervalo de tiempo exacto que cubre cada clip en el timeline de CapCut en formato (##:## - ##:##) seguido de dos puntos ("Clip [número] (##:## - ##:##): [prompt técnico en inglés...]"), incluir obligatoriamente dentro de la descripción técnica en inglés el TIEMPO y LUGAR como referencia visual histórica (ej. 'in Whitechapel, London, England, 1888...'), y finalizar OBLIGATORIAMENTE AL FINAL DE TODO EL PROMPT (después del sufijo obligatorio de barrera sonora) incluyendo la porción de la voz narrativa que le corresponde entre paréntesis en formato (Voz narrativa: "[texto del guion]") (o "(Voz narrativa: Sin voz en off / Hook de puro Foley)" para clips sin locución, como Clip 1). Queda estrictamente prohibido omitir el tiempo y lugar o situar el fragmento de voz narrativa antes o en medio del texto técnico en inglés. (Ejemplos: "Clip 1 (00:00 - 00:06): [prompt con tiempo y lugar...] (Voz narrativa: Sin voz en off / Hook de puro Foley)", "Clip 2 (00:06 - 00:16): [prompt con tiempo y lugar...] (Voz narrativa: \"1888, en el callejón de Whitechapel...\")", etc.).
...
const PromptGenerator = () => {
  ...
  useEffect(() => {
    const key = 'huellas_master_template_v86';
