...
2. Explicación Visual del Clip: Descripción narrativa y contextual en español explicando qué ocurre en la escena y cuál es la atmósfera psicológica que transmite el plano. Para el Clip 1, señalar expresamente: "[Audio: Cero voz en off, exclusivo diseño Foley ambiental de impacto]". Para el Clip 2, señalar expresamente: "[Audio: Los primeros 2 segundos van sin voz en off, exclusivo Foley ambiental; la voz en off entra a los 2 segundos de este clip (segundo 6 del video total), comenzando por FECHA y LUGAR]".
...
const PromptGenerator = () => {
  ...
  useEffect(() => {
    const key = 'huellas_master_template_v71';
