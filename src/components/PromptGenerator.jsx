...
- Estructura de Generación de Clips: La IA debe entregar obligatoriamente la estructura de los clips conteniendo: 1) Identificación del clip y selección de cámara, 2) Explicación visual del clip en español (especificando expresamente en el Clip 1 que no lleva voz en off, y en el Clip 2 que los primeros 2 segundos van sin voz en off y la locución entra a los 2 segundos en el segundo 6 de video comenzando obligatoriamente por TIEMPO, LUGAR, CIUDAD Y PAÍS, y DESCRIPCIÓN BREVE del lugar/suceso/personaje), 3) Prompt visual para generar la imagen inicial estática utilizando el modelo "banana pro" (9:16 con 'no text', comenzando obligatoriamente con "Imagen clip [número]"), y 4) Prompt técnico de movimiento con Foley integrado para generar el clip de video utilizando el modelo "omni flash" (comenzando obligatoriamente con "Clip [número]").
[/?TIPO_PRODUCCION]
[?TIPO_PRODUCCION=REELS_16_SEG]
...
const PromptGenerator = () => {
  ...
  useEffect(() => {
    const key = 'huellas_master_template_v72';
