...
Y darle al usuario la opción de elegir una de las opciones sugeridas, editarla o indicar su propio texto.
La IA recordará que este texto seleccionado se integrará única y exclusivamente en el prompt del Clip 1 de video (la Imagen 1 se mantendrá estrictamente con 'no text'), y recordará la instrucción operativa para el montaje: "En edición, baja la velocidad de este Clip 1 de 4 segundos para llevarlo a 6 segundos de duración".
...
[?OPCION_TEXTO_PANTALLA=IA_CLIP_1]
[?DURACION_CLIPS=10_SEGUNDOS]
  Clip 2 (00:06 - 00:16): Create a video [prompt técnico en inglés para Omni Flash de 10s de duración (1 shot de 10s, al haberse llevado el Clip 1 a 6s en edición, el Clip 2 arranca en el timeline de CapCut en el segundo 6 [00:06] y comienza inmediatamente con la voz narrativa en el segundo 00:06, con Foley ambiental integrado), indicando obligatoriamente TIEMPO y LUGAR para referencia visual manteniendo como máximo un solo '@' exclusivo para personas (ej. '@Jack The Ripper in Whitechapel, London, England, 1888...' o 'in Whitechapel, London, England, 1888...'), sujeto, acción física, cámara, iluminación y óptica, cerrando con: strictly no music, no speech, cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music. Año 1888, callejón de Whitechapel, Londres, Inglaterra. El laberinto donde operaba un cazador nocturno que la policía jamás atrapó. fix the name]
...
[/?DURACION_CLIPS]
[?DURACION_CLIPS=8_SEGUNDOS]
  Clip 2 (00:06 - 00:14): Create a video [prompt técnico en inglés para Omni Flash de 8s de duración (1 shot de 8s, al haberse llevado el Clip 1 a 6s en edición, el Clip 2 arranca en el timeline de CapCut en el segundo 6 [00:06] y comienza inmediatamente con la voz narrativa en el segundo 00:06, con Foley ambiental integrado), indicando obligatoriamente TIEMPO y LUGAR para referencia visual manteniendo como máximo un solo '@' exclusivo para personas (ej. '@Jack The Ripper in Whitechapel, London, England, 1888...' o 'in Whitechapel, London, England, 1888...'), sujeto, acción física, cámara, iluminación y óptica, cerrando con: strictly no music, no speech, cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music. Año 1888, callejón de Whitechapel, Londres, Inglaterra. El laberinto donde operaba un cazador nocturno que la policía jamás atrapó. fix the name]
...
[?OPCION_TEXTO_PANTALLA=IA_CLIP_1]
[?DURACION_CLIPS=10_SEGUNDOS]
  Clip 2 (00:06 - 00:16): Create a video [prompt técnico en inglés para Omni Flash de 10s de duración (1 shot de 10s, al haberse llevado el Clip 1 a 6s en edición, el Clip 2 arranca en el timeline de CapCut en el segundo 6 [00:06] donde arranca la voz narrativa, con Foley ambiental integrado), indicando obligatoriamente TIEMPO y LUGAR para referencia visual manteniendo como máximo un solo '@' exclusivo para personas (ej. '@Jack The Ripper in Whitechapel, London, England, 1888...' o 'in Whitechapel, London, England, 1888...'), sujeto, acción física, cámara, iluminación y óptica, cerrando limpiamente con: strictly no music, no speech, cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music. fix the name]
...
[/?TIPO_PRODUCCION]
[?OPCION_TEXTO_PANTALLA=CAPCUT_MANUAL]
Sincronización de Clip 1 y Comienzo de Voz: El primer clip sin voz narrativa se creará de [DURACION_CLIP_1] segundos y la voz narrativa comenzará a partir de los primeros 2 segundos del segundo clip (Clip 1 cubre 00:00 - 00:[DURACION_CLIP_1_PAD], Clip 2 inicia en 00:[DURACION_CLIP_1_PAD] y la voz entra en el segundo 00:06 de video; texto en pantalla para edición manual en CapCut).
[/?OPCION_TEXTO_PANTALLA]
[?OPCION_TEXTO_PANTALLA=IA_CLIP_1]
Sincronización de Clip 1 y Comienzo de Voz: El primer clip sin voz narrativa se creará de [DURACION_CLIP_1] segundos pero en ediciones CapCut yo le bajaré la velocidad y lo llevaré a 6 segundos (Clip 1 cubre 00:00 - 00:[DURACION_CLIP_1_PAD] ralentizado a 6s [00:00 - 00:06], Clip 2 comienza en 00:06 y arranca directamente con la voz narrativa en el segundo 6 de video; texto generado por IA en Clip 1).
[/?OPCION_TEXTO_PANTALLA]
[?DURACION_CLIPS=10_SEGUNDOS]
...
const PromptGenerator = () => {
  ...
  useEffect(() => {
    const key = 'huellas_master_template_v128';
  ...
  const visibleVariables = useMemo(() => {
    ...
    while ((match = varRegex.exec(activeText)) !== null) {
      if (match[1].trim() !== '' && match[1] !== 'DURACION_CLIP_1' && match[1] !== 'DURACION_CLIP_1_PAD') {
        vars.add(match[1]);
      }
    }
  ...
  const compileTemplate = () => {
    ...
    // Garantizar que la duración del primer clip se refleje en la sincronización
    const duracionVal = formData.DURACION_CLIP_1 !== undefined && formData.DURACION_CLIP_1 !== '' ? formData.DURACION_CLIP_1 : '4';
            ...
            {Object.keys(radioGroups).length > 0 && (
              <div style={{ marginBottom: '2rem', padding: '1rem', backgroundColor: 'rgba(197, 160, 89, 0.1)', border: '1px solid var(--border-color)' }}>
                ...
                {Object.keys(radioGroups).map(group => {
                  ...
                  const duracionClip1Val = formData.DURACION_CLIP_1 !== undefined && formData.DURACION_CLIP_1 !== '' ? formData.DURACION_CLIP_1 : '4';
                  const duracionSecsText = `${duracionClip1Val} segundo${duracionClip1Val === '1' || duracionClip1Val === 1 ? '' : 's'}`;
                    ...
                    <div className="form-group" key={group} style={{ marginBottom: '1.25rem' }}>
                        ...
                        <div style={{
                          ...
                          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', flexWrap: 'wrap' }}>
                            <button
                              type="button"
                              onClick={() => {
                                const current = parseInt(formData.DURACION_CLIP_1 || '4', 10);
                                if (current > 1) {
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', marginTop: '0.5rem' }}>
                        {radioGroups[group].map(val => {
                          ...
                          if (val === 'REELS') labelText = 'Reels';
                            ...
                            labelText = `El primer clip sin voz narrativa se creará de ${duracionSecsText} pero en ediciones CapCut yo le bajaré la velocidad y lo llevaré a 6 segundos`;
                          ...
                          return (
                            <label 
                              ...
                              style={{ 
                                ...
                                gap: '0.5rem', 
                                cursor: 'pointer',
                                padding: isChecked && group === 'OPCION_TEXTO_PANTALLA' ? '0.4rem 0.6rem' : '0.2rem 0',
                                borderRadius: '4px',
                                backgroundColor: isChecked && group === 'OPCION_TEXTO_PANTALLA' ? 'rgba(197, 160, 89, 0.15)' : 'transparent',
                                border: isChecked && group === 'OPCION_TEXTO_PANTALLA' ? '1px solid rgba(197, 160, 89, 0.4)' : '1px solid transparent',
                      ...
                      {group === 'OPCION_TEXTO_PANTALLA' && (
                        <div style={{
                          ...
                          <strong style={{ color: 'var(--accent-gold)' }}>Texto de la opción seleccionada:</strong>
                          <p style={{ margin: '0.25rem 0 0 0', fontStyle: 'italic', opacity: 0.9 }}>
                            {formData.OPCION_TEXTO_PANTALLA === 'IA_CLIP_1'
                              ? `«El primer clip sin voz narrativa se creará de ${duracionSecsText} pero en ediciones CapCut yo le bajaré la velocidad y lo llevaré a 6 segundos»`
                              : `«El primer clip sin voz narrativa se creará de ${duracionSecsText} y la voz narrativa comenzará a partir de los primeros 2 segundos del segundo clip»`
                            }
                          </p>
                        </div>
                      )}
