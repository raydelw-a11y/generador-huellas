...
- Cantidad de Clips y Cuadre Matemático Exacto:
  * Clip 1: Cobertura temporal y duración obligatoria de 4 segundos en el prompt de clip (00:00 - 00:04). Prompt técnico en inglés para Omni Flash de 4s de duración con puro diseño sonoro Foley ambiental (Hook de apertura de alto impacto sensorial). Estrictamente SIN voz en off. En Image 1 y Clip 1, la IA genera directamente en pantalla el texto del rótulo de apertura tipo comienzo de documental cinematográfico en dos líneas centradas (Línea 1: Ciudad, País, Tiempo; Línea 2: Gancho intrigante o perturbador) con encuadre seguro (safe framing composition) y tipografía cinematográfica sobria. Por tanto, Image 1 y Clip 1 NO llevan la instrucción 'no text'. Posteriormente, en edición en CapCut, el editor reduce la velocidad de reproducción de este clip de 4s para llevarlo a 6 segundos (00:00 - 00:06).
...
- Formato Estricto de los Prompts (Orden Operativa EXCLUSIVA en el Primer Bloque):
  ...
  * Regla Inquebrantable de Texto en Pantalla Generado por IA en Image 1 y Clip 1: En Image 1 (Banana Pro) y Clip 1 (Omni Flash), la IA debe instruir al motor a renderizar directamente sobre la imagen el texto de apertura de documental cinematográfico en dos líneas centradas: Línea 1 con Ciudad, País, Tiempo (ej. "London, England, 1888") y Línea 2 justo debajo con la frase de Gancho intrigante o perturbadora. En estos dos prompts iniciales (Image 1 y Clip 1) NO se incluye la instrucción 'no text'. A partir de Image 2 y Clip 2 en adelante, TODOS los prompts de imagen y video deben incluir obligatoriamente 'no text'.
  * Regla Inquebrantable de la Voz Narrativa al Final como una Oración Más (Sin Comillas ni Paréntesis): En cada prompt de clip de video que lleve locución (Clip 2 en adelante), la IA DEBE COLOCAR OBLIGATORIAMENTE al final de todo el prompt la porción correspondiente del guion de voz en off. Dicho texto se sitúa al final como UNA ORACIÓN MÁS, inmediatamente después del punto del sufijo obligatorio de barrera sonora en inglés (...no text, no speech, no music. [Texto de la locución]). Queda TERMINANTEMENTE PROHIBIDO encerrar la voz narrativa entre comillas (""), envolverla en paréntesis (()) o escribir etiquetas burocráticas como '(Voz narrativa: ...)'. Se anexa directamente como una última oración continua y limpia. Para Clip 1 (00:00 - 00:04), al tener una duración obligatoria de 4 segundos en Omni Flash y ser el Hook inicial sin voz en off de puro diseño sonoro Foley (ralentizado en CapCut a 6s), el prompt concluye directamente con el sufijo sin ninguna oración adicional de voz.
  ...
  Image 1: Create an image [prompt en inglés optimizado para Banana Pro en formato [?SUB_OPCION_REELS=9X16]vertical 9:16[/?SUB_OPCION_REELS][?SUB_OPCION_REELS=16X9]horizontal 16:9[/?SUB_OPCION_REELS], indicando obligatoriamente TIEMPO y LUGAR con prefijo '@' para referencia visual (ej. 'in @Whitechapel, @London, @England, 1888...'), encuadre centrado, sujeto, atmósfera, iluminación y óptica, instruyendo a la IA a generar directamente en pantalla el texto de apertura tipo comienzo de documental cinematográfico centrado en dos líneas: Línea 1 con Ciudad, País, Tiempo (ej. "London, England, 1888") y Línea 2 justo debajo con la frase de Gancho intrigante o perturbadora, con tipografía cinematográfica sobria, safe framing composition, no modern objects, no CGI look, no speech, no music.]
  Clip 1 (00:00 - 00:04): Create a video [prompt técnico en inglés para Omni Flash de 4s de duración (Hook de apertura de impacto con puro diseño sonoro Foley ambiental, estrictamente sin voz en off, ralentizado luego en edición en CapCut a 6s para cubrir 00:00 - 00:06), indicando obligatoriamente TIEMPO y LUGAR con prefijo '@' para referencia visual (ej. 'in a dark cobblestone alley in @Whitechapel, @London, @England, 1888...'), manteniendo en pantalla el texto de apertura generado tipo documental cinematográfico centrado en dos líneas (Línea 1: Ciudad, País, Tiempo; Línea 2: Gancho intrigante), con movimiento de cámara sutil o fijo, cerrando con: strictly no music, no speech, cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no speech, no music.]
...
[/?TIPO_PRODUCCION]
[?TIPO_PRODUCCION=REELS]Texto en Pantalla y Diseño para Reproducción en Silencio (Primeros 6 Segundos - Generado por la IA en Clip 1 de 4s y Ralentizado a 6s en CapCut): Alrededor del 70% de los usuarios ven los primeros segundos sin audio, por lo que el apoyo visual claro y los subtítulos dinámicos posteriores en CapCut son obligatorios. Durante los primeros 6 segundos del video (ventana que transcurre sin voz en off con diseño sonoro Foley puro), el impacto visual se potencia mediante un rótulo o letrero en pantalla tipo comienzo de documental cinematográfico. Dicho texto NO se inserta manualmente en edición; es generado directamente por la IA en el fotograma inicial de Image 1 (Banana Pro) y en Clip 1 de 4 segundos de duración (Omni Flash, 00:00 - 00:04). Debe estructurarse obligatoriamente en dos líneas centradas: Línea 1 con Ciudad, País, Tiempo (años en dígitos o siglos en números romanos; ej. "London, England, 1888"), y Línea 2 (justo debajo) con la frase de Gancho intrigante o perturbadora, con tipografía cinematográfica sobria y encuadre seguro (safe framing composition). Posteriormente, durante el montaje en CapCut, el editor reduce la velocidad de reproducción de este clip de 4 segundos para extenderlo a 6 segundos (00:00 - 00:06). Por tanto, Image 1 y Clip 1 NO llevan la directriz negativa 'no text'. A partir de Clip 2 (00:06 - 00:16) en adelante, todos los prompts de imagen y video llevan estrictamente 'no text' para mantener la imagen completamente limpia.[/?TIPO_PRODUCCION][?TIPO_PRODUCCION=TIMELAPSE]Queda estrictamente prohibido incluir cualquier tipo de texto en pantalla para estos videos cortos; la imagen debe permanecer completamente limpia y visual.[/?TIPO_PRODUCCION][?TIPO_PRODUCCION=INMERSIVO_CONTEMPLATIVO]Texto en Pantalla (Edición Manual en CapCut): El texto en pantalla será exclusivo del Clip 1 e incluirá lugar, tiempo (año/siglo) y título que resuma con gancho de qué va el video. Este texto NO debe ser generado por herramientas de IA ni insertado en los prompts visuales (los prompts deben incluir estrictamente 'no text'). La IA debe especificar claramente en la ficha del Clip 1 qué texto colocar manualmente en CapCut durante la edición posterior. Los clips 2 y 3 no llevan texto en pantalla.[/?TIPO_PRODUCCION]
[?TIPO_PRODUCCION=TIMELAPSE]
...
Usa omni flash para videos y banana pro para imágenes iniciales de cada clip.
Crea las imágenes primero y luego los clips usando cada imagen como fotograma inicial.
(Esta orden operativa NO se repite en el Bloque 2 ni en bloques posteriores). Seguida obligatoriamente de la secuencia de prompts en formato limpio y consecutivo: Image 1: Create an image [prompt con texto de apertura de documental cinematográfico generado por la IA en pantalla], Clip 1 (00:00 - 00:04): Create a video [prompt técnico en inglés de 4s de duración con texto de apertura tipo documental generado por la IA en pantalla y puro diseño sonoro Foley, ralentizado a 6s en CapCut], Image 2: Create an image [prompt con 'no text'], Clip 2 (00:06 - 00:16): Create a video [prompt técnico en inglés con 'no text', foley, sufijo, y la porción de locución correspondiente como una oración más sin comillas ni paréntesis], etc. Prompt visual para generar la imagen inicial estática utilizando el modelo "banana pro" ([?SUB_OPCION_REELS=9X16]9:16[/?SUB_OPCION_REELS][?SUB_OPCION_REELS=16X9]16:9[/?SUB_OPCION_REELS], redactado al 100% en inglés, comenzando obligatoriamente tras la numeración con "Image [número]: Create an image [prompt]" o "Imagen [número]: Create an image [prompt]", incluyendo obligatoriamente tiempo y lugar como anclaje y referencia visual histórica con prefijo '@' en personas y lugares; Image 1 instruye a generar en pantalla el rótulo de apertura de documental cinematográfico, mientras que Image 2 en adelante lleva estrictamente 'no text'), y prompt técnico de movimiento con Foley integrado para generar el clip de video utilizando el modelo "omni flash" (redactado al 100% en inglés, comenzando obligatoriamente con la numeración, el intervalo de tiempo exacto que cubre cada clip en el timeline de CapCut en formato (##:## - ##:##) y la orden de acción obligatoria en inglés "Create a video": "Clip [número] (##:## - ##:##): Create a video [prompt técnico en inglés...]", incluyendo obligatoriamente tiempo y lugar de referencia visual histórica con prefijo '@' en personas y lugares, cerrando tras el sufijo de barrera sonora en inglés e incluyendo al final de todo el prompt la porción correspondiente de la voz narrativa colocada directamente como una oración más sin comillas ("") ni paréntesis (()), ej. "Clip 2 (00:06 - 00:16): Create a video [prompt en inglés con tiempo, lugar con '@', 'no text', foley y sufijo]. Año 1888, callejón de Whitechapel, Londres, Inglaterra...", quedando terminantemente prohibido omitir "Create an image" o "Create a video", incluir términos en español en los descriptores técnicos del prompt, omitir tiempo y lugar, o encerrar la voz narrativa entre comillas o paréntesis).
- Texto en Pantalla Generado por la IA en Clip 1 (Primeros 6 Segundos): En Image 1 (Banana Pro) y Clip 1 (Omni Flash de 4s [00:00 - 00:04]), la IA genera directamente en la imagen el texto de apertura de documental cinematográfico estructurado en dos líneas centradas: Ciudad, País, Tiempo en la primera línea, y justo debajo la frase de Gancho intrigante o perturbadora, con tipografía sobria y encuadre seguro (safe framing composition). En edición en CapCut, el editor reduce la velocidad de reproducción de Clip 1 para extenderlo a 6 segundos (00:00 - 00:06). Image 1 y Clip 1 NO llevan la directriz 'no text'. A partir de Clip 2 (00:06 - 00:16) en adelante, todos los prompts de imagen y video llevan estrictamente 'no text'.
[/?TIPO_PRODUCCION]
...
const PromptGenerator = () => {
  ...
  useEffect(() => {
    const key = 'huellas_master_template_v97';
