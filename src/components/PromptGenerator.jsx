...
1. 36 segundos (Clip 1 de 4s + 4 clips de 8s = 32s de voz en off / ~466 caracteres con espacios)
2. 44 segundos (Clip 1 de 4s + 5 clips de 8s = 40s de voz en off / ~582 caracteres con espacios)
3. 52 segundos (Clip 1 de 4s + 6 clips de 8s = 48s de voz en off / ~699 caracteres con espacios)
4. 60 segundos (Clip 1 de 4s + 7 clips de 8s = 56s de voz en off / exactamente 815 caracteres con espacios)
5. 68 segundos (Clip 1 de 4s + 8 clips de 8s = 64s de voz en off / ~931 caracteres con espacios)
6. 76 segundos (Clip 1 de 4s + 9 clips de 8s = 72s de voz en off / ~1048 caracteres con espacios)
7. O especificar cualquier otra duración en segundos que el usuario prefiera.
...
- Cálculo Matemático Exacto de Duración y Extensión (Calibrado a 56s = 815 caracteres):
  * Tiempo de Locución = Duración Total del Video - 4 segundos del Clip 1.
  * Tasa de Lectura Calibrada: Exactamente 14.55 caracteres por segundo de locución incluyendo los espacios (~116 caracteres por cada clip de 8 segundos / 815 caracteres por cada 56 segundos de locución).
  * Extensión Estricta del Guion: Se calcula mediante la fórmula matemática:
    Caracteres del Guion = (Duración Total del Video - 4s) x 14.55 caracteres con espacios.
    (Ejemplos exactos: 60s total -> 56s de voz = 815 caracteres con espacios; 44s total -> 40s de voz = ~582 caracteres; 52s total -> 48s de voz = ~699 caracteres; 36s total -> 32s de voz = ~466 caracteres). La IA debe indicar obligatoriamente al pie del guion el recuento exacto de caracteres generados y el desglose de tiempo.
...
El formato "Reel 9x16" es un video vertical estructurado cinematográficamente con duración flexible definida por el usuario. El Clip 1 (Hook de 4s) no lleva voz en off, dedicándose exclusivamente al impacto visual y atmósfera sonora Foley. La locución narrativa entra a partir del Clip 2, con voz continua en tercera persona (estrictamente sin hablar en "nosotros", sin silencios estructurales /2s o /#s, y sin forzar anonimización con palabras como "anónimos"). La voz en off arranca obligatoriamente en el Clip 2 con un preámbulo que menciona primero la FECHA y luego el LUGAR, capturando de inmediato al espectador con un elemento intrigante o terrorífico. La duración total del video es igual a los 4 segundos del primer clip más el tiempo de la voz en off, calculando la extensión del guion con la métrica calibrada de 14.55 caracteres por segundo de locución (56s de voz en off = 815 caracteres con espacios / ~116 caracteres por cada clip de 8s). Se ejecuta de forma innegociable en 5 etapas por separado: 1) Selección del tema y tipología; 2) Pregunta y definición de la duración total del video; 3) Guion de voz en off continua proporcional a la duración (Duración Total - 4s) x 14.55 caracteres con espacios (ej. 56s de locución = 815 caracteres); 4) Generación de clips (Clip 1 Hook de 4s sin voz + Clips de 8s con voz) con Banana Pro (9:16 'no text') y Omni Flash con Foley integrado (strictly no music); 5) Metadata en formato Todo Corrido sin encabezados.
[/?TIPO_PRODUCCION]
[?TIPO_PRODUCCION=INMERSIVO_CONTEMPLATIVO]
...
- Voz en Off y Foley: Acompañado de locución narrativa solemne y continua que arranca obligatoriamente a partir del segundo clip (Clip 2). El Clip 1 carece por completo de locución para maximizar el misterio y el impacto visual con Foley. La extensión del texto de la voz en off debe calibrarse estrictamente con la métrica empírica de 14.55 caracteres por segundo de locución (56s de voz en off = 815 caracteres con espacios, equivalentes a ~116 caracteres por cada clip de 8s; estrictamente sin silencios estructurales ni pausas artificiales /2s o /#s), complementada con el paisaje sonoro de Foley integrado en cada prompt de video (estrictamente sin música en ningún clip). El preámbulo inicial de la voz en off (en el Clip 2) debe comenzar obligatoriamente por la FECHA y luego el LUGAR (ej: "1888, Londres..."), capturando de inmediato con un gancho profundamente intrigante o terrorífico. La voz en off debe narrar en tercera persona de forma directa y cinematográfica, sin hablar jamás en primera persona del plural ("nosotros") y sin forzar anonimizaciones artificiales ("anónimos").
...
const PromptGenerator = () => {
  ...
  useEffect(() => {
    const key = 'huellas_master_template_v66';
