...
- Estructura y Orden Inalterable de Entrega (Nota IA -> Slogan -> Hashtags [-> Tags en YouTube]):
  ...
  9. Exactamente 5 hashtags en formato #CamelCase referentes al tema del video (aquí concluye estrictamente el conteo de los 3000 caracteres para Facebook/TikTok y YouTube, o de los 2100 caracteres para Instagram).
...
4) Slogan oficial de la marca: "Cada historia deja una huella. Aquí seguimos sus rastros."
   (⠀)
5) Hashtags: Exactamente 5 hashtags en español y formato #CamelCase referentes al tema del video. (Con los hashtags concluye estrictamente la contabilización de los 3000 caracteres para Facebook/TikTok y YouTube, o de los 2100 caracteres para Instagram).
   (⠀)
...
const PromptGenerator = () => {
  ...
  useEffect(() => {
    const key = 'huellas_master_template_v115';
