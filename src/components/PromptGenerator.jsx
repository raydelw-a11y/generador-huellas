...
- Para el Clip 1 (Hook de 4s):
  ...
  3. Prompt de Imagen Inicial (en inglés para Banana Pro con 'no text', comenzando obligatoriamente con "Imagen clip 1...").
  4. Prompt de Movimiento de Video con Audio Foley Integrado (en inglés para Omni Flash, estrictamente sin música ni voz / 'no music, no speech', comenzando obligatoriamente con "Clip 1...").
...
- Para el Clip 2 (8s) y Clip 3 (8s):
  ...
  3. Prompt de Imagen Inicial (en inglés para Banana Pro con 'no text', comenzando obligatoriamente con "Imagen clip [número]...").
  4. Prompt de Movimiento de Video con Audio Foley Integrado (en inglés para Omni Flash, estrictamente sin música ni voz / 'no music, no speech', comenzando obligatoriamente con "Clip [número]...").
...
Este formato corresponde a un video vertical cinematográfico (9:16) con duración flexible definida por el usuario. La arquitectura de audio y video es estricta: el primer clip (Clip 1 de 4 segundos) es un hook visual y sonoro de puro impacto sensorial con audio Foley, y NO lleva voz en off bajo ningún concepto. La locución narrativa (voz en off) entra obligatoriamente a partir del segundo clip (Clip 2) y fluye de forma continua. Por lo tanto, la duración total del video es la suma exacta de los 4 segundos del Clip 1 más el tiempo de duración de la voz en off (Duración Total = 4s + Tiempo de Voz en Off). La IA debe ejecutar obligatoriamente la producción en cinco etapas separadas y secuenciales:
...
- El Clip 1 (Hook de Impacto) dura exactamente 4 segundos fijos y NO lleva voz en off.
- Los clips siguientes duran 8 segundos cada uno y van acompañados por la voz en off continua.
- Por tanto, la Duración Total del Video = 4 segundos (Clip 1 sin voz) + Tiempo de la Voz en Off.
Preséntale opciones sugeridas y dale la opción de indicar cualquier otra duración:
1. 36 segundos (Clip 1 de 4s + 4 clips de 8s = 32s de voz en off / ~565 caracteres con espacios)
2. 44 segundos (Clip 1 de 4s + 5 clips de 8s = 40s de voz en off / ~707 caracteres con espacios)
3. 52 segundos (Clip 1 de 4s + 6 clips de 8s = 48s de voz en off / ~848 caracteres con espacios)
4. 60 segundos (Clip 1 de 4s + 7 clips de 8s = 56s de voz en off / ~989 caracteres con espacios)
5. 68 segundos (Clip 1 de 4s + 8 clips de 8s = 64s de voz en off / ~1130 caracteres con espacios)
6. 76 segundos (Clip 1 de 4s + 9 clips de 8s = 72s de voz en off / ~1272 caracteres con espacios)
7. 84 segundos (Clip 1 de 4s + 10 clips de 8s = 80s de voz en off / ~1413 caracteres con espacios)
8. 120 segundos / 2 min (Clip 1 de 4s + 116s de voz en off = 2049 caracteres con espacios exactos)
9. O especificar cualquier otra duración en segundos que el usuario prefiera.
...
- Regla Fundamental de Audio (Cero Voz en Off en Clip 1): El primer clip (Clip 1 de 4 segundos) NO lleva voz en off bajo ningún concepto. La locución entra obligatoriamente a partir del segundo clip (Clip 2).
- Cálculo Matemático Exacto de Duración y Extensión (Calibrado a 1:56 / 116s de voz = 2049 caracteres):
  * Tiempo de Locución = Duración Total del Video - 4 segundos del Clip 1.
  * Tasa de Lectura Calibrada: Exactamente 17.66 caracteres por segundo de locución incluyendo los espacios (~141 caracteres por cada clip de 8 segundos / 2049 caracteres por cada 116 segundos de locución).
  * Extensión Estricta del Guion: Se calcula mediante la fórmula matemática:
    Caracteres del Guion = (Duración Total del Video - 4s) x 17.66 caracteres con espacios.
    (Ejemplos exactos: 120s total -> 116s de voz = 2049 caracteres con espacios; 60s total -> 56s de voz = ~989 caracteres; 52s total -> 48s de voz = ~848 caracteres; 44s total -> 40s de voz = ~707 caracteres; 36s total -> 32s de voz = ~565 caracteres). La IA debe indicar obligatoriamente al pie del guion el recuento exacto de caracteres generados y el desglose de tiempo.
- Hook de Inicio Obligatorio (en Clip 2): El preámbulo inicial de la narración (que entra con el Clip 2) tiene que generar un hook demoledor; los primeros segundos de locución deben capturar al consumidor con algo profundamente intrigante o terrorífico. DEBE EMPEZAR OBLIGATORIAMENTE POR LA FECHA Y LUEGO EL LUGAR (ej: "1888, Londres...", "Invierno de 1789, París...", "Mayo de 1943, en las profundidades del Mar del Norte..."), seguido inmediatamente por el suceso perturbador, el misterio o la revelación que detenga el scroll al instante.
...
ETAPA 4: PROMPTS DE IMÁGENES INICIALES Y CLIPS DE VIDEO
Tras la validación del guion de voz en off, la IA generará y entregará los clips de video correspondientes a la duración elegida:
- Cantidad de Clips:
  * Clip 1: 4 segundos de duración (Hook de impacto visual y auditivo). Estrictamente SIN voz en off.
  * Clips 2 en adelante: 8 segundos de duración cada uno (cubiertos por la voz en off). Cantidad de clips de 8s = (Duración Total - 4s) / 8s.
  (La suma de los 4s del Clip 1 más los clips de 8s debe dar exactamente la duración total acordada con el usuario).

Para cada uno de los clips, la IA entregará de forma clara y estructurada:
1. Identificación del Clip y Selección de Cámara: Plano vertical centrado (center-framed), angulación, movimiento cinético lento y óptica seleccionados de los catálogos.
2. Explicación Visual del Clip: Descripción narrativa y contextual en español explicando qué ocurre en la escena y cuál es la atmósfera psicológica que transmite el plano. Para el Clip 1, señalar expresamente: "[Audio: Cero voz en off, exclusivo diseño Foley ambiental de impacto]".
3. Prompt de Imagen Inicial: En idioma inglés optimizado para "banana pro" (formato vertical 9:16, con 'no text', cerrando obligatoriamente con la barrera sonora y sufijos: cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music). DEBE COMENZAR OBLIGATORIAMENTE CON: "Imagen clip [número]" (ejemplo para el clip 1: "Imagen clip 1...").
4. Prompt de Movimiento de Video con Audio Foley Integrado: En idioma inglés optimizado para el modelo de video "omni flash", integrando dentro del propio prompt la descripción sonora inmersiva (ambient sound, foley acústico y texturas físicas, estrictamente sin música ni voz / 'strictly no music, no speech'). DEBE COMENZAR OBLIGATORIAMENTE CON: "Clip [número]" (ejemplo para el clip 1: "Clip 1...").
-> ALTO: La IA entrega los prompts de los clips y concluye su respuesta. NO incluyas la metadata de publicación en esta etapa.

ETAPA 5: METADATA PARA SUBIR EL VIDEO (ENTREGA POSTERIOR)
En una interacción posterior, la IA generará la metadata de publicación en formato "Todo Corrido" y SIN encabezados de sección (cero "Título:", cero "Descripción:", cero "Comentario Fijado:"):
- Título inmersivo y directo para formato vertical, terminando con un separador "|" y una palabra clave corta (sin sufijo de IA ni "| Huellas de la Humanidad").
- Línea invisible (⠀)
- Descripción densa, contextual y envolvente adaptada a formato vertical (~2100 caracteres).
- Línea invisible (⠀)
- Exactamente 5 hashtags en formato #CamelCase referentes al tema del video.
- Línea invisible (⠀)
- Leyenda obligatoria del Escudo de IA para videos cortos.
- Línea invisible (⠀)
...
- Formato de Entrega Limpio en Párrafos Consecutivos (Sin tablas, sin bloques de código Markdown):
  ...
  Imagen 1
  [Prompt en inglés para Banana Pro 16:9 'no text', detallando sujeto, entorno, iluminación, óptica 35mm/16mm, cerrando obligatoriamente con el sufijo: cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music.]
...
El formato "Reel 9x16" es un video vertical estructurado cinematográficamente con duración flexible definida por el usuario. El Clip 1 (Hook de 4s) no lleva voz en off, dedicándose exclusivamente al impacto visual y atmósfera sonora Foley. La locución narrativa entra a partir del Clip 2, con voz continua en tercera persona (estrictamente sin hablar en "nosotros", sin silencios estructurales /2s o /#s, y sin forzar anonimización con palabras como "anónimos"). La voz en off arranca obligatoriamente en el Clip 2 con un preámbulo que menciona primero la FECHA y luego el LUGAR, capturando de inmediato al espectador con un elemento intrigante o terrorífico. La duración total del video es igual a los 4 segundos del primer clip más el tiempo de la voz en off, calculando la extensión del guion con la métrica calibrada de 17.66 caracteres por segundo de locución (116s de voz en off = 2049 caracteres con espacios / ~141 caracteres por cada clip de 8s). Se ejecuta de forma innegociable en 5 etapas por separado: 1) Selección del tema y tipología; 2) Pregunta y definición de la duración total del video; 3) Guion de voz en off continua proporcional a la duración (Duración Total - 4s) x 17.66 caracteres con espacios (ej. 116s de locución = 2049 caracteres; 56s de locución = ~989 caracteres); 4) Generación de clips (Clip 1 Hook de 4s sin voz + Clips de 8s con voz) con Banana Pro (9:16 'no text') y Omni Flash con Foley integrado (strictly no music); 5) Metadata en formato Todo Corrido sin encabezados.
[/?TIPO_PRODUCCION]
[?TIPO_PRODUCCION=INMERSIVO_CONTEMPLATIVO]
...
- Arquitectura Temporal (Fórmula de Duración Total): La duración total del video se compone de: 1 clip inicial de 4 segundos para el hook de impacto (estrictamente SIN voz en off, con diseño Foley ambiental puro), seguido de clips de 8 segundos cada uno donde entra y fluye la voz narrativa continua. La suma de los 4 segundos del Clip 1 más el tiempo de duración de la voz en off da el total exacto del video (Total = 4s + Tiempo de Voz en Off).
- Voz en Off y Foley: Acompañado de locución narrativa solemne y continua que arranca obligatoriamente a partir del segundo clip (Clip 2). El Clip 1 carece por completo de locución para maximizar el misterio y el impacto visual con Foley. La extensión del texto de la voz en off debe calibrarse estrictamente con la métrica empírica de 17.66 caracteres por segundo de locución (116s de voz en off = 2049 caracteres con espacios, equivalentes a ~141 caracteres por cada clip de 8s; estrictamente sin silencios estructurales ni pausas artificiales /2s o /#s), complementada con el paisaje sonoro de Foley integrado en cada prompt de video (estrictamente sin música en ningún clip). El preámbulo inicial de la voz en off (en el Clip 2) debe comenzar obligatoriamente por la FECHA y luego el LUGAR (ej: "1888, Londres..."), capturando de inmediato con un gancho profundamente intrigante o terrorífico. La voz en off debe narrar en tercera persona de forma directa y cinematográfica, sin hablar jamás en primera persona del plural ("nosotros") y sin forzar anonimizaciones artificiales ("anónimos").
- Estructura de Generación de Clips: La IA debe entregar obligatoriamente la estructura de los clips conteniendo: 1) Identificación del clip y selección de cámara, 2) Explicación visual del clip en español (especificando expresamente en el Clip 1 que no lleva voz en off), 3) Prompt visual para generar la imagen inicial estática utilizando el modelo "banana pro" (9:16 con 'no text', comenzando obligatoriamente con "Imagen clip [número]"), y 4) Prompt técnico de movimiento con Foley integrado para generar el clip de video utilizando el modelo "omni flash" (comenzando obligatoriamente con "Clip [número]").
[/?TIPO_PRODUCCION]
[?TIPO_PRODUCCION=REELS_16_SEG]
...
- Prompts de Imagen Inicial: Todo prompt para generar la imagen fija inicial debe comenzar obligatoriamente con la frase literal "Imagen clip [número]" (ejemplos: "Imagen clip 1...", "Imagen clip 2...", etc.).
- Prompts de Clips de Video: Todo prompt técnico de movimiento para generar el video con Foley integrado debe comenzar obligatoriamente con la frase literal "Clip [número]" (ejemplos: "Clip 1...", "Clip 2...", etc.).
...
const PromptGenerator = () => {
  ...
  useEffect(() => {
    const key = 'huellas_master_template_v67';
