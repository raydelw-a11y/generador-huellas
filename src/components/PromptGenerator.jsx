...
- Para el Clip 1 (Hook de 4s):
  ...
  4. Prompt de Movimiento de Video con Audio Foley Integrado (en inglés para Omni Flash, comenzando obligatoriamente con "Clip 1...").
...
- Para el Clip 2 (8s) y Clip 3 (8s):
  ...
  4. Prompt de Movimiento de Video con Audio Foley Integrado (en inglés para Omni Flash, comenzando obligatoriamente con "Clip [número]...").
...
const PromptGenerator = () => {
  ...
  useEffect(() => {
    const key = 'huellas_master_template_v62';
