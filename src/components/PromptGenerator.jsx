...
- Formato Estricto de los Prompts (Orden Operativa EXCLUSIVA en el Primer Bloque):
  ...
  * Regla Inquebrantable de Ubicación de la Voz Narrativa al Final: El texto de la voz narrativa (o la indicación de sin voz en off) DEBE IR SITUADO OBLIGATORIA Y ESTRICTAMENTE AL FINAL DE CADA PROMPT DE VIDEO (cerrando el renglón tras el sufijo en inglés "...no text, no speech, no music."). Queda TERMINANTEMENTE PROHIBIDO colocar la voz narrativa al principio del clip, antes del prompt en inglés o intercalada en el medio, asegurando que las primeras 6 palabras pertenezcan exclusivamente a la numeración, tiempo y descriptores técnicos de video.
  ...
  Clip 2 (00:06 - 00:16): [prompt técnico en inglés para Omni Flash de 10s de duración (1 shot de 10s o 2 shots de 5s+5s según dinamismo, con Foley ambiental integrado), sujeto, acción física, cámara, iluminación y óptica, cerrando con: strictly no music, no speech, cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music.] (Voz narrativa: "[Fragmento exacto del guion de locución correspondiente a los primeros 10s de voz (00:00 - 00:10 de tu app de audio), ej. '1888, en el callejón de Whitechapel, Londres, Inglaterra...']")

  (Continuar consecutivamente con Imagen 3: prompt, Clip 3 (00:16 - 00:26): [prompt técnico en inglés cerrando con sufijo] (Voz narrativa: "[bloque 00:10 - 00:20 de voz]")... Imagen 4: prompt, Clip 4 (00:26 - 00:36): [prompt técnico en inglés cerrando con sufijo] (Voz narrativa: "[bloque 00:20 - 00:30 de voz]")... indicando siempre en cada clip de video el tiempo de CapCut en formato (##:## - ##:##) y situando la porción de la voz narrativa SIEMPRE AL FINAL hasta completar el bloque de 10 clips [Clips 1 al 10]).
...
- Prompts de Clips de Video con Intervalo Temporal (##:## - ##:##) y Voz Narrativa Obligatoriamente al Final: Todo prompt técnico de movimiento para generar el video con Foley integrado debe comenzar obligatoriamente indicando la numeración y el intervalo de tiempo exacto que cubre cada clip en el timeline de CapCut en formato (##:## - ##:##) seguido de dos puntos ("Clip [número] (##:## - ##:##): [prompt técnico en inglés...]") y finalizar OBLIGATORIAMENTE AL FINAL DE TODO EL PROMPT (después del sufijo obligatorio de barrera sonora) incluyendo la porción de la voz narrativa que le corresponde entre paréntesis en formato (Voz narrativa: "[texto del guion]") (o "(Voz narrativa: Sin voz en off / Hook de puro Foley)" para clips sin locución, como Clip 1). Queda estrictamente prohibido situar el fragmento de voz narrativa antes o en medio del texto técnico en inglés. (Ejemplos: "Clip 1 (00:00 - 00:06): [prompt...] (Voz narrativa: Sin voz en off / Hook de puro Foley)", "Clip 2 (00:06 - 00:16): [prompt...] (Voz narrativa: \"1888, en el callejón de Whitechapel...\")", etc.).
...
const PromptGenerator = () => {
  ...
  useEffect(() => {
    const key = 'huellas_master_template_v85';
