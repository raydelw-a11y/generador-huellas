...
- Formato Estricto de los Prompts (Orden Operativa EXCLUSIVA en el Primer Bloque):
  ...
  Inmediatamente después de esta orden (en el Bloque 1), la IA entregará la secuencia de prompts correspondiente al bloque (incluyendo obligatoriamente en cada clip de video el tiempo que cubre en formato (##:## - ##:##) y la porción de la voz narrativa que le corresponde):
  ...
  Clip 2 (00:04 - 00:12): [prompt técnico en inglés para Omni Flash de 8s de duración (con Foley integrado; recordando que los primeros 2 segundos van sin voz en off y la locución arranca al segundo 2 de este clip [segundo 6 del video total] comenzando obligatoriamente por TIEMPO, LUGAR, CIUDAD Y PAÍS, y DESCRIPCIÓN BREVE del tema/suceso/personaje), cerrando con: strictly no music, no speech, cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music.] (Voz narrativa: "[Fragmento exacto del guion de locución que corresponde a este clip, ej. '1888, en el callejón de Whitechapel, Londres, Inglaterra...']")

  (Continuar consecutivamente con Imagen 3: prompt, Clip 3 (00:12 - 00:20): prompt (Voz narrativa: "[texto del guion]")... Imagen 4: prompt, Clip 4 (00:20 - 00:28): prompt (Voz narrativa: "[texto del guion]")... indicando siempre en cada clip de video el tiempo que cubre en formato (##:## - ##:##) y la porción de la voz narrativa que le corresponde hasta completar el bloque de 10 clips [Clips 1 al 10]).
...
La IA debe explicar al usuario que este texto corresponde al letrero o rótulo de gancho visual en pantalla durante los primeros 6 segundos del video (la ventana del Hook sin voz en off: Clip 1 de 4s + primeros 2s de Clip 2, con exclusivo diseño sonoro Foley ambiental).
...
Inclusión Obligatoria de la Voz Narrativa Correspondiente en Cada Clip de Video: En cada prompt de clip de video entregado, la IA debe incluir obligatoriamente la parte exacta de la voz narrativa (locución del guion) que le corresponde según el intervalo de tiempo que cubre dicho clip (##:## - ##:##). Esto garantiza una sincronización inversa milimétrica entre el relato auditivo y la acción cinematográfica visual para el editor y los generadores de video. Debe estructurarse al final del prompt en formato: (Voz narrativa: "[texto exacto de la locución que cubre este clip]"). Para clips sin locución (ej. Clip 1 de 00:00 a 00:04 y los primeros 2s de Clip 2), debe indicarse explícitamente: (Voz narrativa: Sin voz en off / Hook de puro Foley).
...
- Prompts de Clips de Video con Intervalo Temporal (##:## - ##:##) y Voz Narrativa Correspondiente: Todo prompt técnico de movimiento para generar el video con Foley integrado debe comenzar obligatoriamente indicando la numeración y el intervalo de tiempo exacto que cubre cada clip en formato (##:## - ##:##) seguido de dos puntos ("Clip [número] (##:## - ##:##): [prompt]") y finalizar obligatoriamente incluyendo la porción de la voz narrativa que le corresponde entre paréntesis en formato (Voz narrativa: "[texto del guion]") (o "(Voz narrativa: Sin voz en off / Hook de puro Foley)" para clips sin locución, como Clip 1). (Ejemplos: "Clip 1 (00:00 - 00:04): [prompt...] (Voz narrativa: Sin voz en off / Hook de puro Foley)", "Clip 2 (00:04 - 00:12): [prompt...] (Voz narrativa: \"1888, en el callejón de Whitechapel...\")", etc.).
...
const PromptGenerator = () => {
  ...
  useEffect(() => {
    const key = 'huellas_master_template_v83';
