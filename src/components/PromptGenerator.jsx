...
- Promesa Narrativa y Slogan Completo Antes del Segundo 30 de Video (~segundos 20–30): Antes del segundo 30 de video (~segundos 20–30 de metraje), la voz narrativa debe articular obligatoriamente la Promesa Narrativa y el Slogan Completo, estructurados de forma estricta de la siguiente manera:
  ...
  3. Inmediatamente después de dicha explicación breve, se articula de forma inseparable el slogan completo oficial: "Si quieres seguir cruzando el umbral del tiempo para vivir la historia desde dentro, dale like a este video, compártelo y suscríbete. Cada historia deja una huella. Aquí seguimos sus rastros."
  (Estructura obligatoria unificada: "En los próximos minutos [explicación breve de lo que estará pasando en el documental]. Si quieres seguir cruzando el umbral del tiempo para vivir la historia desde dentro, dale like a este video, compártelo y suscríbete. Cada historia deja una huella. Aquí seguimos sus rastros.").
...
Promesa Narrativa y Slogan Completo (Antes del segundo 30 de video / "En los próximos minutos [explicación breve de lo que estará pasando en el documental]" + Slogan Completo): [PROMESA_NARRATIVA]
...
const PromptGenerator = () => {
  ...
  useEffect(() => {
    const key = 'huellas_master_template_v105';
