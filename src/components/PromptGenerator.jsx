...
- Para el Clip 1 (Hook de 4s):
  ...
  3. Prompt de Imagen Inicial (en inglés para Banana Pro con 'no text', comenzando obligatoriamente con "Imagen 1: Crea una imagen [prompt...]", incluyendo obligatoriamente tiempo y lugar como referencia visual).
  4. Prompt de Movimiento de Video con Audio Foley Integrado (en inglés para Omni Flash, estrictamente sin música ni voz / 'no music, no speech', comenzando obligatoriamente con el tiempo que cubre en formato (##:## - ##:##) y la orden obligatoria "Crea un video": "Clip 1 (00:00 - 00:04): Crea un video [prompt...]", incluyendo obligatoriamente tiempo y lugar como referencia visual).
...
- Para el Clip 2 (8s) y Clip 3 (8s):
  ...
  3. Prompt de Imagen Inicial (en inglés para Banana Pro con 'no text', comenzando obligatoriamente con "Imagen [número]: Crea una imagen [prompt...]", incluyendo obligatoriamente tiempo y lugar como referencia visual).
  4. Prompt de Movimiento de Video con Audio Foley Integrado (en inglés para Omni Flash, estrictamente sin música ni voz / 'no music, no speech', comenzando obligatoriamente con el tiempo que cubre en formato (##:## - ##:##) y la orden obligatoria "Crea un video": "Clip 2 (00:04 - 00:12): Crea un video [prompt...]", "Clip 3 (00:12 - 00:20): Crea un video [prompt...]", incluyendo obligatoriamente tiempo y lugar como referencia visual).
...
- Promesa del Documental + Slogan Corto antes del Minuto 2 (02:00): En producciones de 2 minutos o más (ej. Reels de 120s o documentales), antes de alcanzar el minuto 02:00 de metraje, la voz narrativa debe articular obligatoriamente la Promesa del Documental (el enigma, revelación o experiencia prometida) enlazada con la pronunciación del slogan corto oficial: "Cada historia deja una huella. Aquí seguimos sus rastros."
...
- Protocolo Obligatorio de Entrega en Bloques de 10 Clips (Alto entre Bloques):
  ...
  * Tras la confirmación del usuario, la IA entregará el Bloque 2 (Clips 11 al 13 o restantes) comenzando DIRECTAMENTE con los prompts (ej. Imagen 11: Crea una imagen, Clip 11 (01:36 - 01:46): Crea un video) SIN repetir la orden operativa, ya que la orden operativa se da EXCLUSIVAMENTE y por única vez en el primer bloque de prompts (Bloque 1).
...
- Formato Estricto de los Prompts (Orden Operativa EXCLUSIVA en el Primer Bloque):
  ...
  * Regla Inquebrantable de Apertura de Prompts ("Crea una imagen" / "Crea un video"): Inmediatamente después de la numeración en las imágenes estáticas, debe colocarse obligatoriamente la orden de acción "Crea una imagen " ("Imagen [número]: Crea una imagen [prompt...]"). Inmediatamente después de la numeración y el timestamp en los clips de video, debe colocarse obligatoriamente la orden de acción "Crea un video " ("Clip [número] (##:## - ##:##): Crea un video [prompt...]"). Queda estrictamente prohibido omitir estas frases de acción en la apertura de cualquier prompt.
...
- Estructura de Entrega Obligatoria para los 3 Clips:
  * CLIP 1 (HOOK DE 4s):
    ...
    3. Prompt de Imagen Inicial: En idioma inglés para 'banana pro' (comenzando obligatoriamente tras la numeración con "Imagen 1: Crea una imagen ", con sufijos obligatorios, 'no text' e incluyendo obligatoriamente tiempo y lugar como referencia visual).
    4. Prompt de Movimiento de Video (con Audio Foley Integrado): En idioma inglés para 'omni flash' (comenzando obligatoriamente con la numeración, el timestamp y la orden: "Clip 1 (00:00 - 00:04): Crea un video ", con diseño foley acústico integrado dentro del propio prompt, incluyendo obligatoriamente tiempo y lugar como referencia visual).
  ...
  * CLIP 2 (8s) y CLIP 3 (8s):
    ...
    3. Prompt de Imagen Inicial: En idioma inglés para 'banana pro' (comenzando obligatoriamente tras la numeración con "Imagen [número]: Crea una imagen ", con sufijos obligatorios, 'no text' e incluyendo obligatoriamente tiempo y lugar como referencia visual).
    4. Prompt de Movimiento de Video (con Audio Foley Integrado): En idioma inglés para 'omni flash' (comenzando obligatoriamente con la numeración, el timestamp y la orden: "Clip [número] (##:## - ##:##): Crea un video ", incluyendo obligatoriamente tiempo y lugar como referencia visual).
...
Usa omni flash para videos y banana pro para imágenes iniciales de cada clip.
Crea las imágenes primero y luego los clips usando cada imagen como fotograma inicial.
(Esta orden operativa NO se repite en el Bloque 2 ni en bloques posteriores). Seguida obligatoriamente de la secuencia de prompts en formato limpio y consecutivo: Imagen 1: Crea una imagen [prompt], Clip 1 (00:00 - 00:06): Crea un video [prompt] (Voz narrativa: Sin voz en off / Hook puro Foley), Imagen 2: Crea una imagen [prompt], Clip 2 (00:06 - 00:16): Crea un video [prompt] (Voz narrativa: "[texto del guion]"), etc. Prompt visual para generar la imagen inicial estática utilizando el modelo "banana pro" ([?SUB_OPCION_REELS=9X16]9:16[/?SUB_OPCION_REELS][?SUB_OPCION_REELS=16X9]16:9[/?SUB_OPCION_REELS] con 'no text', comenzando obligatoriamente tras la numeración con "Imagen [número]: Crea una imagen [prompt]", incluyendo obligatoriamente tiempo y lugar como anclaje y referencia visual histórica), y prompt técnico de movimiento con Foley integrado para generar el clip de video utilizando el modelo "omni flash" (comenzando obligatoriamente con la numeración, el intervalo de tiempo exacto que cubre cada clip en el timeline de CapCut en formato (##:## - ##:##) y la orden de acción obligatoria "Crea un video": "Clip [número] (##:## - ##:##): Crea un video [prompt técnico en inglés...]", incluyendo obligatoriamente tiempo y lugar de referencia visual histórica, y finalizando OBLIGATORIAMENTE AL FINAL DE TODO EL PROMPT con la porción de la voz narrativa que le corresponde en formato (Voz narrativa: "[texto]"), ej. "Clip [número] (##:## - ##:##): Crea un video [prompt en inglés con tiempo, lugar, Foley y sufijo] (Voz narrativa: '[texto del guion]')", quedando terminantemente prohibido omitir "Crea una imagen" o "Crea un video", omitir tiempo y lugar o situar la voz en off al inicio o en medio del prompt).
...
Inclusión Obligatoria de "Crea una imagen" y "Crea un video" tras Numeración y Timestamp: En cada prompt de imagen estática (Banana Pro), inmediatamente después de la numeración ("Imagen [número]: "), es obligatorio anteponer la frase literal: "Crea una imagen ". En cada prompt de clip de video (Omni Flash), inmediatamente después de la numeración y el timestamp del timeline de CapCut ("Clip [número] (##:## - ##:##): "), es obligatorio anteponer la frase literal: "Crea un video ". Esto actúa como comando de acción directo para las herramientas de IA generativa al procesar cada instrucción. Queda terminantemente prohibido omitir "Crea una imagen" o "Crea un video" en cualquier prompt.
...
- Orden Operativa Exclusiva del Primer Bloque de Prompts: Al inicio obligatorio del primer bloque de entrega de prompts de imágenes y videos (Bloque 1: Clips 1 al 10), la IA debe colocar obligatoriamente como preámbulo inicial la siguiente orden operativa textual (quedando estrictamente prohibido repetirla en los bloques subsiguientes):
  ...
  Usa omni flash para videos y banana pro para imágenes iniciales de cada clip.
  Crea las imágenes primero y luego los clips usando cada imagen como fotograma inicial.
- Prompts de Imagen Inicial con "Crea una imagen", Tiempo y Lugar: Todo prompt para generar la imagen fija inicial debe comenzar obligatoriamente tras la numeración con la frase: "Imagen [número]: Crea una imagen ", e incluir obligatoriamente el TIEMPO y LUGAR como anclaje y referencia visual histórica (ejemplos: "Imagen 1: Crea una imagen [prompt con tiempo y lugar...]", "Imagen 2: Crea una imagen [prompt con tiempo y lugar...]", etc.).
- Prompts de Clips de Video con Intervalo Temporal (##:## - ##:##), "Crea un video", Tiempo, Lugar y Voz Narrativa Obligatoriamente al Final: Todo prompt técnico de movimiento para generar el video con Foley integrado debe comenzar obligatoriamente indicando la numeración, el intervalo de tiempo exacto que cubre cada clip en el timeline de CapCut en formato (##:## - ##:##) y la orden literal obligatoria "Crea un video ": ("Clip [número] (##:## - ##:##): Crea un video [prompt técnico en inglés...]"), incluir obligatoriamente dentro de la descripción técnica en inglés el TIEMPO y LUGAR como referencia visual histórica (ej. 'in Whitechapel, London, England, 1888...'), y finalizar OBLIGATORIAMENTE AL FINAL DE TODO EL PROMPT (después del sufijo obligatorio de barrera sonora) incluyendo la porción de la voz narrativa que le corresponde entre paréntesis en formato (Voz narrativa: "[texto del guion]") (o "(Voz narrativa: Sin voz en off / Hook de puro Foley)" para clips sin locución, como Clip 1). Queda estrictamente prohibido omitir la orden "Crea un video", omitir el tiempo y lugar o situar el fragmento de voz narrativa antes o en medio del texto técnico en inglés. (Ejemplos: "Clip 1 (00:00 - 00:06): Crea un video [prompt con tiempo y lugar...] (Voz narrativa: Sin voz en off / Hook de puro Foley)", "Clip 2 (00:06 - 00:16): Crea un video [prompt con tiempo y lugar...] (Voz narrativa: \"1888, en el callejón de Whitechapel...\")", etc.).
...
const PromptGenerator = () => {
  ...
  useEffect(() => {
    const key = 'huellas_master_template_v87';
