...
- Slogan Completo Oficial y Promesa en Párrafo Aparte Antes del Segundo 30 de Video (~segundos 20–30): Antes del segundo 30 de video (~segundos 20–30 de metraje), TODO el bloque del Slogan Completo (desde "En los próximos minutos..." hasta "...Aquí seguimos sus rastros.") DEBE COLOCARSE OBLIGATORIAMENTE EN UN PÁRRAFO APARTE dentro del guion de locución, estructurado internamente en tres partes secuenciales unificadas:
  ...
  [Párrafo final - Cierre en párrafo aparte]: "Déjame saber en los comentarios... Cada historia deja una huella. Aquí seguimos sus rastros.").
...
- Cierre Obligatorio de la Locución con Llamada a Comentarios y Slogan Corto en Párrafo Aparte: Antes del slogan del cierre de la voz narrativa, la locución debe incluir obligatoriamente la frase: "Déjame saber en los comentarios..." (pudiendo formularse textualmente con los puntos suspensivos o completarse de forma orgánica con una pregunta o reflexión breve sobre el enigma o suceso histórico tratado, ej. "Déjame saber en los comentarios qué piensas sobre este suceso. Cada historia deja una huella. Aquí seguimos sus rastros." o "Déjame saber en los comentarios... Cada historia deja una huella. Aquí seguimos sus rastros."). La locución culmina obligatoriamente pronunciando como frase final de cierre el slogan corto oficial: "Cada historia deja una huella. Aquí seguimos sus rastros." Todo este bloque de cierre ("Déjame saber en los comentarios..." + slogan corto oficial) DEBE COLOCARSE OBLIGATORIAMENTE SEPARADO EN UN PÁRRAFO APARTE al final del guion de locución, y sus caracteres se contabilizan dentro de la extensión matemática del guion.
...
const PromptGenerator = () => {
  ...
  useEffect(() => {
    const key = 'huellas_master_template_v117';
