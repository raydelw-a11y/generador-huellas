...
[?OPCION_TEXTO_PANTALLA=CAPCUT_MANUAL]
  ...
  (Continuar consecutivamente con Image 3: Create an image [prompt con tiempo y lugar con '@'], Clip 3 (00:14 - 00:24): Create a video [prompt técnico en inglés con tiempo, lugar con '@', foley y sufijo de barrera sonora sin locución, cerrando con "fix the name"]... Image 4: Create an image [prompt con tiempo y lugar con '@'], Clip 4 (00:24 - 00:34): Create a video [prompt técnico en inglés con tiempo, lugar con '@', foley y sufijo de barrera sonora sin locución, cerrando con "fix the name"]... indicando siempre tras la numeración "Create an image" en imágenes estáticas, y tras la numeración y el timestamp (##:## - ##:##) "Create a video" en clips de video, con todos los prompts técnicos redactados al 100% en idioma inglés, incluyendo tiempo y lugar con '@' en personas y lugares, cerrando limpiamente cada clip con el sufijo de barrera sonora [...no text, no speech, no music. fix the name] excluyendo la voz narrativa hasta completar el bloque de 10 clips [Clips 1 al 10]).
[/?OPCION_TEXTO_PANTALLA]
[?OPCION_TEXTO_PANTALLA=IA_CLIP_1]
...
Usa omni flash para videos y banana pro para imágenes iniciales de cada clip.
Crea las imágenes primero y luego los clips usando cada imagen como fotograma inicial.
(Esta orden operativa NO se repite en el Bloque 2 ni en bloques posteriores). Seguida obligatoriamente de la secuencia de prompts en formato limpio y consecutivo: [?OPCION_TEXTO_PANTALLA=CAPCUT_MANUAL]Image 1: Create an image [prompt], Clip 1 (00:00 - 00:04): Create a video [prompt de 4s de duración cerrando con fix the name], Image 2: Create an image [prompt], Clip 2 (00:04 - 00:14): Create a video [prompt cerrando con fix the name], etc.[/?OPCION_TEXTO_PANTALLA][?OPCION_TEXTO_PANTALLA=IA_CLIP_1]Image 1: Create an image [prompt], Clip 1 (00:00 - 00:04): Create a video [prompt de 4s con texto integrado (bajar a 6s en edición) cerrando con fix the name], Image 2: Create an image [prompt], Clip 2 (00:06 - 00:16): Create a video [prompt de 10s comenzando con la voz narrativa en el segundo 6 cerrando con fix the name], etc.[/?OPCION_TEXTO_PANTALLA] Prompt visual para generar la imagen inicial estática utilizando el modelo "banana pro" ([?SUB_OPCION_REELS=9X16]9:16[/?SUB_OPCION_REELS][?SUB_OPCION_REELS=16X9]16:9[/?SUB_OPCION_REELS] con 'no text', redactado al 100% en inglés, comenzando obligatoriamente tras la numeración con "Image [número]: Create an image [prompt]" o "Imagen [número]: Create an image [prompt]", incluyendo obligatoriamente tiempo y lugar como anclaje y referencia visual histórica con prefijo '@' en personas y lugares), y prompt técnico de movimiento con Foley integrado para generar el clip de video utilizando el modelo "omni flash" (redactado al 100% en inglés, comenzando obligatoriamente con la numeración, el intervalo de tiempo exacto que cubre cada clip en el timeline de CapCut en formato (##:## - ##:##) y la orden de acción obligatoria en inglés "Create a video": "Clip [número] (##:## - ##:##): Create a video [prompt técnico en inglés...]", incluyendo obligatoriamente tiempo y lugar de referencia visual histórica con prefijo '@' en personas y lugares, [?VOZ_NARRATIVA_EN_CLIPS=INCLUIR]cerrando tras el sufijo de barrera sonora en inglés, incluyendo al final de todo el prompt la porción correspondiente de la voz narrativa colocada directamente como una oración más sin comillas ("") ni paréntesis (()), y agregando obligatoriamente al final "fix the name", ej. [?OPCION_TEXTO_PANTALLA=CAPCUT_MANUAL]"Clip 2 (00:04 - 00:14): Create a video [prompt en inglés con tiempo, lugar con '@', foley y sufijo]. Año 1888, callejón de Whitechapel, Londres, Inglaterra. El laberinto donde operaba... fix the name"[/?OPCION_TEXTO_PANTALLA][?OPCION_TEXTO_PANTALLA=IA_CLIP_1]"Clip 2 (00:06 - 00:16): Create a video [prompt en inglés con tiempo, lugar con '@', foley y sufijo]. Año 1888, callejón de Whitechapel, Londres, Inglaterra. El laberinto donde operaba... fix the name"[/?OPCION_TEXTO_PANTALLA], quedando terminantemente prohibido omitir "Create an image" o "Create a video", incluir términos en español en los descriptores técnicos del prompt, omitir tiempo y lugar, encerrar la voz narrativa entre comillas o paréntesis, u omitir "fix the name" al final[/?VOZ_NARRATIVA_EN_CLIPS][?VOZ_NARRATIVA_EN_CLIPS=EXCLUIR]cerrando limpiamente tras el sufijo de barrera sonora en inglés (...no text, no speech, no music. fix the name), excluyendo terminantemente el texto de la voz narrativa de los prompts de video, ej. [?OPCION_TEXTO_PANTALLA=CAPCUT_MANUAL]"Clip 2 (00:04 - 00:14): Create a video [prompt en inglés con tiempo, lugar con '@', foley y sufijo]. fix the name"[/?OPCION_TEXTO_PANTALLA][?OPCION_TEXTO_PANTALLA=IA_CLIP_1]"Clip 2 (00:06 - 00:16): Create a video [prompt en inglés con tiempo, lugar con '@', foley y sufijo]. fix the name"[/?OPCION_TEXTO_PANTALLA], quedando terminantemente prohibido omitir "Create an image" o "Create a video", incluir términos en español en los descriptores técnicos del prompt, omitir tiempo y lugar, omitir "fix the name", o añadir texto de locución al final del clip[/?VOZ_NARRATIVA_EN_CLIPS]).
[?OPCION_TEXTO_PANTALLA=CAPCUT_MANUAL]
...
[?VOZ_NARRATIVA_EN_CLIPS=INCLUIR]
- Prompts de Clips de Video con Intervalo Temporal (##:## - ##:##), "Create a video", Tiempo, Lugar con '@', Voz Narrativa y "fix the name" al Final: Todo prompt técnico de movimiento para generar el video con Foley integrado debe estar redactado al 100% en idioma inglés para los comandos y la descripción técnica cinematográfica, comenzando obligatoriamente indicando la numeración, el intervalo de tiempo exacto que cubre cada clip en el timeline de CapCut en formato (##:## - ##:##) y la orden de acción literal en inglés "Create a video ": ("Clip [número] (##:## - ##:##): Create a video [prompt técnico en inglés...]"), incluir obligatoriamente dentro de la descripción técnica en inglés el TIEMPO y LUGAR como referencia visual histórica con prefijo '@' en personas y lugares (ej. 'in @Whitechapel, @London, @England, 1888...'), cerrar la descripción con el sufijo obligatorio de barrera sonora (...no text, no speech, no music.), colocar la porción correspondiente de la voz narrativa como una oración más sin comillas ("") ni paréntesis (()), y agregar obligatoriamente al final "fix the name". Queda estrictamente prohibido omitir la orden "Create a video", incluir términos en español en la orden o descripción técnica del video, omitir el tiempo y lugar con '@', encerrar la voz narrativa entre comillas o paréntesis, u omitir "fix the name" al final. (Ejemplos: [?OPCION_TEXTO_PANTALLA=CAPCUT_MANUAL]"Clip 1 (00:00 - 00:04): Create a video [prompt técnico en inglés de 4s de duración con tiempo, lugar con '@', foley, sufijo y fix the name]", "Clip 2 (00:04 - 00:14): Create a video [prompt técnico en inglés con tiempo, lugar con '@', foley y sufijo]. Año 1888, callejón de Whitechapel, Londres, Inglaterra. El laberinto donde operaba... fix the name"[/?OPCION_TEXTO_PANTALLA][?OPCION_TEXTO_PANTALLA=IA_CLIP_1]"Clip 1 (00:00 - 00:04): Create a video [prompt técnico en inglés de 4s con texto cinematográfico, foley, sufijo (en edición bajar a 6s) y fix the name]", "Clip 2 (00:06 - 00:16): Create a video [prompt técnico en inglés con tiempo, lugar con '@', foley y sufijo]. Año 1888, callejón de Whitechapel, Londres, Inglaterra. El laberinto donde operaba... fix the name"[/?OPCION_TEXTO_PANTALLA], etc.).
[/?VOZ_NARRATIVA_EN_CLIPS]
[?VOZ_NARRATIVA_EN_CLIPS=EXCLUIR]
- Prompts de Clips de Video con Intervalo Temporal (##:## - ##:##), "Create a video", Tiempo, Lugar con '@', Exclusión de Voz y "fix the name" al Final (Prompts Limpios): Todo prompt técnico de movimiento para generar el video con Foley integrado debe estar redactado al 100% en idioma inglés para los comandos y la descripción técnica cinematográfica, comenzando obligatoriamente indicando la numeración, el intervalo de tiempo exacto que cubre cada clip en el timeline de CapCut en formato (##:## - ##:##) y la orden de acción literal en inglés "Create a video ": ("Clip [número] (##:## - ##:##): Create a video [prompt técnico en inglés...]"), incluir obligatoriamente dentro de la descripción técnica en inglés el TIEMPO y LUGAR como referencia visual histórica con prefijo '@' en personas y lugares (ej. 'in @Whitechapel, @London, @England, 1888...'), y cerrar la descripción estrictamente con el sufijo obligatorio de barrera sonora y la directiva al final (...no text, no speech, no music. fix the name), excluyendo terminantemente cualquier texto de locución o voz narrativa al final del prompt. Queda estrictamente prohibido omitir la orden "Create a video", incluir términos en español en la orden o descripción técnica del video, omitir el tiempo y lugar con '@', omitir "fix the name" al final, o agregar texto de voz en off al final del clip. (Ejemplos: [?OPCION_TEXTO_PANTALLA=CAPCUT_MANUAL]"Clip 1 (00:00 - 00:04): Create a video [prompt técnico en inglés de 4s de duración con tiempo, lugar con '@', foley, sufijo y fix the name]", "Clip 2 (00:04 - 00:14): Create a video [prompt técnico en inglés con tiempo, lugar con '@', foley, sufijo y fix the name]"[/?OPCION_TEXTO_PANTALLA][?OPCION_TEXTO_PANTALLA=IA_CLIP_1]"Clip 1 (00:00 - 00:04): Create a video [prompt técnico en inglés de 4s con texto cinematográfico, foley, sufijo (en edición bajar a 6s) y fix the name]", "Clip 2 (00:06 - 00:16): Create a video [prompt técnico en inglés con tiempo, lugar con '@', foley, sufijo y fix the name]"[/?OPCION_TEXTO_PANTALLA], etc.).
[/?VOZ_NARRATIVA_EN_CLIPS]
...
const PromptGenerator = () => {
  ...
  useEffect(() => {
    const key = 'huellas_master_template_v111';
