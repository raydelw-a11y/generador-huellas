...
- Para el Clip 1 (Hook de 4s):
  ...
  4. Prompt de Movimiento de Video con Audio Foley Integrado (en inglés para Omni Flash, estrictamente sin música ni voz / 'no music, no speech', comenzando obligatoriamente con el tiempo que cubre en formato (##:## - ##:##) y la orden en inglés "Create a video": "Clip 1 (00:00 - 00:04): Create a video [prompt...]", incluyendo obligatoriamente tiempo y lugar como referencia visual).
...
- Para el Clip 2 (8s) y Clip 3 (8s):
  ...
  4. Prompt de Movimiento de Video con Audio Foley Integrado (en inglés para Omni Flash, estrictamente sin música ni voz / 'no music, no speech', comenzando obligatoriamente con el tiempo que cubre en formato (##:## - ##:##) y la orden en inglés "Create a video": "Clip 2 (00:04 - 00:12): Create a video [prompt...]", "Clip 3 (00:12 - 00:20): Create a video [prompt...]", incluyendo obligatoriamente tiempo y lugar como referencia visual).
...
- Los primeros 6 segundos de video NO llevan voz en off (cubiertos por Clip 1 de 4s en prompt [00:00 - 00:04] con texto de apertura de documental cinematográfico generado por la IA en pantalla y puro Foley, ralentizado en edición en CapCut a 6 segundos para cubrir 00:00 - 00:06).
- La voz en off entra obligatoriamente en el segundo 00:06 del video (al inicio de Clip 2 [00:06 - 00:16]) y fluye de forma continua.
...
1. 60 segundos (Clip 1 de 4s ralentizado a 6s + 5 clips de 10s + Clip 7 de 4s = 54s de voz en off / ~954 caracteres con espacios)
2. 70 segundos (Clip 1 de 4s ralentizado a 6s + 6 clips de 10s + Clip 8 de 4s = 64s de voz en off / ~1130 caracteres con espacios)
3. 80 segundos (Clip 1 de 4s ralentizado a 6s + 7 clips de 10s + Clip 9 de 4s = 74s de voz en off / ~1307 caracteres con espacios)
4. 90 segundos (Clip 1 de 4s ralentizado a 6s + 8 clips de 10s + Clip 10 de 4s = 84s de voz en off / ~1483 caracteres con espacios)
5. 100 segundos (Clip 1 de 4s ralentizado a 6s + 9 clips de 10s + Clip 11 de 4s = 94s de voz en off / ~1660 caracteres con espacios)
6. 110 segundos (Clip 1 de 4s ralentizado a 6s + 10 clips de 10s + Clip 12 de 4s = 104s de voz en off / ~1837 caracteres con espacios)
7. 120 segundos / 2 min exactos (Clip 1 de 4s ralentizado a 6s + 11 clips de 10s + Clip 13 de 4s = 114s de voz en off / ~2013 caracteres con espacios)
8. O especificar cualquier otra duración en segundos que el usuario prefiera.
...
- Regla Fundamental de Audio (Entrada de Voz en Segundo 6): Los primeros 6 segundos de video NO llevan voz en off bajo ningún concepto (cubiertos por Clip 1 de 4s de duración en prompt [00:00 - 00:04] con texto de apertura de documental cinematográfico generado por la IA en pantalla y Foley puro, ralentizado en edición en CapCut a 6s para cubrir 00:00 - 00:06). La locución entra obligatoriamente en el segundo 00:06 de video (al inicio exacto de Clip 2 [00:06 - 00:16]).
- Cálculo Matemático Exacto de Duración y Extensión (Tasa Calibrada de 17.66 caracteres/segundo):
  ...
  * Tasa de Lectura Calibrada: Exactamente 17.66 caracteres por segundo de locución incluyendo los espacios (~141 caracteres por cada 8 segundos de locución continua; equivalente a ~1060 caracteres por minuto).
  * Extensión Estricta del Guion: Se calcula mediante la fórmula matemática:
    ...
    (Ejemplos exactos: 120s total -> 114s de voz = ~2013 caracteres con espacios; 116s total -> 110s de voz = ~1943 caracteres; 60s total -> 54s de voz = ~954 caracteres; 52s total -> 46s de voz = ~812 caracteres; 44s total -> 38s de voz = ~671 caracteres; 36s total -> 30s de voz = ~530 caracteres).
  * Reporte Obligatorio al Pie del Guion (Caracteres Totales y Caracteres por Minuto): Al finalizar la entrega del guion, la IA debe indicar obligatoriamente el recuento exacto de caracteres generados y, justo al lado de "Caracteres Totales: [número]", cuántos caracteres por minuto representa en el siguiente formato literal:
    ...
    (ejemplos: "Caracteres Totales: 7657 (1060 caracteres por minuto)", "Caracteres Totales: 2013 (1060 caracteres por minuto)"), mostrando justo al lado de Caracteres Totales cuántos caracteres por minuto representa (calculado dividiendo los caracteres totales entre los minutos de locución o aplicando la tasa calibrada de 17.66 caracteres/segundo x 60 = ~1060 caracteres por minuto), seguido del desglose de la duración en minutos y segundos de la locución.
- Hook de Inicio Obligatorio (Estructura de Apertura al Segundo 6 / Inicio de Clip 2): La locución arranca obligatoriamente en el segundo 00:06 del video total (al inicio exacto de Clip 2 [00:06 - 00:16], una vez culminados los primeros 6 segundos de apertura cubiertos por Clip 1 ralentizado en CapCut) y su frase inicial DEBE ESTRUCTURARSE DE FORMA INNEGOCIABLE EN LA SIGUIENTE TRÍADA SECUENCIAL:
...
- Promesa del Documental al Final del Primer Minuto + Slogan Completo (Minuto 01:00 / Segundos 50–60): En producciones de 60 segundos o más (ej. Reels de 60s, 120s o documentales), justo al final del primer minuto de metraje (~00:50 - 01:00), la voz narrativa debe articular obligatoriamente la Promesa del Documental. Dicha promesa DEBE COMENZAR OBLIGATORIA Y ESTRICTAMENTE con la frase: "En este documental..." (ej. "En este documental descubrirás...", "En este documental revelaremos..."), y al final de la promesa se debe articular obligatoriamente el slogan completo oficial: "Si quieres seguir cruzando el umbral del tiempo para vivir la historia desde dentro, dale like a este video, compártelo y suscríbete. Cada historia deja una huella. Aquí seguimos sus rastros."
...
- Cierre Obligatorio de la Locución con el Slogan Corto en Párrafo Aparte: La voz en off debe culminar obligatoriamente pronunciando como frase final de cierre el slogan corto oficial: "Cada historia deja una huella. Aquí seguimos sus rastros." (se contabilizan sus ~57 caracteres con espacios dentro de la extensión matemática del guion). Este slogan corto final DEBE COLOCARSE OBLIGATORIAMENTE SEPARADO EN UN PÁRRAFO APARTE al final del guion de locución.
...
- Estructura de Entrega de las Imágenes Modelo de Referencia (en idioma inglés para Banana Pro):
  ...
  1. Personas (@Personas): Prompts de modelo de personaje / retrato conceptual (character reference sheet / portrait), identificados como Image @[Nombre de la Persona]: Create an image... (ej. "Image @Jack The Ripper: Create an image..."), detallando rostro, edad histórica, rasgos fisonómicos distintivos, indumentaria de época rigurosamente auténtica, iluminación y textura de la piel, cerrando con: cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music.
  2. Lugares (@Lugares): Prompts de modelo de entorno / arquitectura (establishing shot / environment reference model), identificados como Image @[Nombre del Lugar]: Create an image... (ej. "Image @Whitechapel: Create an image..."), detallando materialidad de las calles, edificios, atmósfera, clima e iluminación de época, cerrando con: cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music.
  3. Objetos (@Objetos): Prompts de modelo de primer plano (macro / prop reference model) para objetos, reliquias, armas, herramientas o documentos clave que jueguen un rol determinante en la historia, identificados como Image @[Nombre del Objeto]: Create an image... (ej. "Image @Scalpel: Create an image..."), detallando materiales, desgaste histórico y textura, cerrando con: cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music.
Estas imágenes modelo de referencia constituyen el anclaje visual ('ground truth') que la IA y el usuario utilizarán para mantener una rigurosa consistencia facial, arquitectónica y estética a lo largo de todos los clips del video.
...
Tras la validación de las imágenes modelo de referencia de personas, lugares y objetos, la IA generará y entregará los clips de video correspondientes a la duración elegida en bloques controlados de 10 clips (ej. Bloque 1: Clips 1 al 10; Bloque 2: Clips 11 al 13 o restantes):
- Cantidad de Clips y Cuadre Matemático Exacto:
  * Clip 1: Cobertura temporal y duración obligatoria de 4 segundos en el prompt de clip (00:00 - 00:04). Prompt técnico en inglés para Omni Flash de 4s de duración con puro diseño sonoro Foley ambiental (Hook de apertura de alto impacto sensorial). Estrictamente SIN voz en off. El texto en pantalla de apertura tipo comienzo de documental cinematográfico va EXCLUSIVAMENTE en el prompt del Clip 1, NO en el prompt de la Image 1 (la cual se genera completamente limpia con 'no text'). En Clip 1, la IA genera directamente en pantalla el rótulo de apertura en dos líneas centradas (Línea 1: Ciudad, País, Tiempo; Línea 2: Gancho intrigante o perturbador) con encuadre seguro (safe framing composition) y tipografía cinematográfica sobria. Por tanto, Clip 1 es el ÚNICO prompt donde se omite la instrucción 'no text'. Posteriormente, en edición en CapCut, el editor reduce la velocidad de reproducción de este clip de 4s para llevarlo a 6 segundos (00:00 - 00:06).
  * Clip 2: Cobertura temporal de 00:06 a 00:16 (10 segundos de duración en el timeline de CapCut). La voz narrativa continua da comienzo exactamente en el segundo 00:06 del video (al inicio exacto de este clip). A partir de Clip 2 (tanto en Image 2 como en Clip 2 en adelante), todos los prompts de imágenes y clips llevan estrictamente 'no text' para mantener la imagen completamente limpia.
  * Clips subsiguientes (Clip 3 en adelante): Clips de 10 segundos cada uno (decidiendo la IA con criterio cinematográfico si cada clip es de un solo shot continuo de 10s o de dos shots de 5s + 5s).
  * Regla Inquebrantable de Compensación de Timestamps (+6 Segundos): La IA debe tener en cuenta que el software de audio y transcripción del usuario arranca sus marcas de tiempo desde 00:00 (mientras que en edición el audio se coloca a partir del segundo 00:06). Por tanto, la IA realiza automáticamente la compensación de +6 segundos: el fragmento de voz inicial (00:00 - 00:10) se asigna a los 10 segundos de Clip 2 (00:06 - 00:16, donde la voz entra exactamente al segundo 00:06), el de 00:10 - 00:20 a Clip 3 (00:16 - 00:26), etc., mostrando en los prompts exclusivamente el tiempo real del timeline de video en CapCut (##:## - ##:##).
  * Regla Inquebrantable de Cuadre Total: La suma exacta de los segundos de todos los clips generados DEBE coincidir con precisión milimétrica con la duración total acordada con el usuario, sin que falte ni sobre un solo segundo:
    - Si el usuario acordó 120 segundos (2 min exactos): La IA generará obligatoriamente Clip 1 (00:00 - 00:04 en prompt, 4s generado por Omni Flash con texto en pantalla tipo documental y puro Foley, ralentizado en CapCut a 6s para cubrir 00:00 - 00:06) + 11 clips de 10s (00:06 a 01:56, 110s de locución: Clips 2 al 12) + Clip 13 final de 4s (01:56 a 02:00, 4s de locución con el slogan oficial corto y plano macro de huella/rastro físico) = 120s exactos en el timeline (6s + 110s + 4s = 120s en 13 clips totales, con 114s de voz en off).
    - Si el usuario acordó 60 segundos (1 min): Se generará Clip 1 (00:00 - 00:04 en prompt, 4s ralentizado en CapCut a 6s para cubrir 00:00 - 00:06) + 5 clips de 10s (00:06 a 00:56, 50s de locución: Clips 2 al 6) + Clip 7 final de 4s (00:56 a 01:00, 4s de locución con slogan oficial) = 60s exactos en el timeline (6s + 50s + 4s = 60s en 7 clips totales, con 54s de voz en off).
    - Para cualquier otra duración personalizada, si (Duración Total - 6s de apertura de Clip 1) no es múltiplo exacto de 10, la IA ajustará un clip final con los segundos exactos restantes para completar la duración solicitada sin faltantes.
...
- Decisión Inteligente de Shots por Clip (10s vs 5s + 5s):
  La IA decidirá con criterio cinematográfico cuáles clips serán de un solo shot continuo (10s) y cuáles de dos shots (5s + 5s) dependiendo de la escena y la voz en off:
  * Un solo shot continuo (10s): Se selecciona para escenas de contemplación profunda, misterio paulatino, tensión atmosférica lenta, planos panorámicos o planos macro de hipertextura.
  * Dos shots internos (5s + 5s): Se selecciona cuando la voz narrativa describe giros rápidos, relaciones de causa-efecto, acción-reacción o saltos de escala (ej. pasar de un plano general del entorno a un primer plano del sujeto u objeto en tensión). En estos casos, el prompt debe describir la acción y el Foley integrado de cada shot.
...
- Protocolo Obligatorio de Entrega en Bloques de 10 Clips (Alto entre Bloques):
  * Si la producción tiene más de 10 clips en total (ej. un video de 120s con 13 clips), la IA generará y entregará en esta primera interacción ÚNICAMENTE el Bloque 1 correspondiente a los primeros 10 clips (Clips 1 al 10).
  * Al finalizar los 10 clips del Bloque 1, la IA DEBE DETENERSE OBLIGATORIAMENTE mediante la instrucción:
    -> ALTO INQUEBRANTABLE: La IA entrega el bloque de 10 clips (Clips 1 al 10) y concluye su respuesta deteniéndose. Espera la confirmación del usuario para generar y entregar el siguiente bloque (Clips 11 al 13 o restantes). NO entregues la metadata ni pases a la siguiente etapa hasta completar todos los clips.
  * Tras la confirmación del usuario, la IA entregará el Bloque 2 (Clips 11 al 13 o restantes) comenzando DIRECTAMENTE con los prompts (ej. Image 11: Create an image, Clip 11 (01:36 - 01:46): Create a video) SIN repetir la orden operativa, ya que la orden operativa se da EXCLUSIVAMENTE y por única vez en el primer bloque de prompts (Bloque 1).
  * Si la producción tiene 10 clips o menos en total (ej. un video de 60s con 7 clips), la IA entregará la totalidad de los clips en un único bloque y se detendrá con el ALTO INQUEBRANTABLE antes de pasar a la siguiente etapa (Etapa 6: Metadata).
...
- Formato Estricto de los Prompts (Orden Operativa EXCLUSIVA en el Primer Bloque):
  ...
  Inmediatamente después de esta orden (en el Bloque 1), la IA entregará la secuencia de prompts correspondiente al bloque (incluyendo obligatoriamente en cada clip de video el tiempo real de CapCut que cubre en formato (##:## - ##:##), aplicando la compensación de +6s respecto a la transcripción de audio, y anexando al final de cada clip que lleve locución la porción correspondiente de la voz narrativa como una oración más sin comillas ni paréntesis):
  ...
  * Regla Inquebrantable de Inclusión de Tiempo y Lugar con Prefijo '@' en Cada Prompt: En absolutamente CADA prompt de imagen estática (Banana Pro) y en CADA prompt de clip de video (Omni Flash), la IA DEBE INCLUIR OBLIGATORIAMENTE el TIEMPO (año exacto en dígitos o época histórica, ej. '1888', '1944', 'Victorian era') y el LUGAR (ciudad, país, entorno geográfico o locación específica con prefijo '@', ej. 'in @Whitechapel, @London, @England', 'in @Paris, @France') como anclaje y referencia visual ineludible. Asimismo, cuando se mencione a personajes o figuras clave en los prompts, debe anteponerse siempre el prefijo '@' (ej. '@Jack The Ripper', '@Julio César'). Esto garantiza la concordancia con las imágenes modelo de referencia y la máxima fidelidad documental.
  * Regla Inquebrantable de Texto en Pantalla Generado por IA Exclusivo en Clip 1 (NO en Image 1): El texto en pantalla de los primeros 6 segundos va ÚNICAMENTE en el prompt del Clip 1 (Omni Flash), NO en el prompt de la Image 1. En Image 1 (Banana Pro), la imagen debe generarse completamente limpia y visual con 'no text' al igual que todas las demás imágenes. En Clip 1, la IA instruye al motor a renderizar directamente en pantalla el texto de apertura de documental cinematográfico en dos líneas centradas: Línea 1 con Ciudad, País, Tiempo (ej. "London, England, 1888") y Línea 2 justo debajo con la frase de Gancho intrigante o perturbadora, con tipografía cinematográfica sobria y encuadre seguro (safe framing composition). Por tanto, Clip 1 es el ÚNICO prompt donde se omite la directriz negativa 'no text'. A partir de Clip 2 en adelante, y en todas las imágenes desde Image 1, todos los prompts de imagen y video deben incluir estrictamente 'no text'.
  * Regla Inquebrantable de la Voz Narrativa al Final como una Oración Más (Sin Comillas ni Paréntesis): En cada prompt de clip de video que lleve locución (Clip 2 en adelante), la IA DEBE COLOCAR OBLIGATORIAMENTE al final de todo el prompt la porción correspondiente del guion de voz en off. Dicho texto se sitúa al final como UNA ORACIÓN MÁS, inmediatamente después del punto del sufijo obligatorio de barrera sonora en inglés (...no text, no speech, no music. [Texto de la locución]). Queda TERMINANTEMENTE PROHIBIDO encerrar la voz narrativa entre comillas (""), envolverla en paréntesis (()) o escribir etiquetas burocráticas como '(Voz narrativa: ...)'. Se anexa directamente como una última oración continua y limpia. Para Clip 1 (00:00 - 00:04), al tener una duración obligatoria de 4 segundos en Omni Flash y ser el Hook inicial sin voz en off de puro diseño sonoro Foley (ralentizado en CapCut a 6s), el prompt concluye directamente con el sufijo sin ninguna oración adicional de voz.

  Image 1: Create an image [prompt en inglés optimizado para Banana Pro en formato [?SUB_OPCION_REELS=9X16]vertical 9:16[/?SUB_OPCION_REELS][?SUB_OPCION_REELS=16X9]horizontal 16:9[/?SUB_OPCION_REELS] con 'no text', indicando obligatoriamente TIEMPO y LUGAR con prefijo '@' para referencia visual (ej. 'in @Whitechapel, @London, @England, 1888...'), encuadre centrado, sujeto, atmósfera, iluminación y óptica, cerrando con: cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music.]
  Clip 1 (00:00 - 00:04): Create a video [prompt técnico en inglés para Omni Flash de 4s de duración (Hook de apertura de impacto con puro diseño sonoro Foley ambiental, estrictamente sin voz en off, ralentizado luego en edición en CapCut a 6s para cubrir 00:00 - 00:06), indicando obligatoriamente TIEMPO y LUGAR con prefijo '@' para referencia visual (ej. 'in a dark cobblestone alley in @Whitechapel, @London, @England, 1888...'), instruyendo a la IA a renderizar directamente en pantalla el texto de apertura tipo comienzo de documental cinematográfico centrado en dos líneas: Línea 1 con Ciudad, País, Tiempo (ej. "London, England, 1888") y Línea 2 justo debajo con la frase de Gancho intrigante o perturbadora, con tipografía cinematográfica sobria, safe framing composition, movimiento de cámara sutil o fijo, cerrando con: strictly no music, no speech, cinematic documentary realism, no modern objects, no CGI look, no speech, no music.]

  Image 2: Create an image [prompt en inglés para Banana Pro [?SUB_OPCION_REELS=9X16]9:16[/?SUB_OPCION_REELS][?SUB_OPCION_REELS=16X9]16:9[/?SUB_OPCION_REELS] con 'no text', indicando obligatoriamente TIEMPO y LUGAR con prefijo '@' para referencia visual, encuadre centrado, sujeto, atmósfera, iluminación y óptica, cerrando con: cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music.]
  Clip 2 (00:06 - 00:16): Create a video [prompt técnico en inglés para Omni Flash de 10s de duración (cobertura temporal de 00:06 a 00:16 en CapCut, donde la locución narrativa arranca exactamente en el segundo 00:06 de video, 1 shot de 10s o 2 shots de 5s+5s según dinamismo, con Foley ambiental integrado), indicando obligatoriamente TIEMPO y LUGAR con prefijo '@' para referencia visual (ej. 'in @Whitechapel, @London, @England, 1888...'), sujeto (@Persona si aplica), acción física, cámara, iluminación y óptica, cerrando con: strictly no music, no speech, cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music. Año 1888, callejón de Whitechapel, Londres, Inglaterra, el laberinto donde operaba un cazador nocturno que la policía jamás atrapó.]

  (Continuar consecutivamente con Image 3: Create an image [prompt con tiempo y lugar con '@', 'no text'], Clip 3 (00:16 - 00:26): Create a video [prompt técnico en inglés con tiempo, lugar con '@', 'no text', foley, sufijo, y la porción de locución que cubre este clip anexada al final como una oración más sin comillas ni paréntesis]... Image 4: Create an image [prompt con tiempo y lugar con '@', 'no text'], Clip 4 (00:26 - 00:36): Create a video [prompt técnico en inglés con tiempo, lugar con '@', 'no text', foley, sufijo, y la locución correspondiente como una oración más sin comillas ni paréntesis]... indicando siempre tras la numeración "Create an image" en imágenes estáticas, y tras la numeración y el timestamp (##:## - ##:##) "Create a video" en clips de video, con todos los prompts técnicos redactados al 100% en idioma inglés, incluyendo tiempo y lugar con '@' en personas y lugares, cerrando el clip con el sufijo de barrera sonora y colocando la locución al final como una oración más sin comillas ni paréntesis hasta completar el bloque de 10 clips [Clips 1 al 10]).
-> ALTO INQUEBRANTABLE: La IA entrega el bloque de 10 clips y concluye su respuesta deteniéndose. Espera la confirmación del usuario para entregar el siguiente bloque (Clips 11 al 13 o restantes, el cual iniciará directamente con Image 11: Create an image [prompt], Clip 11 (01:36 - 01:46): Create a video [prompt], sin la orden operativa). Una vez completados y entregados todos los clips de video del proyecto, la IA pasará obligatoriamente a la Etapa 6 (Metadata). NO generes la metadata de publicación en esta etapa.

ETAPA 6: METADATA PARA SUBIR EL VIDEO (ENTREGA POSTERIOR)
Una vez completados y validados todos los clips de video por el usuario, en una interacción posterior la IA generará la metadata de publicación en formato "Todo Corrido" y SIN encabezados de sección (cero "Título:", cero "Descripción:", cero "Comentario Fijado:"):
...
Promesa Narrativa (Al final del primer minuto / comienza con "En este documental..." + Slogan Completo): [PROMESA_NARRATIVA]
...
[?TIPO_PRODUCCION=TIMELAPSE]
Capítulo 2: La Promesa Narrativa con el Slogan Completo, el Slogan Corto al Final y los Micro-Ganchos cada 90 Segundos
Todo episodio que aspire a construir una audiencia leal requiere una promesa clara y transparente. Esta debe aparecer obligatoriamente al final del primer minuto de metraje (~minuto 01:00 / segundos 50–60) de cada episodio, y DEBE COMENZAR OBLIGATORIA Y ESTRICTAMENTE con la frase: "En este documental..." (ej. "En este documental descubrirás...", "En este documental revelaremos..."), integrando de forma inseparable al final de la promesa la articulación del slogan completo oficial: "Si quieres seguir cruzando el umbral del tiempo para vivir la historia desde dentro, dale like a este video, compártelo y suscríbete. Cada historia deja una huella. Aquí seguimos sus rastros." No es un simple truco de marketing; es un contrato donde le aseguramos al espectador que no recibirá una clase de historia tradicional. Debe dejar claro de qué trata el episodio, qué enigma histórico, tensión social o perspectiva inédita descubrirá si se queda hasta el final, prometiéndole habitar el pasado desde adentro. Al concluir el episodio, la locución cierra obligatoriamente con el slogan corto ("Cada historia deja una huella. Aquí seguimos sus rastros.") ubicado obligatoriamente separado en un párrafo aparte.
...
El proceso de manufactura audiovisual en Huellas de la Humanidad repudia la improvisación visual. Se rige por un principio operativo denominado Sincronización Inversa Absoluta. En la producción tradicional, a menudo la imagen dicta el ritmo; en nuestro sistema, la voz humana es el metrónomo inalterable. La generación de prompts sobre tiempos teóricos está prohibida. El flujo inquebrantable desde la investigación hasta la exportación consta de los siguientes pasos:Investigación Multidimensional (Filtro de Realidad): Toda producción comienza con una investigación organizada en cinco capas progresivas: 1) Hechos básicos y cronología; 2) Contexto estructural sociopolítico; 3) Experiencia humana a través de testimonios y reconstrucciones; 4) Interpretación y debate histórico; 5) Dimensión visual y arquitectónica real. Si un elemento no es historically verificable o lógicamente inferible, se descarta.Arquitectura Conceptual: El equipo define explícitamente la Contradicción Central, redacta la Promesa Narrativa (ubicada al final del primer minuto, comenzando obligatoriamente con "En este documental..." y articulando al final el slogan completo oficial) y establece la Imagen Final hacia la cual convergerá el episodio.Redacción Cronometrada: El guion se escribe optimizado para mantener una cadencia rigurosa de 112 a 114 Palabras Por Minuto (WPM), articulando micro-ganchos cada 90 segundos para que el espectador no lo sepa todo en el minuto 2 y culminando la voz en off con el eslogan corto oficial de la marca separado en un párrafo aparte.Grabación de la Pista Maestra: La locución se registra respetando los tonos institucionales (Formato A) o de crónica (Formato B), y se masteriza como el eje de la producción.Construcción del Timeline Real: Una vez renderizado el audio, se mapean las marcas de tiempo milimétricas. El guion se transforma en una hoja de cálculo temporal. Si el locutor menciona "el colapso de la torre" en el minuto 03:14, el clip visual generado debe coordinar esa acción física exactamente en esa marca de tiempo.Diseño de Escenas y Asignación Foley (Decisión de Shots 10s vs 5s + 5s): Se fragmenta el timeline en bloques de 10 segundos con Omni Flash, determinando la IA cuáles tendrán dos shots de 5 segundos cada uno y cuáles se mantendrán como un shot continuo de 10 segundos dependiendo de la escena y la voz en off, asignando la acción visual precisa y el diseño acústico (Foley) que acompañará a cada escena.Ingeniería de Prompts y Renderizado: Redacción técnica de las instrucciones en inglés para el motor [MODELO_DE_IA] e inicio de la generación de lotes bajo el principio de diseño para reproducción en silencio (subtítulos dinámicos y apoyo visual claro obligatorios).Edición Invisible: Montaje en software con cortes motivados por la emoción o el cambio de espacio, aplicando una sincronización audiovisual total.Empaque SEO y QA: Elaboración de miniaturas, auditoría final mediante el checklist y configuración del algoritmo de publicación.
[/?TIPO_PRODUCCION]
[?TIPO_PRODUCCION=REELS]
Capítulo 9: Flujo de Trabajo (Formato Reels)
El formato "Reels" es un video cinematográfico ([?SUB_OPCION_REELS=9X16]vertical 9:16[/?SUB_OPCION_REELS][?SUB_OPCION_REELS=16X9]horizontal 16:9[/?SUB_OPCION_REELS]) estructurado con duración flexible definida por el usuario. Los primeros 6 segundos de video no llevan voz en off (cubiertos por Clip 1 de 4 segundos de duración en el prompt de Omni Flash [00:00 - 00:04] con texto de apertura de documental cinematográfico generado directamente por la IA en pantalla y puro diseño sonoro Foley, ralentizado luego en edición en CapCut a 6 segundos [00:00 - 00:06]). La locución narrativa entra obligatoriamente en el segundo 00:06 del video (al inicio de Clip 2 [00:06 - 00:16]), con voz continua en tercera persona (estrictamente sin hablar en "nosotros", sin silencios estructurales /2s o /#s, y sin forzar anonimización con palabras como "anónimos"). La voz en off arranca obligatoriamente en ese segundo 6 con un preámbulo estructurado estrictamente en: 1) Tiempo (años en números/dígitos; iniciando obligatoriamente con "Año" [número] si es únicamente el año sin mes ni día, ej. "Año 1888", "Año 44 antes de Cristo"), 2) Lugar, ciudad y país mencionado acto seguido sin poner "en el" (ej. "Año 1888, callejón de Whitechapel, Londres, Inglaterra..."), y 3) Descripción breve del lugar, suceso histórico, personaje o temática del video, capturando de inmediato al espectador con un elemento intrigante o perturbador. La duración total del video es igual a los 6 segundos iniciales sin voz más el tiempo de la voz en off (Tiempo de Voz en Off = Duración Total - 6s), calculando la extensión del guion con la métrica calibrada de 17.66 caracteres por segundo de locución (~141 caracteres por cada 8 segundos de locución). El guion integra la promesa del documental al final del primer minuto comenzando obligatoriamente con "En este documental..." y culminando al final de la promesa con el slogan completo oficial ("Si quieres seguir cruzando el umbral del tiempo para vivir la historia desde dentro, dale like a este video, compártelo y suscríbete. Cada historia deja una huella. Aquí seguimos sus rastros."), articula micro-ganchos cada 90 segundos para sostener la intriga sin revelarlo todo prematuramente, y culmina obligatoriamente pronunciando el slogan corto oficial en un párrafo aparte al final del guion: "Cada historia deja una huella. Aquí seguimos sus rastros." Todo el metraje se concibe bajo el principio de Diseño para Reproducción en Silencio (el 70% consume inicialmente sin audio, por lo que el apoyo visual y los subtítulos dinámicos en CapCut son obligatorios). Se ejecuta de forma innegociable en 6 etapas por separado: 1) Selección del tema y tipología; 2) Pregunta y definición de la duración total del video; 3) Guion de voz en off continua proporcional a la duración (Duración Total - 6s) x 17.66 caracteres con espacios (ej. 114s de locución [video de 120s] = ~2013 caracteres; 54s de locución [video de 60s] = ~954 caracteres), indicando obligatoriamente al pie del guion el formato "Caracteres Totales: [número] ([X] caracteres por minuto)"; 4) Generación de prompts de imágenes modelo de referencia para las personas, lugares y objetos más importantes anteponiendo al inicio en una sola oración la orden "Cambia los nombres y ponles @ seguido del nombre del lugar, persona u objeto correspondiente." y utilizando el prefijo '@' en nombres de personas, lugares y objetos para fijar la consistencia visual; 5) Generación y entrega de prompts de imágenes iniciales e indicando en cada clip de video el tiempo que cubre en formato (##:## - ##:##) en bloques de 10 clips con Banana Pro y Omni Flash con Foley integrado (strictly no music), donde el texto de apertura de documental cinematográfico (Ciudad, País, Tiempo / Gancho) va exclusivamente en el prompt de Clip 1 (00:00 - 00:04) para ser ralentizado a 6s en CapCut (no en Image 1, la cual lleva estrictamente 'no text'), mientras que a partir de Clip 2 (00:06 - 00:16) en adelante se aplica estrictamente 'no text' anexando al final de cada clip con voz la locución como una oración más sin comillas ni paréntesis, decidiendo la IA cuáles clips serán de un solo shot (10s) y cuáles de dos shots (5s + 5s) según la escena y la locución, anteponiendo la orden operativa EXCLUSIVAMENTE en el primer bloque de prompts (Bloque 1); 6) Metadata para subir el video en formato Todo Corrido de 2100 caracteres sin encabezados con CTA natural en comentarios.
[/?TIPO_PRODUCCION]
[?TIPO_PRODUCCION=INMERSIVO_CONTEMPLATIVO]
...
- Estructura de Entrega Obligatoria para los 3 Clips:
  * CLIP 1 (HOOK DE 4s):
    ...
    4. Prompt de Movimiento de Video (con Audio Foley Integrado): En idioma inglés para 'omni flash' (comenzando obligatoriamente con la numeración, el timestamp y la orden en inglés: "Clip 1 (00:00 - 00:04): Create a video ", con diseño foley acústico integrado dentro del propio prompt, incluyendo obligatoriamente tiempo y lugar como referencia visual).
  ...
  * CLIP 2 (8s) y CLIP 3 (8s):
    ...
    4. Prompt de Movimiento de Video (con Audio Foley Integrado): En idioma inglés para 'omni flash' (comenzando obligatoriamente con la numeración, el timestamp y la orden en inglés: "Clip [número] (##:## - ##:##): Create a video ", incluyendo obligatoriamente tiempo y lugar como referencia visual).
...
- Ley Tipográfica de Seguridad: En Clip 1 (el Hook de apertura, donde va exclusivamente el texto en pantalla y no en Image 1), el texto generado por la IA en pantalla (Ciudad, País, Tiempo y Gancho intrigante) debe estar perfectamente centrado, con un margen lateral y vertical de seguridad ancho y limpio (safe framing composition) para evitar que la interfaz nativa del móvil (botones de like, comentarios, bordes de pantalla) lo recorte.
- Arquitectura Temporal (Fórmula de Duración Total): La duración total del video se compone de: 6 segundos iniciales sin voz en off cubiertos por el Clip 1 de 4 segundos de duración en el prompt (00:00 - 00:04) con puro Foley ambiental y texto de apertura tipo documental generado por la IA en pantalla, ralentizado en edición en CapCut a 6 segundos (00:00 - 00:06), seguidos por la voz narrativa continua que entra exactamente en el segundo 00:06 de video (al comenzar el Clip 2 [00:06 - 00:16]). La suma de los 6 segundos iniciales sin voz más el tiempo de duración de la voz en off da el total exacto del video (Total = 6s + Tiempo de Voz en Off; es decir, Tiempo de Voz en Off = Duración Total - 6s; ej. en video de 120s = 6s iniciales sin voz + 114s de voz en off).
- Voz en Off, Foley y Compensación de Timestamps (+6s): Acompañado de locución narrativa solemne y continua que arranca obligatoriamente en el segundo 00:06 del video (al inicio de Clip 2 [00:06 - 00:16]). Los primeros 6 segundos (cubiertos por Clip 1 de 4s [00:00 - 00:04] ralentizado a 6s en CapCut) carecen por completo de locución para maximizar el misterio y el impacto sensorial visual con Foley. La IA debe compensar automáticamente el desfase de +6 segundos entre la transcripción/audio del usuario (que empieza en 00:00) y el timeline de video en CapCut (que arranca la voz en 00:06): el bloque inicial de locución (00:00 - 00:10) se asigna a los 10 segundos de Clip 2 (00:06 - 00:16, donde la voz entra al segundo 00:06), el de 00:10 - 00:20 a Clip 3 (00:16 - 00:26), etc. La extensión del texto de la voz en off debe calibrarse estrictamente con la métrica empírica de 17.66 caracteres por segundo de locución ((Duración Total - 6s) x 17.66 caracteres con espacios; ej. 114s de voz en off para un video de 120s = ~2013 caracteres; 54s de voz en off para un video de 60s = ~954 caracteres; equivalentes a ~176 caracteres por cada bloque de 10s de locución continua; estrictamente sin silencios estructurales ni pausas artificiales /2s o /#s), complementada con el paisaje sonoro de Foley integrado en cada prompt de video (estrictamente sin música en ningún clip). El preámbulo inicial de la voz en off (al segundo 00:06 de video / inicio de Clip 2) debe estructurarse obligatoriamente en tres partes: 1) Tiempo (años siempre en números/dígitos; si es únicamente el año sin mes ni día, iniciando obligatoriamente con "Año" [número], ej. "Año 1888", "Año 44 antes de Cristo"), 2) Lugar, ciudad y país mencionado acto seguido sin anteponer "en el" ni preposiciones de relleno (ej: "Año 1888, callejón de Whitechapel, Londres, Inglaterra...", quedando terminantemente prohibido escribir "en el" después del año), y 3) Descripción breve del lugar, suceso histórico, personaje o tema central abordado, capturando de inmediato con un gancho profundamente intrigante o terrorífico. La voz en off debe narrar en tercera persona de forma directa y cinematográfica, sin hablar jamás en primera persona del plural ("nosotros") y sin forzar anonimizaciones artificiales ("anónimos").
- Estructura de Generación de Clips en Bloques de 10: Para producciones con más de 10 clips (ej. 120s con 13 clips totales), la IA debe entregar los prompts estrictamente en bloques controlados de 10 clips (Bloque 1: Clips 1 al 10 con ALTO INQUEBRANTABLE esperando confirmación para el Bloque 2: Clips 11 al 13). Al inicio EXCLUSIVO DEL PRIMER BLOQUE de entrega (Bloque 1), la IA debe anteponer la orden operativa:
Actúa como un historiador, director de cine, y periodista profesional.
Cambia los nombres de los clips a las primeras 6 palabras literales del prompt proveído pegado y enviado que incluyen la numeración.
Usa omni flash para videos y banana pro para imágenes iniciales de cada clip.
Crea las imágenes primero y luego los clips usando cada imagen como fotograma inicial.
(Esta orden operativa NO se repite en el Bloque 2 ni en bloques posteriores). Seguida obligatoriamente de la secuencia de prompts en formato limpio y consecutivo: Image 1: Create an image [prompt con 'no text'], Clip 1 (00:00 - 00:04): Create a video [prompt técnico en inglés de 4s de duración con texto de apertura tipo documental generado por la IA en pantalla (Ciudad, País, Tiempo y Gancho) y puro diseño sonoro Foley, ralentizado a 6s en CapCut], Image 2: Create an image [prompt con 'no text'], Clip 2 (00:06 - 00:16): Create a video [prompt técnico en inglés con 'no text', foley, sufijo, y la porción de locución correspondiente como una oración más sin comillas ni paréntesis], etc. Prompt visual para generar la imagen inicial estática utilizando el modelo "banana pro" ([?SUB_OPCION_REELS=9X16]9:16[/?SUB_OPCION_REELS][?SUB_OPCION_REELS=16X9]16:9[/?SUB_OPCION_REELS], redactado al 100% en inglés, comenzando obligatoriamente tras la numeración con "Image [número]: Create an image [prompt]" o "Imagen [número]: Create an image [prompt]", incluyendo obligatoriamente tiempo y lugar como anclaje y referencia visual histórica con prefijo '@' en personas y lugares, llevando estrictamente 'no text' en todas las imágenes desde Image 1), y prompt técnico de movimiento con Foley integrado para generar el clip de video utilizando el modelo "omni flash" (redactado al 100% en inglés, comenzando obligatoriamente con la numeración, el intervalo de tiempo exacto que cubre cada clip en el timeline de CapCut en formato (##:## - ##:##) y la orden de acción obligatoria en inglés "Create a video": "Clip [número] (##:## - ##:##): Create a video [prompt técnico en inglés...]", incluyendo obligatoriamente tiempo y lugar de referencia visual histórica con prefijo '@' en personas y lugares, cerrando tras el sufijo de barrera sonora en inglés e incluyendo al final de todo el prompt la porción correspondiente de la voz narrativa colocada directamente como una oración más sin comillas ("") ni paréntesis (()), ej. "Clip 2 (00:06 - 00:16): Create a video [prompt en inglés con tiempo, lugar con '@', 'no text', foley y sufijo]. Año 1888, callejón de Whitechapel, Londres, Inglaterra...", quedando terminantemente prohibido omitir "Create an image" o "Create a video", incluir términos en español en los descriptores técnicos del prompt, omitir tiempo y lugar, o encerrar la voz narrativa entre comillas o paréntesis).
- Texto en Pantalla Generado por la IA Exclusivamente en Clip 1 (Primeros 6 Segundos, NO en Image 1): El texto en pantalla de los primeros 6 segundos va ÚNICAMENTE en el prompt del Clip 1 (Omni Flash de 4s [00:00 - 00:04]), NO en el prompt de la Image 1 (Banana Pro), la cual lleva estrictamente 'no text'. En Clip 1, la IA genera directamente en pantalla el texto de apertura de documental cinematográfico estructurado en dos líneas centradas: Ciudad, País, Tiempo en la primera línea, y justo debajo la frase de Gancho intrigante o perturbadora, con tipografía sobria y encuadre seguro (safe framing composition). En edición en CapCut, el editor reduce la velocidad de reproducción de Clip 1 para extenderlo a 6 segundos (00:00 - 00:06). Clip 1 es el ÚNICO prompt donde se omite la directriz negativa 'no text'. A partir de Clip 2 (00:06 - 00:16) en adelante, y en todas las imágenes desde Image 1, todos los prompts llevan estrictamente 'no text'.
[/?TIPO_PRODUCCION]
...
Inclusión Obligatoria de Tiempo y Lugar en Cada Prompt con Prefijo '@' en Personas y Lugares (Referencia Visual Histórica Inalterable): En CADA prompt de imagen estática (Banana Pro) y en CADA prompt de clip de video (Omni Flash), la IA tiene la obligación inquebrantable de incluir explícitamente el TIEMPO (año exacto en números/dígitos o época histórica precisa, ej: '1888', '1943', 'Victorian era', 'ancient Rome, 44 BC') y el LUGAR (ciudad, país, entorno geográfico o locación arquitectónica específica con prefijo '@', ej: '@Whitechapel, @London, @England', '@Normandy, @France', '@Kyoto, @Japan'). Asimismo, cuando se mencione a personajes o figuras históricas, se debe anteponer obligatoriamente el prefijo '@' (ej. '@Jack The Ripper', '@Julio César'). Esta referencia visual histórica en inglés es indispensable para que el motor generador configure con fidelidad documental la vestimenta, la arquitectura, los objetos, las texturas y el alumbrado de la época, eliminando de raíz cualquier anacronismo o alucinación visual moderna.
...
Regla Inquebrantable: Inclusión de la Voz Narrativa al Final como una Oración Más (Sin Comillas ni Paréntesis): En cada prompt de clip de video entregado que tenga locución asignada (Clip 2 en adelante), la IA debe incluir la parte exacta de la voz narrativa que le corresponde según el intervalo de tiempo del timeline de CapCut (##:## - ##:##) compensando los +6 segundos. Dicho texto de locución DEBE COLOCARSE OBLIGATORIA Y ESTRICTAMENTE AL FINAL DE TODO EL PROMPT como una oración más, cerrando inmediatamente después del sufijo de barrera sonora en inglés (...no text, no speech, no music. [Texto de la locución]). Queda TERMINANTEMENTE PROHIBIDO encerrar la voz narrativa entre comillas (""), ponerla entre paréntesis (()), o anteponer etiquetas burocráticas como '(Voz narrativa: ...)'. El texto del guion se añade limpiamente como una última oración continua. Para clips sin locución (Clip 1 de 00:00 - 00:04 con duración obligatoria de 4 segundos en el prompt de Omni Flash, con texto de apertura de documental cinematográfico generado por la IA en pantalla y puro diseño sonoro Foley, ralentizado luego a 6s en edición en CapCut), el prompt concluye directamente con el sufijo sin oración de voz en off.
Compensación de Timestamps (+6s) en los Intervalos de los Clips (##:## - ##:##): La numeración de los intervalos de tiempo en el timeline de CapCut (##:## - ##:##) debe reflejar con exactitud la sincronización: Clip 1 cubre 00:00 - 00:04 en el prompt de Omni Flash (ralentizado en CapCut a 6s para cubrir 00:00 - 00:06 sin voz), Clip 2 cubre 00:06 - 00:16 (donde la voz en off entra en el segundo 00:06), Clip 3 cubre 00:16 - 00:26, etc.
...
- Orden Operativa Exclusiva del Primer Bloque de Prompts: Al inicio obligatorio del primer bloque de entrega de prompts de imágenes y videos (Bloque 1: Clips 1 al 10), la IA debe colocar obligatoriamente como preámbulo inicial la siguiente orden operativa textual (quedando estrictamente prohibido repetirla en los bloques subsiguientes):
  ...
  Usa omni flash para videos y banana pro para imágenes iniciales de cada clip.
  Crea las imágenes primero y luego los clips usando cada imagen como fotograma inicial.
- Prompts de Imagen Inicial con "Create an image", Tiempo y Lugar con '@': Todo prompt para generar la imagen fija inicial debe estar redactado al 100% en idioma inglés, comenzando obligatoriamente tras la numeración con la frase: "Image [número]: Create an image " (o "Imagen [número]: Create an image "), e incluir obligatoriamente el TIEMPO y LUGAR con prefijo '@' en personas y lugares como anclaje y referencia visual histórica (ejemplos: "Image 1: Create an image [prompt con tiempo, lugar con '@'...]", "Image 2: Create an image [prompt con tiempo, lugar con '@'...]", etc.).
- Prompts de Clips de Video con Intervalo Temporal (##:## - ##:##), "Create a video", Tiempo, Lugar con '@' y Voz Narrativa al Final como una Oración Más: Todo prompt técnico de movimiento para generar el video con Foley integrado debe estar redactado al 100% en idioma inglés para los comandos y la descripción técnica cinematográfica, comenzando obligatoriamente indicando la numeración, el intervalo de tiempo exacto que cubre cada clip en el timeline de CapCut en formato (##:## - ##:##) y la orden de acción literal en inglés "Create a video ": ("Clip [número] (##:## - ##:##): Create a video [prompt técnico en inglés...]"), incluir obligatoriamente dentro de la descripción técnica en inglés el TIEMPO y LUGAR como referencia visual histórica con prefijo '@' en personas y lugares (ej. 'in @Whitechapel, @London, @England, 1888...'), cerrar la descripción con el sufijo obligatorio de barrera sonora (...no text, no speech, no music.), y colocar AL FINAL DE TODO EL PROMPT la porción correspondiente de la voz narrativa como una oración más sin comillas ("") ni paréntesis (()). Queda estrictamente prohibido omitir la orden "Create a video", incluir términos en español en la orden o descripción técnica del video, omitir el tiempo y lugar con '@', o encerrar la voz narrativa entre comillas o paréntesis. (Ejemplos: "Clip 1 (00:00 - 00:04): Create a video [prompt técnico en inglés de 4s de duración con tiempo, lugar con '@', texto de apertura de documental en pantalla, foley y sufijo]", "Clip 2 (00:06 - 00:16): Create a video [prompt técnico en inglés con tiempo, lugar con '@', 'no text', foley y sufijo]. Año 1888, callejón de Whitechapel, Londres, Inglaterra...", etc.).
...
5) Hashtags: Exactamente 5 hashtags en español y formato #CamelCase referentes al tema del video. (Con los hashtags concluye estrictamente la contabilización de los 2100 caracteres totales).
   (⠀)
6) Comentario Fijado: Directo (CTA natural invitando a contar una experiencia propia, no solo pedir "dale like"), sin etiqueta.
[/?TIPO_PRODUCCION]
...
La publicación de un documento de Huellas de la Humanidad es irreversible. Antes de presionar el botón de exportación y programar el video en la plataforma, el Director Ejecutivo, el Editor o el Arquitecto de Sistemas Audiovisuales debe confrontar el metraje final contra el siguiente escrutinio inflexible. Un solo fallo en este checklist implica la retención del episodio y la re-ingeniería del bloque defectuoso :[ ] 1. Contradicción Central: ¿La tensión histórica o paradoja planteada en el inicio permea de manera constante hasta la resolución del documental?[ ] 2. Promesa Narrativa al Final del Primer Minuto con Slogan Completo y Micro-Ganchos cada 90s: ¿La promesa del documental fue ubicada al final del primer minuto (~minuto 01:00), comienza obligatoriamente con la frase "En este documental..." e incluye al final de la promesa la articulación del slogan completo oficial ("Si quieres seguir cruzando el umbral del tiempo para vivir la historia desde dentro, dale like a este video, compártelo y suscríbete. Cada historia deja una huella. Aquí seguimos sus rastros.")? ¿Se articulan micro-ganchos cada 90 segundos planteando una nueva interrogante antes de resolver la anterior sin que el espectador lo sepa todo prematuramente?[ ] 3. Filtro de Realidad (Anacronismos) y Referencia Visual de Tiempo y Lugar: ¿Se ha verificado que en CADA prompt de imagen (Banana Pro) y en CADA prompt de clip de video (Omni Flash) se incluya obligatoriamente el TIEMPO (año en números o época precisa) y el LUGAR (ciudad, país o locación) como referencia visual indispensable para erradicar anacronismos en prendas, arquitectura y tecnología?[ ] 4. Auditoría Anti-Estancamiento (Planos): ¿Se ha verificado que ningún tipo de plano (ej. Drone reveal) se repita idénticamente en el rango cercano de los últimos 6 a 8 clips?[ ] 5. Auditoría Anti-Estancamiento (Cámara): ¿Se ha constatado que el mismo movimiento de cámara no se encadena consecutivamente sin una justificación narrativa extrema?[ ] 6. Continuidad Ambiental: ¿Las transiciones entre clips mantienen una coherencia impecable en el uso del catálogo de iluminación, la materialidad de las ruinas y la textura del espacio?[ ] 7. Sinergia de Miniatura: ¿La miniatura gráfica proyecta una emoción dominante que intriga y que es complementaria (jamás repetitiva) respecto al título del video?[ ] 8. Contención de Hashtags: ¿El bloque final de la descripción contiene un recuento estricto y exacto de cinco (5) hashtags?[ ] 9. Formato "Todo Corrido": ¿La descripción de la plataforma fluye orgánicamente sin el uso de subtítulos burocráticos ni encabezados ("Título:", "Descripción:"), separada únicamente por una línea de retorno de carro con braille (⠀) entre bloques?[ ] 10. Cierre de Locución y Acoplamiento del Eslogan Corto en Párrafo Aparte: ¿La voz narrativa culmina obligatoriamente pronunciando como frase de cierre el lema oficial ("Cada historia deja una huella. Aquí seguimos sus rastros.") ubicado obligatoriamente separado en un párrafo aparte al final del guion, coincidiendo milimétricamente con un plano de hipertextura que muestre una huella, rastro o marca física en un material histórico?[ ] 11. Sincronización Inversa Perfecta, Cero Marcas de Pausas y Reporte de Caracteres por Minuto: ¿La cadencia de la locución humana concuerda rítmicamente con los impactos visuales, entregando el guion completamente limpio y continuo sin marcas de pausas artificiales (/2s, /#s) para ser colocadas manualmente en edición, cumpliendo en Reels con la fórmula de caracteres proporcionales (Duración Total - 6s iniciales sin voz) x 17.66 caracteres con espacios (benchmark: 114s de locución para video de 120s = ~2013 caracteres; 54s de locución para video de 60s = ~954 caracteres), e indicando obligatoriamente al pie del guion el reporte en formato estricto "Caracteres Totales: [número] ([número] caracteres por minuto)" (ej. "Caracteres Totales: 7657 (1060 caracteres por minuto)")?[ ] 12. Arquitectura de Audio y Hook de Inicio (Reels): ¿Se ha verificado que los primeros 6 segundos de video carezcan de voz en off (Clip 1 de 4 segundos de duración en prompt [00:00 - 00:04] con texto de apertura de documental cinematográfico generado directamente por la IA en pantalla, ralentizado en edición en CapCut a 6 segundos [00:00 - 00:06] con exclusivo Foley ambiental) y que la locución arranque exactamente en el segundo 00:06 de video al inicio de Clip 2 [00:06 - 00:16] comenzando obligatoriamente con la tríada: TIEMPO (años en números/dígitos; si es únicamente el año sin mes ni día, iniciando con "Año" [número], ej. "Año 1888", "Año 44 antes de Cristo"), LUGAR, CIUDAD Y PAÍS (mencionando el lugar acto seguido del año, quedando terminantemente prohibido escribir "en el" después del año), y DESCRIPCIÓN BREVE del lugar, suceso o personaje con premisa intrigante o perturbadora? ¿La voz en off relata en tercera persona sin hablar jamás en "nosotros", y se nombran las figuras históricas con naturalidad sin forzar etiquetas como "anónimos"?[ ] 13. Orden Operativa Exclusiva de Bloque 1, Nomenclatura, Bloques de 10, Intervalos Temporales (##:## - ##:##), Prompts 100% en Inglés con "Create an image / Create a video", Tiempo y Lugar con Prefijo '@', Texto en Pantalla Exclusivo en Clip 1 y Voz Narrativa al Final de Clips como Oración Más (Sin Comillas ni Paréntesis): ¿La entrega de prompts arranca en el Bloque 1 obligatoriamente con la orden operativa de 4 líneas (Actúa como un historiador..., Cambia los nombres a las primeras 6 palabras..., Usa omni flash y banana pro..., Crea las imágenes primero y luego los clips...), asegurando que los bloques posteriores (Bloque 2 en adelante) NO repitan dicha orden y comiencen directamente con los prompts? ¿Se entrega estrictamente en bloques controlados de 10 clips (con ALTO INQUEBRANTABLE entre bloques para producciones de más de 10 clips), están todos los prompts redactados al 100% en idioma INGLÉS iniciando obligatoriamente con "Image [número]: Create an image " (o "Imagen [número]: Create an image ") para imágenes estáticas y "Clip [número] (##:## - ##:##): Create a video " para clips de video, incluye obligatoriamente el TIEMPO y LUGAR con prefijo '@' en personas y lugares en el cuerpo en inglés de cada prompt de imagen y de video como ancla histórica visual, incluye obligatoriamente en cada clip de video el tiempo exacto que cubre en el timeline de CapCut en formato (##:## - ##:##) compensando los +6s de la transcripción, contiene Clip 1 (00:00 - 00:04) el texto de apertura de documental cinematográfico generado por la IA en pantalla omitiendo 'no text' (manteniendo Image 1 con 'no text' al igual que todas las imágenes), y a partir de Clip 2 (00:06 - 00:16) en adelante se cumple estrictamente la regla de 'no text' colocando al final del prompt de video el texto de la voz narrativa correspondiente a ese clip como una oración más, terminada en punto, sin comillas "", sin paréntesis (), y sin etiquetas burocráticas (manteniendo Clip 1 sin texto de locución)? [ ] 14. Regla Estricta de Cero Música: ¿Se ha verificado que ningún clip de ningún tipo de video contenga música, melodías o pistas sonoras de fondo, garantizando que el diseño acústico de cada clip sea exclusivamente Foley ambiental con 'no music'?[ ] 15. Instrucción de Rol Universal: ¿El prompt comienza obligatoriamente con "Actúa como un historiador, director de cine, y periodista profesional." para todos los tipos de video?[ ] 16. Formato de Años, Siglos y Distinción de Era ('a.C.'/'d.C.' vs 'antes de Cristo'/'después de Cristo'): ¿Todos los años en el título, anclajes de fecha, guion de locución y metadata están escritos estrictamente en dígitos numéricos (ej. 1888, 1943) sin palabras, todos los siglos en las descripciones están escritos obligatoriamente en números romanos (ej. siglo XIX, siglo XXI) sin arábigos ni palabras, y las referencias de era están redactadas obligatoriamente en palabras completas en la voz en off ("antes de Cristo" y "después de Cristo", ej. "44 antes de Cristo") y estrictamente en siglas en las descripciones y metadata ("a.C." y "d.C.", ej. "44 a.C.", "siglo V a.C.")?[ ] 17. Orden, Extensión de Metadata (2100 Caracteres) y Escudo de IA: ¿En formato vertical, el bloque desde el título hasta los hashtags suma exactamente 2100 caracteres con espacios, y sigue el orden estricto: Título -> Descripción -> Nota IA -> Slogan -> Hashtags -> Comentario Fijado? ¿La Nota IA se formula con exactitud histórica oficial ("(Nota: Este video/documental inmersivo ha sido recreado utilizando herramientas de inteligencia artificial generativa basándonos estrictamente en registros históricos de la época. Es posible que existan incongruencias o errores visuales).") empleando obligatoriamente "video" para formato 9x16 y "documental" para formato 16:9?[ ] 18. Cuadre Matemático de Clips y Entrega en Bloques de 10 (Reels): ¿La suma exacta de segundos de todos los clips coincide milimétricamente con la duración acordada (ej. 120s = 6s de Clip 1 [generado como 4s en prompt 00:00 - 00:04 y ralentizado en edición en CapCut a 6s: 00:00 - 00:06] + 11 clips de 10s [110s de Clips 2 al 12: 00:06 a 01:56] + Clip 13 de 4s [cierre 01:56 - 02:00 con slogan corto en locución] = 120s exactos en 13 clips totales) sin omitir ningún segundo, y si el video supera los 10 clips, la entrega se realiza estrictamente en bloques de 10 clips con un ALTO INQUEBRANTABLE entre cada bloque (Bloque 1: Clips 1 al 10; Bloque 2: Clips 11 al 13)?[ ] 19. Texto en Pantalla Generado por la IA Exclusivamente en Clip 1 (Reels, NO en Image 1): ¿Se ha verificado que el texto de apertura tipo comienzo de documental cinematográfico de los primeros 6 segundos vaya EXCLUSIVAMENTE en el prompt de Clip 1 (00:00 - 00:04) y NO en el prompt de Image 1 (la cual lleva estrictamente 'no text' como todas las imágenes), estructurado en Clip 1 obligatoriamente en dos líneas centradas (Ciudad, País, Tiempo en la primera línea, y justo debajo la frase de Gancho intrigante o perturbador) con tipografía cinematográfica sobria y encuadre seguro, para luego ser ralentizado a 6s en CapCut (00:00 - 00:06), omitiendo 'no text' únicamente en Clip 1 y manteniendo estrictamente 'no text' en todas las imágenes y a partir de Clip 2 en adelante?[ ] 20. Diseño para Reproducción en Silencio y CTA Natural: ¿Se ha verificado que la producción esté optimizada para el ~70% de usuarios que miran inicialmente sin sonido (apoyo visual claro y subtítulos dinámicos en CapCut obligatorios)? ¿El comentario fijado plantea un CTA natural que invite orgánicamente a contar una experiencia propia en lugar de limitarse a pedir "dale like"?[ ] 21. Decisión Inteligente de Shots por Clip (10s vs 5s + 5s): ¿La IA ha determinado con criterio cinematográfico cuáles clips son de un solo shot continuo (10s para contemplación y atmósfera) y cuáles se dividen en dos shots (5s + 5s para dinamismo y acción-reacción) dependiendo de la escena y la voz en off?[ ] 22. Generación Previa de Prompts de Imágenes Modelo de Referencia (Etapa 4 con Orden en una Sola Oración y Prefijo '@'): ¿Se generaron y validaron previamente en una etapa separada e independiente (Etapa 4 con ALTO INQUEBRANTABLE) los prompts técnicos de imágenes modelo de referencia para las figuras históricas principales (@Personas), escenarios arquitectónicos clave (@Lugares) y objetos determinantes del relato, anteponiendo al inicio en una sola oración la orden obligatoria ("Cambia los nombres y ponles @ seguido del nombre del lugar, persona u objeto correspondiente.") y asegurando consistencia visual absoluta antes de generar los clips de video?
...
const PromptGenerator = () => {
  ...
  useEffect(() => {
    const key = 'huellas_master_template_v98';
      ...
      <div className="panel output-panel" style={{ display: 'flex', flexDirection: 'column', height: '92vh', overflow: 'hidden' }}>
        <div className="brand-header" style={{ flexShrink: 0, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <span style={{ fontSize: '0.8rem', color: 'var(--text-secondary)', background: 'var(--bg-card, rgba(255,255,255,0.05))', padding: '0.2rem 0.6rem', borderRadius: '4px', border: '1px solid var(--border-color, rgba(255,255,255,0.1))' }}>
            Caracteres Totales: {compiledOutput.length} (~1060 car/min)
          </span>
        </div>
