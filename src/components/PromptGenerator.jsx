...
2. Qué opción de texto en pantalla para los primeros 6 segundos prefiere:
   - Opción A (Edición manual en CapCut): Prompts visuales con 'no text', el texto se acuerda con el usuario y se coloca manualmente en CapCut durante los primeros 6 segundos (Clip 1 de 4s + primeros 2s de Clip 2).
   - Opción B (Generado por IA en Clip 1): El texto en pantalla va exclusivamente en el prompt del Clip 1 de 4s (tipo comienzo de documental cinematográfico), NO en el prompt de la Imagen 1 (que lleva 'no text'). Luego en edición el usuario baja la velocidad del Clip 1 y lo lleva a 6 segundos.
...
[/?OPCION_TEXTO_PANTALLA]
[?OPCION_TEXTO_PANTALLA=IA_CLIP_1]
Opción de Texto en Pantalla (Primeros 6s): Generado por IA en Clip 1 (El texto en pantalla va solo en el prompt del Clip 1 [4s], NO en la Imagen 1 ['no text'], tipo comienzo de documental cinematográfico; luego en edición se baja la velocidad del Clip 1 y se lleva a 6 segundos).
[/?OPCION_TEXTO_PANTALLA]
[?VOZ_NARRATIVA_EN_CLIPS=INCLUIR]
...
const PromptGenerator = () => {
  ...
  useEffect(() => {
    const key = 'huellas_master_template_v109';
                          ...
                          <label key={val} style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', cursor: 'pointer' }}>
                            ...
                            <span>
                              {val === 'REELS' ? 'Reels' :
                               ...
                               val === 'IA_CLIP_1' ? 'Generado por IA en Clip 1 (Texto solo en prompt de Clip 1 [4s], no en Imagen 1 / Bajar a 6s en edición)' :
