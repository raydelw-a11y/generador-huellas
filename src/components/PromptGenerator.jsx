...
Tras la validación del guion de voz en off, la IA generará y entregará los clips de video correspondientes a la duración elegida en bloques controlados de 10 clips (ej. Bloque 1: Clips 1 al 10; Bloque 2: Clips 11 al 13 o restantes):
...
- Protocolo Obligatorio de Entrega en Bloques de 10 Clips (Alto entre Bloques):
  ...
  * Si la producción tiene 10 clips o menos en total (ej. un video de 60s con 7 clips), la IA entregará la totalidad de los clips en un único bloque y se detendrá con el ALTO INQUEBRANTABLE antes de pasar a la siguiente etapa (Etapa 5: Texto en Pantalla).
...
- Formato Estricto de los Prompts (Orden Operativa EXCLUSIVA en el Primer Bloque):
  ...
  Inmediatamente después de esta orden (en el Bloque 1), la IA entregará la secuencia de prompts correspondiente al bloque (incluyendo obligatoriamente en cada clip de video el tiempo real de CapCut que cubre en formato (##:## - ##:##) y la porción de la voz narrativa que le corresponde, aplicando la compensación de +6s respecto a la transcripción de audio):
  ...
  * Regla Inquebrantable de Inclusión de Tiempo y Lugar en Cada Prompt: En absolutamente CADA prompt de imagen estática (Banana Pro) y en CADA prompt de clip de video (Omni Flash), la IA DEBE INCLUIR OBLIGATORIAMENTE el TIEMPO (año exacto en dígitos o época histórica, ej. '1888', '1944', 'Victorian era') y el LUGAR (ciudad, país, entorno geográfico o locación específica, ej. 'in Whitechapel, London, England', 'in Paris, France') como anclaje y referencia visual ineludible. Esto garantiza que la vestimenta, arquitectura, materiales y objetos generados coincidan rigurosamente con la época y contexto histórico del video.
  * Regla Inquebrantable de Ubicación de la Voz Narrativa al Final: El texto de la voz narrativa (o la indicación de sin voz en off) DEBE IR SITUADO OBLIGATORIA Y ESTRICTAMENTE AL FINAL DE CADA PROMPT DE VIDEO (cerrando el renglón tras el sufijo en inglés "...no text, no speech, no music."). Queda TERMINANTEMENTE PROHIBIDO colocar la voz narrativa al principio del clip, antes del prompt en inglés o intercalada en el medio, asegurando que las primeras 6 palabras pertenezcan exclusivamente a la numeración, tiempo y descriptores técnicos de video.

  Image 1: Create an image [prompt en inglés optimizado para Banana Pro en formato [?SUB_OPCION_REELS=9X16]vertical 9:16[/?SUB_OPCION_REELS][?SUB_OPCION_REELS=16X9]horizontal 16:9[/?SUB_OPCION_REELS] con 'no text', indicando obligatoriamente TIEMPO y LUGAR para referencia visual (ej. 'in Whitechapel, London, England, 1888...'), encuadre centrado, sujeto, atmósfera, iluminación y óptica, cerrando con: cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music.]
  Clip 1 (00:00 - 00:06): Create a video [prompt técnico en inglés para Omni Flash de 4s de duración con movimiento cinético lento para ser ralentizado a 6s en CapCut (Hook de impacto con puro diseño sonoro Foley ambiental, estrictamente sin voz en off), indicando obligatoriamente TIEMPO y LUGAR para referencia visual (ej. 'in a dark cobblestone alley in Whitechapel, London, England, 1888...'), cerrando con: strictly no music, no speech, cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music.] (Voz narrativa: Sin voz en off / Hook visual y Foley puro)

  Image 2: Create an image [prompt en inglés para Banana Pro [?SUB_OPCION_REELS=9X16]9:16[/?SUB_OPCION_REELS][?SUB_OPCION_REELS=16X9]16:9[/?SUB_OPCION_REELS] con 'no text', indicando obligatoriamente TIEMPO y LUGAR para referencia visual...]
  Clip 2 (00:06 - 00:16): Create a video [prompt técnico en inglés para Omni Flash de 10s de duración (1 shot de 10s o 2 shots de 5s+5s según dinamismo, con Foley ambiental integrado), indicando obligatoriamente TIEMPO y LUGAR para referencia visual (ej. 'in Whitechapel, London, England, 1888...'), sujeto, acción física, cámara, iluminación y óptica, cerrando con: strictly no music, no speech, cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music.] (Voz narrativa: "[Fragmento exacto del guion de locución correspondiente a los primeros 10s de voz (00:00 - 00:10 de tu app de audio), ej. '1888, callejón de Whitechapel, Londres, Inglaterra...']")

  (Continuar consecutivamente con Image 3: Create an image [prompt con tiempo y lugar], Clip 3 (00:16 - 00:26): Create a video [prompt técnico en inglés con tiempo, lugar, foley y sufijo] (Voz narrativa: "[bloque 00:10 - 00:20 de voz]")... Image 4: Create an image [prompt con tiempo y lugar], Clip 4 (00:26 - 00:36): Create a video [prompt técnico en inglés con tiempo, lugar, foley y sufijo] (Voz narrativa: "[bloque 00:20 - 00:30 de voz]")... indicando siempre tras la numeración "Create an image" en imágenes estáticas, y tras la numeración y el timestamp (##:## - ##:##) "Create a video" en clips de video, con todos los prompts redactados al 100% en idioma inglés, incluyendo tiempo y lugar en cada prompt, y situando la porción de la voz narrativa SIEMPRE AL FINAL hasta completar el bloque de 10 clips [Clips 1 al 10]).
-> ALTO INQUEBRANTABLE: La IA entrega el bloque de 10 clips y concluye su respuesta deteniéndose. Espera la confirmación del usuario para entregar el siguiente bloque (Clips 11 al 13 o restantes, el cual iniciará directamente con Image 11: Create an image [prompt], Clip 11 (01:36 - 01:46): Create a video [prompt], sin la orden operativa). Una vez completados y entregados todos los clips de video del proyecto, la IA pasará obligatoriamente a la Etapa 5. NO generes la metadata de publicación en esta etapa.
...
Usa omni flash para videos y banana pro para imágenes iniciales de cada clip.
Crea las imágenes primero y luego los clips usando cada imagen como fotograma inicial.
(Esta orden operativa NO se repite en el Bloque 2 ni en bloques posteriores). Seguida obligatoriamente de la secuencia de prompts en formato limpio y consecutivo: Image 1: Create an image [prompt], Clip 1 (00:00 - 00:06): Create a video [prompt] (Voz narrativa: Sin voz en off / Hook puro Foley), Image 2: Create an image [prompt], Clip 2 (00:06 - 00:16): Create a video [prompt] (Voz narrativa: "[texto del guion]"), etc. Prompt visual para generar la imagen inicial estática utilizando el modelo "banana pro" ([?SUB_OPCION_REELS=9X16]9:16[/?SUB_OPCION_REELS][?SUB_OPCION_REELS=16X9]16:9[/?SUB_OPCION_REELS] con 'no text', redactado al 100% en inglés, comenzando obligatoriamente tras la numeración con "Image [número]: Create an image [prompt]" o "Imagen [número]: Create an image [prompt]", incluyendo obligatoriamente tiempo y lugar como anclaje y referencia visual histórica), y prompt técnico de movimiento con Foley integrado para generar el clip de video utilizando el modelo "omni flash" (redactado al 100% en inglés, comenzando obligatoriamente con la numeración, el intervalo de tiempo exacto que cubre cada clip en el timeline de CapCut en formato (##:## - ##:##) y la orden de acción obligatoria en inglés "Create a video": "Clip [número] (##:## - ##:##): Create a video [prompt técnico en inglés...]", incluyendo obligatoriamente tiempo y lugar de referencia visual histórica, y finalizando OBLIGATORIAMENTE AL FINAL DE TODO EL PROMPT con la porción de la voz narrativa que le corresponde en formato (Voz narrativa: "[texto]"), ej. "Clip [número] (##:## - ##:##): Create a video [prompt en inglés con tiempo, lugar, Foley y sufijo] (Voz narrativa: '[texto del guion]')", quedando terminantemente prohibido omitir "Create an image" o "Create a video", incluir términos en español en los prompts, omitir tiempo y lugar o situar la voz en off al inicio o en medio del prompt).
...
Inclusión Obligatoria de Tiempo y Lugar en Cada Prompt (Referencia Visual Histórica Inalterable): En CADA prompt de imagen estática (Banana Pro) y en CADA prompt de clip de video (Omni Flash), la IA tiene la obligación inquebrantable de incluir explícitamente el TIEMPO (año exacto en números/dígitos o época histórica precisa, ej: '1888', '1943', 'Victorian era', 'ancient Rome, 44 BC') y el LUGAR (ciudad, país, entorno geográfico o locación arquitectónica específica, ej: 'Whitechapel, London, England', 'Normandy, France', 'Kyoto, Japan'). Esta referencia visual histórica en inglés es indispensable para que el motor generador configure con fidelidad documental la vestimenta, la arquitectura, los objetos, las texturas y el alumbrado de la época, eliminando de raíz cualquier anacronismo o alucinación visual moderna.
...
Inclusión Obligatoria de la Voz Narrativa Correspondiente al Final de Cada Clip de Video y Compensación de +6s: En cada prompt de clip de video entregado, la IA debe incluir obligatoriamente la parte exacta de la voz narrativa (locución del guion) que le corresponde según el intervalo de tiempo del timeline de CapCut que cubre dicho clip (##:## - ##:##). Dado que el software de audio y transcripción arranca desde 00:00 y en edición la voz se posiciona en el segundo 00:06 del timeline, la IA compensa automáticamente +6 segundos (el bloque de voz 00:00 - 00:10 corresponde a Clip 2 de 00:06 - 00:16, etc.). Esto garantiza una sincronización inversa milimétrica entre el relato auditivo y la acción cinematográfica visual para el editor y los generadores de video.
Regla Inquebrantable: El texto de la voz narrativa (o la aclaración de 'Sin voz en off') DEBE IR SITUADO OBLIGATORIA Y ESTRICTAMENTE AL FINAL DE CADA PROMPT DE VIDEO, cerrando el renglón tras el sufijo en inglés (...no text, no speech, no music). Queda estrictamente prohibido colocar la voz narrativa al principio del clip (ej. nunca escribir Clip 2: (Voz narrativa: ...) [prompt]) o en el medio, preservando la nomenclatura técnica limpia de las primeras 6 palabras para nombrar archivos. Debe estructurarse estrictamente al final en formato: (Voz narrativa: "[texto exacto de la locución que cubre este clip]"). Para clips sin locución (Clip 1 de 00:00 a 00:06), debe indicarse explícitamente al final: (Voz narrativa: Sin voz en off / Hook de puro Foley).
...
- Orden Operativa Exclusiva del Primer Bloque de Prompts: Al inicio obligatorio del primer bloque de entrega de prompts de imágenes y videos (Bloque 1: Clips 1 al 10), la IA debe colocar obligatoriamente como preámbulo inicial la siguiente orden operativa textual (quedando estrictamente prohibido repetirla en los bloques subsiguientes):
  ...
  Usa omni flash para videos y banana pro para imágenes iniciales de cada clip.
  Crea las imágenes primero y luego los clips usando cada imagen como fotograma inicial.
- Prompts de Imagen Inicial con "Create an image", Tiempo y Lugar: Todo prompt para generar la imagen fija inicial debe estar redactado al 100% en idioma inglés, comenzando obligatoriamente tras la numeración con la frase: "Image [número]: Create an image " (o "Imagen [número]: Create an image "), e incluir obligatoriamente el TIEMPO y LUGAR como anclaje y referencia visual histórica (ejemplos: "Image 1: Create an image [prompt con tiempo y lugar...]", "Image 2: Create an image [prompt con tiempo y lugar...]", etc.).
- Prompts de Clips de Video con Intervalo Temporal (##:## - ##:##), "Create a video", Tiempo, Lugar y Voz Narrativa Obligatoriamente al Final: Todo prompt técnico de movimiento para generar el video con Foley integrado debe estar redactado al 100% en idioma inglés, comenzando obligatoriamente indicando la numeración, el intervalo de tiempo exacto que cubre cada clip en el timeline de CapCut en formato (##:## - ##:##) y la orden de acción literal en inglés "Create a video ": ("Clip [número] (##:## - ##:##): Create a video [prompt técnico en inglés...]"), incluir obligatoriamente dentro de la descripción técnica en inglés el TIEMPO y LUGAR como referencia visual histórica (ej. 'in Whitechapel, London, England, 1888...'), y finalizar OBLIGATORIAMENTE AL FINAL DE TODO EL PROMPT (después del sufijo obligatorio de barrera sonora) incluyendo la porción de la voz narrativa que le corresponde entre paréntesis en formato (Voz narrativa: "[texto del guion]") (o "(Voz narrativa: Sin voz en off / Hook de puro Foley)" para clips sin locución, como Clip 1). Queda estrictamente prohibido omitir la orden "Create a video", incluir términos en español en la orden o descripción del video, omitir el tiempo y lugar o situar el fragmento de voz narrativa antes o en medio del texto técnico en inglés. (Ejemplos: "Clip 1 (00:00 - 00:06): Create a video [prompt con tiempo y lugar...] (Voz narrativa: Sin voz en off / Hook de puro Foley)", "Clip 2 (00:06 - 00:16): Create a video [prompt con tiempo y lugar...] (Voz narrativa: \"1888, callejón de Whitechapel, Londres, Inglaterra...\")", etc.).
...
const PromptGenerator = () => {
  ...
  useEffect(() => {
    const key = 'huellas_master_template_v91';
