...
- Cierre Obligatorio de la Locución con el Slogan Corto: La voz en off debe culminar obligatoriamente pronunciando como frase final de cierre el slogan oficial: "Cada historia deja una huella. Aquí seguimos sus rastros." (se contabilizan sus ~57 caracteres con espacios dentro de la extensión matemática del guion).
...
Promesa Narrativa (Al final del primer minuto / comienza con "En este documental..."): [PROMESA_NARRATIVA]
...
const PromptGenerator = () => {
  ...
  useEffect(() => {
    const key = 'huellas_master_template_v89';
