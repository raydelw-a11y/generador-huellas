...
- Prompt Técnico de la Miniatura (si se incluye o solicita con el empaque): Todas las miniaturas llevarán obligatoriamente en la parte superior derecha un logo pequeño al 5% que diga 8K en dorado, especificado directamente en el prompt técnico en inglés para Banana Pro ('a small discreet 5% scale logo in the top right corner displaying "8K" in metallic gold') y creado directamente por la inteligencia artificial.
[/?TIPO_PRODUCCION]
...
La publicación del episodio requiere una estrategia algorítmica tan precisa como su creación visual, orientada a dominar el CTR (Click-Through Rate) y la retención profunda.1. Dirección de Arte para Miniaturas y Regla Obligatoria del Logo "8K" en Dorado al 5%:
...
Regla Inquebrantable del Logo "8K" en Dorado al 5% en la Parte Superior Derecha (Generado Directamente por IA): Todas las miniaturas llevarán obligatoriamente en la parte superior derecha un logo pequeño al 5% que diga 8K en dorado (metallic gold), especificado directamente en el prompt de la miniatura y creado directamente por la inteligencia artificial. En el prompt técnico en inglés para Banana Pro ([?SUB_OPCION_REELS=9X16]vertical 9:16[/?SUB_OPCION_REELS][?SUB_OPCION_REELS=16X9]horizontal 16:9[/?SUB_OPCION_REELS]), la IA debe incluir de forma explícita y obligatoria la instrucción: 'a small discreet 5% scale logo in the top right corner displaying "8K" in metallic gold' (o 'small 5% size metallic gold 8K logo in the upper right corner'), asegurando que dicho logo sea generado de forma nativa por el motor de IA dentro de la propia imagen sin requerir edición gráfica posterior. Queda terminantemente prohibido omitir esta especificación técnica en el prompt de la miniatura.
Formato del Prompt de la Miniatura: Al generar o solicitar el prompt de la miniatura, se redactará al 100% en inglés iniciando con 'Thumbnail: Create an image [descripción visual de alto impacto cinematográfico, sujeto, atmósfera, tiempo y lugar, contradicción visual, composición segura para móviles, texto conciso de 1 a 3 palabras si aplica, y obligatoriamente: a small discreet 5% scale logo in the top right corner displaying "8K" in metallic gold, cinematic documentary realism, safe framing composition, no CGI look, no modern objects]'.
...
const PromptGenerator = () => {
  ...
  useEffect(() => {
    const key = 'huellas_master_template_v127';
