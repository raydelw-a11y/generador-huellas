...
- Cantidad de Clips y Cuadre Matemático Exacto:
  * Clip 1: Cobertura temporal de 00:00 a 00:06 (6 segundos en el timeline de CapCut). Prompt técnico en inglés para Omni Flash de 4s con movimiento cinético lento (a ralentizar en CapCut para cubrir con tensión visual y Foley los 6s de apertura). Estrictamente SIN voz en off.
  * Clips subsiguientes (Clip 2 en adelante): Clips de 10 segundos cada uno (decidiendo la IA con criterio cinematográfico si cada clip es de un solo shot continuo de 10s o de dos shots de 5s + 5s). Arrancan en el segundo 00:06 del timeline de CapCut, donde da comienzo la voz narrativa.
  * Regla Inquebrantable de Compensación de Timestamps (+6 Segundos): La IA debe tener en cuenta que el software de audio y transcripción del usuario arranca sus marcas de tiempo desde 00:00 (mientras que en edición el audio se coloca a partir del segundo 00:06). Por tanto, la IA realiza automáticamente la compensación de +6 segundos: el fragmento de voz 00:00 - 00:10 de la transcripción se asigna a Clip 2 (00:06 - 00:16), el de 00:10 - 00:20 a Clip 3 (00:16 - 00:26), etc., mostrando en los prompts exclusivamente el tiempo real del timeline de video en CapCut (##:## - ##:##).
  * Regla Inquebrantable de Cuadre Total: La suma exacta de los segundos de todos los clips generados DEBE coincidir con precisión milimétrica con la duración total acordada con el usuario, sin que falte ni sobre un solo segundo:
    - Si el usuario acordó 120 segundos (2 min exactos): La IA generará obligatoriamente Clip 1 (00:00 - 00:06, 6s) + 11 clips de 10s (00:06 a 01:56, 110s) + Clip 13 final de 4s (01:56 a 02:00, cierre con el slogan oficial y plano macro de huella/rastro físico) = 120s exactos (6 + 110 + 4 = 120s en 13 clips totales).
    - Si el usuario acordó 60 segundos (1 min): Se generará Clip 1 (00:00 - 00:06, 6s) + 5 clips de 10s (00:06 a 00:56, 50s) + Clip 7 final de 4s (00:56 a 01:00, cierre con slogan) = 60s exactos (6 + 50 + 4 = 60s en 7 clips totales).
...
- Formato Estricto de los Prompts (Orden Operativa EXCLUSIVA en el Primer Bloque):
  ...
  * Regla Inquebrantable de la Voz Narrativa al Final como una Oración Más (Sin Comillas ni Paréntesis): En cada prompt de clip de video que lleve locución (Clip 2 en adelante), la IA DEBE COLOCAR OBLIGATORIAMENTE al final de todo el prompt la porción correspondiente del guion de voz en off. Dicho texto se sitúa al final como UNA ORACIÓN MÁS, inmediatamente después del punto del sufijo obligatorio de barrera sonora en inglés (...no text, no speech, no music. [Texto de la locución]). Queda TERMINANTEMENTE PROHIBIDO encerrar la voz narrativa entre comillas (""), envolverla en paréntesis (()) o escribir etiquetas burocráticas como '(Voz narrativa: ...)'. Se anexa directamente como una última oración continua y limpia. Para Clip 1 (00:00 - 00:06), al ser el Hook inicial sin voz en off de puro diseño sonoro Foley, el prompt concluye directamente con el sufijo sin ninguna oración adicional de voz.
  ...
  Clip 1 (00:00 - 00:06): Create a video [prompt técnico en inglés para Omni Flash de 4s de duración con movimiento cinético lento para ser ralentizado a 6s en CapCut (Hook de impacto con puro diseño sonoro Foley ambiental, estrictamente sin voz en off), indicando obligatoriamente TIEMPO y LUGAR con prefijo '@' para referencia visual (ej. 'in a dark cobblestone alley in @Whitechapel, @London, @England, 1888...'), cerrando con: strictly no music, no speech, cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music.]
...
ETAPA 6: TEXTO EN PANTALLA PARA LOS PRIMEROS 6 SEGUNDOS DEL VIDEO
...
La IA debe explicar al usuario que este texto corresponde al letrero o rótulo de gancho visual en pantalla durante los primeros 6 segundos del video (la ventana del Hook sin voz en off que cubre Clip 1 de 00:00 a 00:06, con exclusivo diseño sonoro Foley ambiental).
...
- Arquitectura Temporal (Fórmula de Duración Total): La duración total del video se compone de: 6 segundos iniciales sin voz en off cubiertos por el Clip 1 (00:00 - 00:06, generado como prompt de 4 segundos con movimiento cinético lento y ralentizado en CapCut a 6s con puro Foley ambiental), seguidos por la voz narrativa continua que entra exactamente en el segundo 00:06 de video (al inicio del Clip 2). La suma de los 6 segundos iniciales sin voz más el tiempo de duración de la voz en off da el total exacto del video (Total = 6s + Tiempo de Voz en Off; es decir, Tiempo de Voz en Off = Duración Total - 6s; ej. en video de 120s = 6s de Clip 1 + 114s de voz en off).
- Voz en Off, Foley y Compensación de Timestamps (+6s): Acompañado de locución narrativa solemne y continua que arranca obligatoriamente en el segundo 00:06 del video (justo al inicio del Clip 2). Los primeros 6 segundos (Clip 1 completo de 00:00 a 00:06) carecen por completo de locución para maximizar el misterio y el impacto sensorial visual con Foley. La IA debe compensar automáticamente el desfase de +6 segundos entre la transcripción/audio del usuario (que empieza en 00:00) y el timeline de video en CapCut (que arranca la voz en 00:06): el bloque de voz 00:00 - 00:10 se asigna al Clip 2 (00:06 - 00:16), el de 00:10 - 00:20 al Clip 3 (00:16 - 00:26), etc. La extensión del texto de la voz en off debe calibrarse estrictamente con la métrica empírica de 17.66 caracteres por segundo de locución ((Duración Total - 6s) x 17.66 caracteres con espacios; ej. 114s de voz en off para un video de 120s = ~2013 caracteres; 54s de voz en off para un video de 60s = ~954 caracteres; equivalentes a ~176 caracteres por cada bloque de 10s de locución continua; estrictamente sin silencios estructurales ni pausas artificiales /2s o /#s), complementada con el paisaje sonoro de Foley integrado en cada prompt de video (estrictamente sin música en ningún clip). El preámbulo inicial de la voz en off (al segundo 00:06 de video / inicio de Clip 2) debe estructurarse obligatoriamente en tres partes: 1) Tiempo (años siempre en números/dígitos; si es únicamente el año sin mes ni día, iniciando obligatoriamente con "Año" [número], ej. "Año 1888", "Año 44 antes de Cristo"), 2) Lugar, ciudad y país mencionado acto seguido sin anteponer "en el" ni preposiciones de relleno (ej: "Año 1888, callejón de Whitechapel, Londres, Inglaterra...", quedando terminantemente prohibido escribir "en el" después del año), y 3) Descripción breve del lugar, suceso histórico, personaje o tema central abordado, capturando de inmediato con un gancho profundamente intrigante o terrorífico. La voz en off debe narrar en tercera persona de forma directa y cinematográfica, sin hablar jamás en primera persona del plural ("nosotros") y sin forzar anonimizaciones artificiales ("anónimos").
...
Regla Inquebrantable: Inclusión de la Voz Narrativa al Final como una Oración Más (Sin Comillas ni Paréntesis): En cada prompt de clip de video entregado que tenga locución asignada (Clip 2 en adelante), la IA debe incluir la parte exacta de la voz narrativa que le corresponde según el intervalo de tiempo del timeline de CapCut (##:## - ##:##) compensando los +6 segundos. Dicho texto de locución DEBE COLOCARSE OBLIGATORIA Y ESTRICTAMENTE AL FINAL DE TODO EL PROMPT como una oración más, cerrando inmediatamente después del sufijo de barrera sonora en inglés (...no text, no speech, no music. [Texto de la locución]). Queda TERMINANTEMENTE PROHIBIDO encerrar la voz narrativa entre comillas (""), ponerla entre paréntesis (()), o anteponer etiquetas burocráticas como '(Voz narrativa: ...)'. El texto del guion se añade limpiamente como una última oración continua. Para clips sin locución (Clip 1 de 00:00 a 00:06), el prompt concluye directamente con el sufijo de barrera sonora sin oración de voz en off.
Compensación de Timestamps (+6s) en los Intervalos de los Clips (##:## - ##:##): La numeración de los intervalos de tiempo en el timeline de CapCut (##:## - ##:##) debe reflejar con exactitud la sincronización: Clip 1 cubre 00:00 - 00:06 (6s sin voz), Clip 2 cubre 00:06 - 00:16 (segundo 6 donde entra la voz), Clip 3 cubre 00:16 - 00:26, etc.
...
const PromptGenerator = () => {
  ...
  useEffect(() => {
    const key = 'huellas_master_template_v95';
