...
- Consulta Obligatoria de Texto en Pantalla (Primeros 6 Segundos): Una vez concluida la entrega de todos los prompts de video y antes de entregar la metadata, la IA preguntará al usuario qué texto colocar durante los primeros 6 segundos del video (Clip 1 y primeros 2s de Clip 2), proponiéndole de 2 a 3 opciones de gancho visual para ser aplicadas manualmente en CapCut (los prompts de Banana Pro y Omni Flash se mantienen estrictamente con 'no text').
[/?TIPO_PRODUCCION]
...
const PromptGenerator = () => {
  ...
  useEffect(() => {
    const key = 'huellas_master_template_v79';
