...
2. Qué opción de texto en pantalla para los primeros 6 segundos prefiere:
   - Opción A (Edición manual en CapCut): Prompts visuales con 'no text', el texto se selecciona con el usuario en la Etapa 6 (antes de los prompts de imágenes iniciales y clips) y se coloca manualmente en CapCut durante los primeros 6 segundos (Clip 1 de 4s + primeros 2s de Clip 2). La voz narrativa entra a los 2 segundos de haber iniciado el Clip 2 (segundo 00:06 de video).
   - Opción B (Generado por IA en Clip 1): El texto en pantalla se selecciona con el usuario en la Etapa 6 (antes de los prompts de imágenes iniciales y clips) y va exclusivamente en el prompt del Clip 1 de 4s (tipo comienzo de documental cinematográfico), NO en el prompt de la Imagen 1 (que lleva 'no text'). Luego en edición el usuario baja la velocidad del Clip 1 y lo lleva a 6 segundos. El Clip 2 arranca en el timeline en el segundo 6 ([?DURACION_CLIPS=10_SEGUNDOS]00:06 - 00:16[/?DURACION_CLIPS][?DURACION_CLIPS=8_SEGUNDOS]00:06 - 00:14[/?DURACION_CLIPS]) y comienza inmediatamente con la voz narrativa en el segundo 6 de video.
...
rename everything adding _ as the blank spaces between words
from 1 to 9 change them to 01 to 09
...
[?TEXTO_PANTALLA_CLIP_1=CAPCUT_MANUAL]
  ...
  4. Prompt de Movimiento de Video con Audio Foley Integrado (en inglés para Omni Flash, estrictamente sin música ni voz / 'no music, no speech', con 'no text', comenzando obligatoriamente con el tiempo que cubre en formato (##:## - ##:##) y la orden en inglés "Create a video": "Clip 1 (00:00 - 00:[DURACION_CLIP_1_PAD]): Create a video [prompt...]", incluyendo obligatoriamente tiempo y lugar como referencia visual, y agregando al final "fix the name").
...
[/?TEXTO_PANTALLA_CLIP_1]
[?TEXTO_PANTALLA_CLIP_1=IA_CLIP_1]
  ...
  4. Prompt de Movimiento de Video con Audio Foley Integrado y Texto Generado por IA (en inglés para Omni Flash, estrictamente sin música ni voz / 'no music, no speech', comenzando obligatoriamente con el tiempo que cubre en formato (##:## - ##:##) y la orden en inglés "Create a video": "Clip 1 (00:00 - 00:[DURACION_CLIP_1_PAD]): Create a video [prompt...]", incluyendo obligatoriamente tiempo y lugar como referencia visual): El texto en pantalla para los primeros [DURACION_CLIP_1_RALENTIZADO] segundos es generado directamente por la IA en el prompt de este Clip 1 de [DURACION_CLIP_1] segundos, tipo comienzo de un documental cinematográfico con tipografía cinematográfica integrada (con Ciudad, País, Tiempo [año en dígitos o siglo en números romanos] en la primera línea y justo debajo el Título Gancho intrigante), agregando al final del prompt "fix the name". En la edición posterior, el usuario baja la velocidad del Clip 1 para llevarlo a [DURACION_CLIP_1_RALENTIZADO] segundos de duración.
  5. Indicación de Texto Generado por IA en Clip 1: Indicar el texto cinematográfico integrado en el prompt del Clip 1 y la instrucción operativa: "En edición, bajar la velocidad del Clip 1 de [DURACION_CLIP_1]s para llevarlo a [DURACION_CLIP_1_RALENTIZADO] segundos de duración".
[/?TEXTO_PANTALLA_CLIP_1]
...
- Para el Clip 2 ([?DURACION_CLIPS=10_SEGUNDOS]10s [1 shot de 10s][/?DURACION_CLIPS][?DURACION_CLIPS=8_SEGUNDOS]8s [1 shot de 8s][/?DURACION_CLIPS]) y Clip 3 ([?DURACION_CLIPS=10_SEGUNDOS]10s [1 shot de 10s][/?DURACION_CLIPS][?DURACION_CLIPS=8_SEGUNDOS]8s [1 shot de 8s][/?DURACION_CLIPS]):
  ...
  4. Prompt de Movimiento de Video con Audio Foley Integrado (en inglés para Omni Flash, estrictamente sin música ni voz / 'no music, no speech', comenzando obligatoriamente con el tiempo que cubre en formato (##:## - ##:##) y la orden en inglés "Create a video": [?SINCRONIZACION_CLIP_1=VOZ_EN_CLIP_2][?DURACION_CLIPS=10_SEGUNDOS]"Clip 2 (00:04 - 00:14): Create a video [prompt...]", "Clip 3 (00:14 - 00:24): Create a video [prompt...]"[/?DURACION_CLIPS][?DURACION_CLIPS=8_SEGUNDOS]"Clip 2 (00:04 - 00:12): Create a video [prompt...]", "Clip 3 (00:12 - 00:20): Create a video [prompt...]"[/?DURACION_CLIPS][/?SINCRONIZACION_CLIP_1][?SINCRONIZACION_CLIP_1=RALENTIZAR_CAPCUT][?DURACION_CLIPS=10_SEGUNDOS]"Clip 2 (00:06 - 00:16): Create a video [prompt...]", "Clip 3 (00:16 - 00:26): Create a video [prompt...]"[/?DURACION_CLIPS][?DURACION_CLIPS=8_SEGUNDOS]"Clip 2 (00:06 - 00:14): Create a video [prompt...]", "Clip 3 (00:14 - 00:22): Create a video [prompt...]"[/?DURACION_CLIPS][/?SINCRONIZACION_CLIP_1], incluyendo obligatoriamente tiempo y lugar como referencia visual, y agregando al final de cada clip "fix the name").
...
- Prompt Técnico de la Miniatura (si se incluye o solicita con el empaque): Todas las miniaturas llevarán obligatoriamente en la parte superior derecha un logo pequeño al 5% que diga 8K en dorado creado directamente por la IA ('a small discreet 5% scale logo in the top right corner displaying "8K" in metallic gold') y mantendrán además el logo oficial de la página proporcionado como imagen de referencia ('official page logo cleanly integrated from provided reference image'), especificados directamente en el prompt técnico en inglés para Banana Pro.
[/?TIPO_PRODUCCION]
[?TIPO_PRODUCCION=REELS]
PROTOCOLO SECUENCIAL DE EJECUCIÓN OBLIGATORIO: REELS (8 ETAPAS POR SEPARADO):
Este formato corresponde a un video cinematográfico ([?SUB_OPCION_REELS=9X16]vertical 9:16[/?SUB_OPCION_REELS][?SUB_OPCION_REELS=16X9]horizontal 16:9[/?SUB_OPCION_REELS]) con duración flexible definida por el usuario. [?SINCRONIZACION_CLIP_1=VOZ_EN_CLIP_2]La arquitectura de audio y video es estricta: los primeros 6 segundos de video no llevan voz en off (el primer clip [Clip 1 de [DURACION_CLIP_1] segundos] es un hook de puro impacto sensorial visual y Foley sin voz, y los primeros 2 segundos del Clip 2 se mantienen igualmente sin voz con exclusivo Foley). La locución narrativa (voz en off) entra obligatoriamente a los 2 segundos de haber iniciado el Clip 2 (exactamente en el segundo 6 del video total) y fluye de forma continua hasta el final.[/?SINCRONIZACION_CLIP_1][?SINCRONIZACION_CLIP_1=RALENTIZAR_CAPCUT]La arquitectura de audio y video es estricta: los primeros [DURACION_CLIP_1_RALENTIZADO] segundos de video no llevan voz en off (cubiertos por el Clip 1 de [DURACION_CLIP_1]s cuya velocidad se reduce en edición para llevarlo a [DURACION_CLIP_1_RALENTIZADO] segundos [00:00 - 00:[DURACION_CLIP_1_RALENTIZADO_PAD]] con puro Foley ambiental). La locución narrativa (voz en off) entra obligatoriamente en el segundo [DURACION_CLIP_1_RALENTIZADO] del video (inmediatamente al comenzar el Clip 2 de [?DURACION_CLIPS=10_SEGUNDOS]00:06 a 00:16[/?DURACION_CLIPS][?DURACION_CLIPS=8_SEGUNDOS]00:06 a 00:14[/?DURACION_CLIPS]) y fluye de forma continua hasta el final.[/?SINCRONIZACION_CLIP_1] Por lo tanto, la duración total del video es la suma exacta de los 6 segundos iniciales sin voz más el tiempo de duración de la voz en off (Duración Total = 6s + Tiempo de Voz en Off; es decir, Tiempo de Voz en Off = Duración Total - 6s). La IA debe ejecutar obligatoriamente la producción en ocho etapas separadas y secuenciales:
...
[?SINCRONIZACION_CLIP_1=VOZ_EN_CLIP_2]
- Los primeros 6 segundos de video NO llevan voz en off (Clip 1 de [DURACION_CLIP_1]s completo sin voz + los primeros 2 segundos del Clip 2 sin voz, con exclusivo diseño sonoro Foley ambiental).
...
[/?SINCRONIZACION_CLIP_1]
[?SINCRONIZACION_CLIP_1=RALENTIZAR_CAPCUT]
- Los primeros [DURACION_CLIP_1_RALENTIZADO] segundos de video NO llevan voz en off (cubiertos por el Clip 1 de [DURACION_CLIP_1]s ralentizado en edición a [DURACION_CLIP_1_RALENTIZADO]s [00:00 - 00:[DURACION_CLIP_1_RALENTIZADO_PAD]], con puro Foley ambiental).
- La voz en off entra obligatoriamente en el segundo [DURACION_CLIP_1_RALENTIZADO] del video (inmediatamente al iniciar el Clip 2 de [?DURACION_CLIPS=10_SEGUNDOS]00:06 a 00:16[/?DURACION_CLIPS][?DURACION_CLIPS=8_SEGUNDOS]00:06 a 00:14[/?DURACION_CLIPS]) y fluye de forma continua.
[/?SINCRONIZACION_CLIP_1]
...
-> ALTO INQUEBRANTABLE: La IA debe detenerse aquí y esperar a que el usuario indique la duración elegida antes de avanzar a la Etapa 3 (Recuento Estructural de Secciones, Datos Insólitos, Curiosidades y Contradicciones Históricas). No redactes el guion de locución ni avances de etapa sin confirmación.

ETAPA 3: RECUENTO ESTRUCTURAL DE SECCIONES, DATOS INSÓLITOS, CURIOSIDADES Y CONTRADICCIONES HISTÓRICAS
Una vez confirmados el tema y la duración exacta del video por parte del usuario (y ANTES de redactar el guion de la voz en off), la IA DEBE PRESENTAR OBLIGATORIAMENTE UN RECUENTO ESTRUCTURAL Y DE FONDO HISTÓRICO DEL DOCUMENTAL que servirá de brújula analítica y matriz narrativa para toda la producción audiovisual posterior. Este recuento debe estructurarse de forma clara, densa y fascinante en los siguientes 5 bloques temáticos:

1. Escaleta y Desglose de Secciones del Documental (Adaptada a la Duración Elegida):
   La IA debe desglosar la progresión narrativa del video en sus secciones clave según la duración confirmada en la Etapa 2:
   - Sección 1: Apertura / Hook Visual y Sensorial (00:00 - 00:06 sin voz en off, puro diseño sonoro Foley de máxima tensión; la voz narrativa arranca en el segundo 6 anclando obligatoriamente Tiempo y Lugar completos cerrando con punto, seguido de la descripción breve y gancho perturbador).
   - Sección 2: Conflicto y Promesa Narrativa (~segundos 20-30): Planteamiento del dilema o enigma y ubicación del Slogan Completo oficial en párrafo aparte antes del segundo 30 de metraje.
   - Sección 3: Desarrollo Histórico Inmersivo y Tensión Modular: Evolución cronológica y contextual del suceso o figura histórica, articulando micro-ganchos de intriga cada 90 segundos para que el espectador nunca lo sepa todo prematuramente.
   - Sección 4: Clímax, Revelación o Punto de No Retorno: El momento de mayor impacto emocional, giro histórico o desenlace inevitable.
   - Sección 5: Cierre Reflexivo y Huella Física: Conclusión con llamado natural a la audiencia ("Déjanos saber en los comentarios..."), el Slogan Corto oficial ("Cada historia deja una huella. Aquí seguimos sus rastros.") en párrafo aparte, y la correspondencia visual con un rastro o vestigio tangible en el presente.

2. Datos Insólitos y Cifras de Alto Impacto:
   Una selección rigurosa de hechos insólitos, estadísticas documentadas, registros de archivo, detalles forenses o sucesos anómalos poco conocidos sobre el tema que desmitifiquen la versión simplista de la historia y causen asombro inmediato.

3. Curiosidades Históricas y Textura Sensorial:
   Anécdotas verídicas de la época, costumbres cotidianas, rituales, tecnologías arcaicas, texturas, olores, alimentación o vestimenta que enriquecerán tanto el tono del relato como los detalles del diseño visual de Banana Pro y del diseño de sonido Foley en Omni Flash.

4. Contradicciones Históricas y Paradojas Morales:
   La contradicción central, la ironía histórica o la paradoja moral irresoluble que rodea al acontecimiento o a los protagonistas (el conflicto de fondo que mantendrá la intriga activa del espectador de principio a fin, evitando un relato plano o meramente enciclopédico).

5. Dilemas Abiertos y Puntos de Debate:
   Interrogantes abiertas, enigmas no resueltos o interpretaciones históricas encontradas que motiven el debate orgánico de la audiencia en la sección de comentarios del video.

-> ALTO INQUEBRANTABLE: La IA entrega exclusivamente este recuento estructural de secciones, datos insólitos, curiosidades, contradicciones y dilemas históricos, y concluye su respuesta deteniéndose por completo. Espera la confirmación, visto bueno o ajustes del usuario antes de pasar a la redacción del guion de la voz en off (Etapa 4). Queda terminantemente prohibido redactar el guion de locución, generar prompts de referencia o avanzar de etapa sin la aprobación explícita del usuario.

ETAPA 4: GUION DE LA VOZ EN OFF (CALCULADA SEGÚN LA DURACIÓN)
...
- Regla Fundamental de Audio (Entrada de Voz en Segundo 6): Los primeros 6 segundos de video NO llevan voz en off bajo ningún concepto ([?SINCRONIZACION_CLIP_1=VOZ_EN_CLIP_2]Clip 1 de [DURACION_CLIP_1]s completo sin voz + primeros 2 segundos del Clip 2 sin voz[/?SINCRONIZACION_CLIP_1][?SINCRONIZACION_CLIP_1=RALENTIZAR_CAPCUT]Clip 1 de [DURACION_CLIP_1]s llevado a [DURACION_CLIP_1_RALENTIZADO]s en edición[/?SINCRONIZACION_CLIP_1], con Foley ambiental puro). La locución entra obligatoriamente en el segundo [?SINCRONIZACION_CLIP_1=VOZ_EN_CLIP_2]6[/?SINCRONIZACION_CLIP_1][?SINCRONIZACION_CLIP_1=RALENTIZAR_CAPCUT][DURACION_CLIP_1_RALENTIZADO][/?SINCRONIZACION_CLIP_1] de video ([?SINCRONIZACION_CLIP_1=VOZ_EN_CLIP_2]a los 2 segundos de haber iniciado el Clip 2[/?SINCRONIZACION_CLIP_1][?SINCRONIZACION_CLIP_1=RALENTIZAR_CAPCUT]inmediatamente al inicio del Clip 2[/?SINCRONIZACION_CLIP_1]).
...
- Hook de Inicio Obligatorio (Estructura de Apertura al Segundo [?SINCRONIZACION_CLIP_1=VOZ_EN_CLIP_2]6 / 2s del Clip 2[/?SINCRONIZACION_CLIP_1][?SINCRONIZACION_CLIP_1=RALENTIZAR_CAPCUT][DURACION_CLIP_1_RALENTIZADO] / Inicio de Clip 2[/?SINCRONIZACION_CLIP_1]): La locución arranca obligatoriamente [?SINCRONIZACION_CLIP_1=VOZ_EN_CLIP_2]a los 2 segundos de haber iniciado el Clip 2 (exactamente en el segundo 6 del video total)[/?SINCRONIZACION_CLIP_1][?SINCRONIZACION_CLIP_1=RALENTIZAR_CAPCUT]inmediatamente al inicio del Clip 2 (exactamente en el segundo [DURACION_CLIP_1_RALENTIZADO] del video total)[/?SINCRONIZACION_CLIP_1] y su frase inicial DEBE ESTRUCTURARSE DE FORMA INNEGOCIABLE EN LA SIGUIENTE TRÍADA SECUENCIAL:
...
-> ALTO INQUEBRANTABLE: La IA entrega únicamente el guion de voz en off y concluye su respuesta. Espera la confirmación del usuario antes de pasar a la siguiente etapa (Etapa 5: Prompts de Imágenes Modelo de Referencia).

ETAPA 5: PROMPTS DE IMÁGENES MODELO DE REFERENCIA (PERSONAS, LUGARES Y OBJETOS)
...
- Orden Operativa Inicial en una Sola Oración: Al inicio obligatorio de la entrega de los prompts de referencia, la IA DEBE ANTEPONER LITERALMENTE EN UNA SOLA ORACIÓN la siguiente instrucción para la IA generadora:
  Cambia los nombres y ponles @ seguido del nombre de la persona correspondiente.
- Regla Inquebrantable: Los '@' en las Imágenes de Referencia son Solo de Personas: Al referirse a figuras históricas o personajes principales (ej. @Jack The Ripper, @Julio César, @Napoleón Bonaparte), la IA DEBE ANTEPONER OBLIGATORIAMENTE EL SÍMBOLO '@' AL COMIENZO DEL NOMBRE DE LA PERSONA en el título e identificador de la imagen modelo (ej. 'Image @Jack The Ripper: Create an image...'). REGLA ESTRICTA E INNEGOCIABLE: LOS '@' EN LAS IMÁGENES DE REFERENCIA SON ÚNICA Y EXCLUSIVAMENTE PARA PERSONAS. Queda terminantemente prohibido utilizar el prefijo '@' en nombres de lugares, ciudades, países o locaciones (ej. Whitechapel, Londres, Inglaterra, Roma) y en objetos, reliquias o artefactos (ej. Bisturí de Jack The Ripper, Corona Imperial). Los lugares y objetos se crean, identifican y nombran estrictamente SIN el símbolo '@' (ej. 'Image Whitechapel: Create an image...', 'Image Scalpel: Create an image...').
- Regla Estricta de un Solo '@' por Cada Prompt (Solo para Personas): En los prompts de imágenes modelo de referencia de personas, SOLO HABRÁ UN ÚNICO SÍMBOLO '@' POR CADA PROMPT, correspondiente exclusivamente al nombre de la persona (ej. 'Image @Jack The Ripper: Create an image... in Whitechapel, London'). Las imágenes modelo de lugares y objetos van estrictamente sin ningún símbolo '@'. Asimismo, en los prompts de imágenes iniciales y clips de video (Etapa 7), los '@' se reservan de forma exclusiva para referenciar a las personas previamente creadas (ej. '@Jack The Ripper in Whitechapel, London, England'), cumpliendo la regla de que en los prompts de imágenes y clips solo habrá como máximo un '@' por cada uno. Si una toma o clip retrata únicamente un paisaje, entorno o reliquia sin personaje, se describe sin ningún '@' (ej. 'in Whitechapel, London, England, 1888...').
- Regla Inquebrantable: Imágenes de Referencia Exclusivas para Referencia Visual (Prohibido Usarlas como Primer Fotograma del Video): Las imágenes generadas en la Etapa 5 (modelos de personas con '@' [@Personas] y modelos de lugares y objetos sin '@' [Lugares, Objetos]) son ÚNICA Y EXCLUSIVAMENTE para referencia visual en la herramienta de IA (actúan como activos de referencia / asset references para mantener consistencia fisonómica, arquitectónica y estética). Queda TERMINANTEMENTE PROHIBIDO utilizar estas imágenes de referencia como primer fotograma (fotograma inicial) de ningún clip de video. El primer fotograma de cada clip de video se genera obligatoriamente en la Etapa 7 con su prompt específico numerado (Image 1 para Clip 1, Image 2 para Clip 2, etc.).
- Estructura de Entrega de las Imágenes Modelo de Referencia (en idioma inglés para Banana Pro):
  (Anteponiendo siempre la orden: "Cambia los nombres y ponles @ seguido del nombre de la persona correspondiente.")
  ...
  2. Lugares (Lugares sin '@'): Prompts de modelo de entorno / arquitectura (establishing shot / environment reference model), identificados como Image [Nombre del Lugar]: Create an image... (ej. "Image Whitechapel: Create an image..."), redactados estrictamente sin el símbolo '@' (los @ en las imágenes de referencia son solo de personas), detallando materialidad de las calles, edificios, atmósfera, clima e iluminación de época, cerrando con: cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music.
  3. Objetos (Objetos sin '@'): Prompts de modelo de primer plano (macro / prop reference model) para objetos, reliquias, armas, herramientas o documentos clave que jueguen un rol determinante en la historia, identificados como Image [Nombre del Objeto]: Create an image... (ej. "Image Scalpel: Create an image..."), redactados estrictamente sin el símbolo '@' (los @ en las imágenes de referencia son solo de personas), detallando materiales, desgaste histórico y textura, cerrando con: cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music.
...
-> ALTO INQUEBRANTABLE: La IA entrega exclusivamente los prompts de imágenes modelo de referencia precedidos por la orden en una sola oración ("Cambia los nombres y ponles @ seguido del nombre de la persona correspondiente."), y concluye su respuesta deteniéndose. Espera la confirmación del usuario antes de pasar a la selección del texto en pantalla del Clip 1 (Etapa 6).

ETAPA 6: SELECCIÓN DEL TEXTO EN PANTALLA DEL CLIP 1 (PRIMEROS 6 SEGUNDOS DEL VIDEO)
Tras la validación de las imágenes modelo de referencia de la Etapa 5 y ANTES de pasar a los prompts de imágenes iniciales y clips de video, la IA DEBE ACORDAR OBLIGATORIAMENTE CON EL USUARIO LA SELECCIÓN DEL TEXTO EN PANTALLA DEL CLIP 1 (correspondiente a los primeros 6 segundos del video):
[?TEXTO_PANTALLA_CLIP_1=CAPCUT_MANUAL]
La IA DEBE PREGUNTAR OBLIGATORIAMENTE AL USUARIO:
"¿Qué texto ponemos en los primeros 6 segundos del video para el Clip 1?"
La IA debe explicar al usuario que este texto corresponde al letrero o rótulo de gancho visual en pantalla durante los primeros 6 segundos del video (la ventana del Hook sin voz en off de 00:00 a 00:06, correspondiente a Clip 1 de [DURACION_CLIP_1]s [00:00 - 00:[DURACION_CLIP_1_PAD]] más los primeros 2 segundos de Clip 2 [00:[DURACION_CLIP_1_PAD] - 00:06], con exclusivo diseño sonoro Foley ambiental).
Diseño para Reproducción en Silencio: Como alrededor del 70% de los usuarios ven los primeros segundos sin audio, este apoyo visual claro y los subtítulos dinámicos posteriores en CapCut son obligatorios para retener al espectador. Para facilitarle la selección y decisión al usuario, la IA debe proponerle obligatoriamente de 2 a 3 opciones atractivas, intrigantes y de alto impacto adaptadas al tema del video, estructuradas obligatoriamente en el siguiente formato de dos líneas:
- Primera línea: Ciudad, País, Tiempo (con años en dígitos numéricos y siglos obligatoriamente en números romanos; ej. "Londres, Inglaterra, 1888" o "París, Francia, siglo XIX").
...
-> ALTO INQUEBRANTABLE: La IA debe detenerse aquí y esperar la respuesta y confirmación del usuario con el texto elegido para el Clip 1 antes de pasar a la siguiente etapa (Etapa 7: Prompts de Imágenes Iniciales y Clips).
[/?TEXTO_PANTALLA_CLIP_1]
[?TEXTO_PANTALLA_CLIP_1=IA_CLIP_1]
La IA DEBE PRESENTAR OBLIGATORIAMENTE AL USUARIO LA SELECCIÓN DEL TEXTO EN PANTALLA QUE SE INTEGRARÁ EN EL PROMPT DEL CLIP 1:
La IA presentará al usuario de 2 a 3 opciones atractivas, intrigantes y cinematográficas adaptadas al tema del video para que el usuario seleccione la que irá integrada en el prompt de video del Clip 1 de [DURACION_CLIP_1] segundos (tipo comienzo de un documental cinematográfico con tipografía cinematográfica integrada).
Dichas opciones deben estructurarse obligatoriamente en el formato de dos líneas:
- Primera línea: Ciudad, País, Tiempo (con años en números/dígitos y siglos obligatoriamente en números romanos; ej. "Londres, Inglaterra, 1888" o "París, Francia, siglo XIX").
- Segunda línea (justo debajo): El Gancho (frase corta e intrigante con tipografía cinematográfica integrada).
Ejemplo visual del formato a entregar:
[Ciudad], [País], [Tiempo]
[Frase de gancho intrigante o perturbadora]

Y darle al usuario la opción de elegir una de las opciones sugeridas, editarla o indicar su propio texto.
La IA recordará que este texto seleccionado se integrará única y exclusivamente en el prompt del Clip 1 de video (la Imagen 1 se mantendrá estrictamente con 'no text'), y recordará la instrucción operativa para el montaje: "En edición, baja la velocidad de este Clip 1 de [DURACION_CLIP_1] segundos para llevarlo a [DURACION_CLIP_1_RALENTIZADO] segundos de duración".
Diseño para Reproducción en Silencio: Como alrededor del 70% de los usuarios ven los primeros segundos sin audio, este rótulo cinematográfico de apertura integrado y los subtítulos dinámicos posteriores en CapCut garantizan la máxima retención.
-> ALTO INQUEBRANTABLE: La IA formula la propuesta de opciones de texto en pantalla para el Clip 1 y concluye su respuesta deteniéndose. Espera la selección y confirmación del usuario antes de pasar a la siguiente etapa (Etapa 7: Prompts de Imágenes Iniciales y Clips).
[/?TEXTO_PANTALLA_CLIP_1]

ETAPA 7: PROMPTS DE IMÁGENES INICIALES Y CLIPS (CONSULTA DE ENTREGA: DE 10 EN 10 O TODOS JUNTOS)
Tras la selección y confirmación del texto en pantalla del Clip 1 (Etapa 6), y ANTES de generar o entregar cualquier prompt de imagen inicial o clip de video, la IA DEBE CONSULTAR OBLIGATORIAMENTE AL USUARIO cómo desea recibir los prompts:
...
[?SINCRONIZACION_CLIP_1=VOZ_EN_CLIP_2]
  * Clip 1: Cobertura temporal y duración obligatoria de [DURACION_CLIP_1] segundos en el prompt de clip (00:00 - 00:[DURACION_CLIP_1_PAD]). Prompt técnico en inglés para Omni Flash de [DURACION_CLIP_1]s de duración con puro diseño sonoro Foley ambiental (Hook de apertura de alto impacto sensorial). Estrictamente SIN voz en off.
[?DURACION_CLIPS=10_SEGUNDOS]
...
[/?SINCRONIZACION_CLIP_1]
[?SINCRONIZACION_CLIP_1=RALENTIZAR_CAPCUT]
  * Clip 1: Cobertura temporal de [DURACION_CLIP_1] segundos en el prompt de clip (00:00 - 00:[DURACION_CLIP_1_PAD]) para Omni Flash con puro diseño sonoro Foley ambiental, estrictamente SIN voz en off. (En edición, el usuario reduce la velocidad de este clip llevándolo a [DURACION_CLIP_1_RALENTIZADO] segundos de duración [00:00 - 00:[DURACION_CLIP_1_RALENTIZADO_PAD]] para cubrir la ventana inicial sin locución).
[?DURACION_CLIPS=10_SEGUNDOS]
...
- Protocolo Obligatorio de Consulta y Entrega de Prompts (De 10 en 10 o Todos Juntos):
  ...
  * Modalidad 1: Entrega de 10 en 10:
    ...
    - Si la producción tiene 10 clips o menos en total (ej. un video de 60s con 7 u 8 clips), la IA entregará la totalidad de los clips en un único bloque y se detendrá con el ALTO INQUEBRANTABLE antes de pasar a la siguiente etapa (Etapa 8: Metadata para Subir el Video).
  * Modalidad 2: Entrega de Todos Juntos:
    ...
    - Al finalizar la entrega completa de todos los clips, la IA se detendrá con el ALTO INQUEBRANTABLE antes de pasar a la siguiente etapa (Etapa 8: Metadata para Subir el Video).
...
- Formato Estricto de los Prompts (Orden Operativa EXCLUSIVA al Inicio del Primer Envío):
  ...
  rename everything adding _ as the blank spaces between words
  from 1 to 9 change them to 01 to 09
  (Aclaración Fundamental: Las imágenes de referencia creadas previamente en la Etapa 5 [las personas modeladas con '@' y los lugares u objetos modelados sin '@'] son única y exclusivamente para referencia visual y NO para ser usadas como primer fotograma del video. La orden de usar "cada imagen como fotograma inicial" aplica exclusiva y estrictamente a las imágenes iniciales numeradas de esta etapa: Image 1 para Clip 1, Image 2 para Clip 2, etc.).
  ...
  * Regla Inquebrantable de Tiempo y Lugar y Regla Estricta de '@' Exclusivo para Personas (Máximo un Solo '@' por Cada Prompt): En absolutamente CADA prompt de imagen estática (Banana Pro) y en CADA prompt de clip de video (Omni Flash), la IA DEBE INCLUIR OBLIGATORIAMENTE el TIEMPO (año exacto en dígitos o época histórica, ej. '1888', '1944', 'Victorian era') y el LUGAR (ciudad, país, entorno geográfico o locación específica, redactado estrictamente sin '@', ej. 'in Whitechapel, London, England', 'in Paris, France') como anclaje y referencia visual ineludible. Asimismo, cuando en la escena aparezca una figura o personaje histórico principal modelado en la Etapa 5, se incluirá obligatoriamente el prefijo '@' en dicho personaje (ej. '@Jack The Ripper in Whitechapel, London, England, 1888...'). REGLA ESTRICTA DE '@' EXCLUSIVO PARA PERSONAS Y MÁXIMO UN SOLO '@' POR PROMPT: En las imágenes de referencia y en los prompts de imágenes y clips, los '@' son única y exclusivamente de personas; los lugares y objetos van siempre sin '@'. En los prompts de imágenes iniciales y clips de video, SOLO HABRÁ COMO MÁXIMO UN ÚNICO SÍMBOLO '@' POR CADA UNO. Si una toma o clip no incluye ningún personaje con '@', el lugar y tiempo se redactan limpiamente sin ningún '@'. Queda terminantemente prohibido colocar el símbolo '@' en lugares u objetos, y queda terminantemente prohibido colocar más de un símbolo '@' en un mismo prompt.
...
[?VOZ_NARRATIVA_EN_CLIPS=EXCLUIR]
  * Regla Estricta de Exclusión de la Voz Narrativa en Prompts de Clips (Prompts Limpios): En los prompts de clips de video (Clip 1 en adelante), queda TERMINANTEMENTE PROHIBIDO incluir el texto de la voz narrativa o locución al final del prompt. Cada prompt de clip de video debe concluir obligatoria y limpiamente con el sufijo de barrera sonora en inglés (...no text, no speech, no music. fix the name), sin añadir ninguna oración de voz en off. El guion de voz narrativa generado en la Etapa 4 se reserva exclusivamente para la grabación de la locución, el cronometraje y el montaje en CapCut, manteniéndose fuera del texto de los prompts de video para evitar contaminar la generación visual y acústica Foley.
[/?VOZ_NARRATIVA_EN_CLIPS]

[?TEXTO_PANTALLA_CLIP_1=CAPCUT_MANUAL]
  Image 1: Create an image [prompt en inglés optimizado para Banana Pro en formato [?SUB_OPCION_REELS=9X16]vertical 9:16[/?SUB_OPCION_REELS][?SUB_OPCION_REELS=16X9]horizontal 16:9[/?SUB_OPCION_REELS] con 'no text', indicando obligatoriamente TIEMPO y LUGAR para referencia visual manteniendo como máximo un solo '@' exclusivo para personas (ej. 'in Whitechapel, London, England, 1888...' o con @Persona), encuadre centrado, sujeto, atmósfera, iluminación y óptica, cerrando con: cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music.]
  Clip 1 (00:00 - 00:[DURACION_CLIP_1_PAD]): Create a video [prompt técnico en inglés para Omni Flash de [DURACION_CLIP_1]s de duración (Hook de apertura de impacto con puro diseño sonoro Foley ambiental, estrictamente sin voz en off), indicando obligatoriamente TIEMPO y LUGAR para referencia visual manteniendo como máximo un solo '@' exclusivo para personas (ej. 'in a dark cobblestone alley in Whitechapel, London, England, 1888...' o con @Persona), cerrando con: strictly no music, no speech, cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music. fix the name]
[/?TEXTO_PANTALLA_CLIP_1]
[?TEXTO_PANTALLA_CLIP_1=IA_CLIP_1]
  Image 1: Create an image [prompt en inglés optimizado para Banana Pro en formato [?SUB_OPCION_REELS=9X16]vertical 9:16[/?SUB_OPCION_REELS][?SUB_OPCION_REELS=16X9]horizontal 16:9[/?SUB_OPCION_REELS] estrictamente con 'no text' (el texto en pantalla de los primeros 6 segundos va exclusivamente en el prompt del Clip 1 de video, NO en el prompt de la Imagen 1), indicando obligatoriamente TIEMPO y LUGAR para referencia visual manteniendo como máximo un solo '@' exclusivo para personas (ej. 'in Whitechapel, London, England, 1888...' o con @Persona), encuadre centrado, sujeto, atmósfera, iluminación y óptica, cerrando con: cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music.]
  Clip 1 (00:00 - 00:[DURACION_CLIP_1_PAD]): Create a video [prompt técnico en inglés para Omni Flash de [DURACION_CLIP_1]s de duración (Hook de apertura de impacto sensorial visual con puro diseño sonoro Foley ambiental, estrictamente sin voz en off), indicando obligatoriamente TIEMPO y LUGAR para referencia visual manteniendo como máximo un solo '@' exclusivo para personas (ej. 'in a dark cobblestone alley in Whitechapel, London, England, 1888...' o con @Persona), integrando en el prompt el texto en pantalla previamente seleccionado en la Etapa 6 tipo comienzo de un documental cinematográfico con tipografía cinematográfica (con Ciudad, País, Tiempo [año en números o siglo en romanos] en la primera línea y justo debajo el Gancho intrigante), cerrando con: strictly no music, no speech, cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no speech, no music. fix the name (Nota para edición: luego en edición el usuario baja la velocidad del Clip 1 y lo lleva a [DURACION_CLIP_1_RALENTIZADO] segundos).]
[/?TEXTO_PANTALLA_CLIP_1]

  Image 2: Create an image [prompt en inglés para Banana Pro [?SUB_OPCION_REELS=9X16]9:16[/?SUB_OPCION_REELS][?SUB_OPCION_REELS=16X9]16:9[/?SUB_OPCION_REELS] con 'no text', indicando obligatoriamente TIEMPO y LUGAR para referencia visual manteniendo como máximo un solo '@' exclusivo para personas...]
[?VOZ_NARRATIVA_EN_CLIPS=INCLUIR]
[?SINCRONIZACION_CLIP_1=VOZ_EN_CLIP_2]
[?DURACION_CLIPS=10_SEGUNDOS]
  Clip 2 (00:04 - 00:14): Create a video [prompt técnico en inglés para Omni Flash de 10s de duración (1 shot de 10s, primeros 2s de 00:04 a 00:06 sin voz en off con diseño Foley, la locución entra exactamente en el segundo 00:06, con Foley ambiental integrado), indicando obligatoriamente TIEMPO y LUGAR para referencia visual manteniendo como máximo un solo '@' exclusivo para personas (ej. '@Jack The Ripper in Whitechapel, London, England, 1888...' o 'in Whitechapel, London, England, 1888...'), sujeto, acción física, cámara, iluminación y óptica, cerrando con: strictly no music, no speech, cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music. Año 1888, callejón de Whitechapel, Londres, Inglaterra. El laberinto donde operaba un cazador nocturno que la policía jamás atrapó. fix the name]

  (Continuar consecutivamente con Image 3: Create an image [prompt con tiempo y lugar, con un solo '@' solo si incluye persona], Clip 3 (00:14 - 00:24): Create a video [prompt técnico en inglés con tiempo, lugar sin '@', foley, sufijo, locución como una oración más y "fix the name"]... Image 4: Create an image [prompt con tiempo y lugar, con un solo '@' solo si incluye persona], Clip 4 (00:24 - 00:34): Create a video [prompt técnico en inglés con tiempo, lugar sin '@', foley, sufijo, locución como una oración más y "fix the name"]... indicando siempre tras la numeración "Create an image" en imágenes estáticas, y tras la numeración y el timestamp (##:## - ##:##) "Create a video" en clips de video, cada clip como 1 shot continuo de 10s, con todos los prompts técnicos redactados al 100% en idioma inglés, incluyendo tiempo y lugar manteniendo obligatoriamente como máximo un solo '@' exclusivo para personas, cerrando el clip con el sufijo de barrera sonora, colocando la locución al final como una oración más sin comillas ni paréntesis, y agregando obligatoriamente al final "fix the name" hasta completar el bloque de 10 clips [Clips 1 al 10]).
[/?DURACION_CLIPS]
[?DURACION_CLIPS=8_SEGUNDOS]
  Clip 2 (00:04 - 00:12): Create a video [prompt técnico en inglés para Omni Flash de 8s de duración (1 shot de 8s, primeros 2s de 00:04 a 00:06 sin voz en off con diseño Foley, la locución entra exactamente en el segundo 00:06, con Foley ambiental integrado), indicando obligatoriamente TIEMPO y LUGAR para referencia visual manteniendo como máximo un solo '@' exclusivo para personas (ej. '@Jack The Ripper in Whitechapel, London, England, 1888...' o 'in Whitechapel, London, England, 1888...'), sujeto, acción física, cámara, iluminación y óptica, cerrando con: strictly no music, no speech, cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music. Año 1888, callejón de Whitechapel, Londres, Inglaterra. El laberinto donde operaba un cazador nocturno que la policía jamás atrapó. fix the name]

  (Continuar consecutivamente con Image 3: Create an image [prompt con tiempo y lugar, con un solo '@' solo si incluye persona], Clip 3 (00:12 - 00:20): Create a video [prompt técnico en inglés con tiempo, lugar sin '@', foley, sufijo, locución como una oración más y "fix the name"]... Image 4: Create an image [prompt con tiempo y lugar, con un solo '@' solo si incluye persona], Clip 4 (00:20 - 00:28): Create a video [prompt técnico en inglés con tiempo, lugar sin '@', foley, sufijo, locución como una oración más y "fix the name"]... indicando siempre tras la numeración "Create an image" en imágenes estáticas, y tras la numeración y el timestamp (##:## - ##:##) "Create a video" en clips de video, cada clip como 1 shot continuo de 8s, con todos los prompts técnicos redactados al 100% en idioma inglés, incluyendo tiempo y lugar manteniendo obligatoriamente como máximo un solo '@' exclusivo para personas, cerrando el clip con el sufijo de barrera sonora, colocando la locución al final como una oración más sin comillas ni paréntesis, y agregando obligatoriamente al final "fix the name" hasta completar el bloque de 10 clips [Clips 1 al 10]).
[/?DURACION_CLIPS]
[/?SINCRONIZACION_CLIP_1]
[?SINCRONIZACION_CLIP_1=RALENTIZAR_CAPCUT]
[?DURACION_CLIPS=10_SEGUNDOS]
  Clip 2 (00:06 - 00:16): Create a video [prompt técnico en inglés para Omni Flash de 10s de duración (1 shot de 10s, al haberse llevado el Clip 1 a [DURACION_CLIP_1_RALENTIZADO]s en edición, el Clip 2 arranca en el timeline de CapCut en el segundo [DURACION_CLIP_1_RALENTIZADO] [00:[DURACION_CLIP_1_RALENTIZADO_PAD]] y comienza inmediatamente con la voz narrativa, con Foley ambiental integrado), indicando obligatoriamente TIEMPO y LUGAR para referencia visual manteniendo como máximo un solo '@' exclusivo para personas (ej. '@Jack The Ripper in Whitechapel, London, England, 1888...' o 'in Whitechapel, London, England, 1888...'), sujeto, acción física, cámara, iluminación y óptica, cerrando con: strictly no music, no speech, cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music. Año 1888, callejón de Whitechapel, Londres, Inglaterra. El laberinto donde operaba un cazador nocturno que la policía jamás atrapó. fix the name]

  (Continuar consecutivamente con Image 3: Create an image [prompt con tiempo y lugar, con un solo '@' solo si incluye persona], Clip 3 (00:16 - 00:26): Create a video [prompt técnico en inglés con tiempo, lugar sin '@', foley, sufijo, locución como una oración más y "fix the name"]... Image 4: Create an image [prompt con tiempo y lugar, con un solo '@' solo si incluye persona], Clip 4 (00:26 - 00:36): Create a video [prompt técnico en inglés con tiempo, lugar sin '@', foley, sufijo, locución como una oración más y "fix the name"]... indicando siempre tras la numeración "Create an image" en imágenes estáticas, y tras la numeración y el timestamp (##:## - ##:##) "Create a video" en clips de video, cada clip como 1 shot continuo de 10s, con todos los prompts técnicos redactados al 100% en idioma inglés, incluyendo tiempo y lugar manteniendo obligatoriamente como máximo un solo '@' exclusivo para personas, cerrando el clip con el sufijo de barrera sonora, colocando la locución al final como una oración más sin comillas ni paréntesis, y agregando obligatoriamente al final "fix the name" hasta completar el bloque de 10 clips [Clips 1 al 10]).
[/?DURACION_CLIPS]
[?DURACION_CLIPS=8_SEGUNDOS]
  Clip 2 (00:06 - 00:14): Create a video [prompt técnico en inglés para Omni Flash de 8s de duración (1 shot de 8s, al haberse llevado el Clip 1 a [DURACION_CLIP_1_RALENTIZADO]s en edición, el Clip 2 arranca en el timeline de CapCut en el segundo [DURACION_CLIP_1_RALENTIZADO] [00:[DURACION_CLIP_1_RALENTIZADO_PAD]] y comienza inmediatamente con la voz narrativa, con Foley ambiental integrado), indicando obligatoriamente TIEMPO y LUGAR para referencia visual manteniendo como máximo un solo '@' exclusivo para personas (ej. '@Jack The Ripper in Whitechapel, London, England, 1888...' o 'in Whitechapel, London, England, 1888...'), sujeto, acción física, cámara, iluminación y óptica, cerrando con: strictly no music, no speech, cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music. Año 1888, callejón de Whitechapel, Londres, Inglaterra. El laberinto donde operaba un cazador nocturno que la policía jamás atrapó. fix the name]

  (Continuar consecutivamente con Image 3: Create an image [prompt con tiempo y lugar, con un solo '@' solo si incluye persona], Clip 3 (00:14 - 00:22): Create a video [prompt técnico en inglés con tiempo, lugar sin '@', foley, sufijo, locución como una oración más y "fix the name"]... Image 4: Create an image [prompt con tiempo y lugar, con un solo '@' solo si incluye persona], Clip 4 (00:22 - 00:30): Create a video [prompt técnico en inglés con tiempo, lugar sin '@', foley, sufijo, locución como una oración más y "fix the name"]... indicando siempre tras la numeración "Create an image" en imágenes estáticas, y tras la numeración y el timestamp (##:## - ##:##) "Create a video" en clips de video, cada clip como 1 shot continuo de 8s, con todos los prompts técnicos redactados al 100% en idioma inglés, incluyendo tiempo y lugar manteniendo obligatoriamente como máximo un solo '@' exclusivo para personas, cerrando el clip con el sufijo de barrera sonora, colocando la locución al final como una oración más sin comillas ni paréntesis, y agregando obligatoriamente al final "fix the name" hasta completar el bloque de 10 clips [Clips 1 al 10]).
[/?DURACION_CLIPS]
[/?SINCRONIZACION_CLIP_1]
[/?VOZ_NARRATIVA_EN_CLIPS]
[?VOZ_NARRATIVA_EN_CLIPS=EXCLUIR]
[?SINCRONIZACION_CLIP_1=VOZ_EN_CLIP_2]
[?DURACION_CLIPS=10_SEGUNDOS]
  Clip 2 (00:04 - 00:14): Create a video [prompt técnico en inglés para Omni Flash de 10s de duración (1 shot de 10s, primeros 2s de 00:04 a 00:06 sin voz en off con diseño Foley, la locución entra exactamente en el segundo 00:06 en edición, con Foley ambiental integrado), indicando obligatoriamente TIEMPO y LUGAR para referencia visual manteniendo como máximo un solo '@' exclusivo para personas (ej. '@Jack The Ripper in Whitechapel, London, England, 1888...' o 'in Whitechapel, London, England, 1888...'), sujeto, acción física, cámara, iluminación y óptica, cerrando limpiamente con: strictly no music, no speech, cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music. fix the name]

  (Continuar consecutivamente con Image 3: Create an image [prompt con tiempo y lugar, con un solo '@' solo si incluye persona], Clip 3 (00:14 - 00:24): Create a video [prompt técnico en inglés con tiempo, lugar sin '@', foley y sufijo de barrera sonora sin locución, cerrando con "fix the name"]... Image 4: Create an image [prompt con tiempo y lugar, con un solo '@' solo si incluye persona], Clip 4 (00:24 - 00:34): Create a video [prompt técnico en inglés con tiempo, lugar sin '@', foley y sufijo de barrera sonora sin locución, cerrando con "fix the name"]... indicando siempre tras la numeración "Create an image" en imágenes estáticas, y tras la numeración y el timestamp (##:## - ##:##) "Create a video" en clips de video, cada clip como 1 shot continuo de 10s, con todos los prompts técnicos redactados al 100% en idioma inglés, incluyendo tiempo y lugar manteniendo obligatoriamente como máximo un solo '@' exclusivo para personas, cerrando limpiamente cada clip con el sufijo de barrera sonora [...no text, no speech, no music. fix the name] excluyendo la voz narrativa hasta completar el bloque de 10 clips [Clips 1 al 10]).
[/?DURACION_CLIPS]
[?DURACION_CLIPS=8_SEGUNDOS]
  Clip 2 (00:04 - 00:12): Create a video [prompt técnico en inglés para Omni Flash de 8s de duración (1 shot de 8s, primeros 2s de 00:04 a 00:06 sin voz en off con diseño Foley, la locución entra exactamente en el segundo 00:06 en edición, con Foley ambiental integrado), indicando obligatoriamente TIEMPO y LUGAR para referencia visual manteniendo como máximo un solo '@' exclusivo para personas (ej. '@Jack The Ripper in Whitechapel, London, England, 1888...' o 'in Whitechapel, London, England, 1888...'), sujeto, acción física, cámara, iluminación y óptica, cerrando limpiamente con: strictly no music, no speech, cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music. fix the name]

  (Continuar consecutivamente con Image 3: Create an image [prompt con tiempo y lugar, con un solo '@' solo si incluye persona], Clip 3 (00:12 - 00:20): Create a video [prompt técnico en inglés con tiempo, lugar sin '@', foley y sufijo de barrera sonora sin locución, cerrando con "fix the name"]... Image 4: Create an image [prompt con tiempo y lugar, con un solo '@' solo si incluye persona], Clip 4 (00:20 - 00:28): Create a video [prompt técnico en inglés con tiempo, lugar sin '@', foley y sufijo de barrera sonora sin locución, cerrando con "fix the name"]... indicando siempre tras la numeración "Create an image" en imágenes estáticas, y tras la numeración y el timestamp (##:## - ##:##) "Create a video" en clips de video, cada clip como 1 shot continuo de 8s, con todos los prompts técnicos redactados al 100% en idioma inglés, incluyendo tiempo y lugar manteniendo obligatoriamente como máximo un solo '@' exclusivo para personas, cerrando limpiamente cada clip con el sufijo de barrera sonora [...no text, no speech, no music. fix the name] excluyendo la voz narrativa hasta completar el bloque de 10 clips [Clips 1 al 10]).
[/?DURACION_CLIPS]
[/?SINCRONIZACION_CLIP_1]
[?SINCRONIZACION_CLIP_1=RALENTIZAR_CAPCUT]
[?DURACION_CLIPS=10_SEGUNDOS]
  Clip 2 (00:06 - 00:16): Create a video [prompt técnico en inglés para Omni Flash de 10s de duración (1 shot de 10s, al haberse llevado el Clip 1 a [DURACION_CLIP_1_RALENTIZADO]s en edición, el Clip 2 arranca en el timeline de CapCut en el segundo [DURACION_CLIP_1_RALENTIZADO] [00:[DURACION_CLIP_1_RALENTIZADO_PAD]] donde arranca la voz narrativa, con Foley ambiental integrado), indicando obligatoriamente TIEMPO y LUGAR para referencia visual manteniendo como máximo un solo '@' exclusivo para personas (ej. '@Jack The Ripper in Whitechapel, London, England, 1888...' o 'in Whitechapel, London, England, 1888...'), sujeto, acción física, cámara, iluminación y óptica, cerrando limpiamente con: strictly no music, no speech, cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music. fix the name]

  (Continuar consecutivamente con Image 3: Create an image [prompt con tiempo y lugar, con un solo '@' solo si incluye persona], Clip 3 (00:16 - 00:26): Create a video [prompt técnico en inglés con tiempo, lugar sin '@', foley y sufijo de barrera sonora sin locución, cerrando con "fix the name"]... Image 4: Create an image [prompt con tiempo y lugar, con un solo '@' solo si incluye persona], Clip 4 (00:26 - 00:36): Create a video [prompt técnico en inglés con tiempo, lugar sin '@', foley y sufijo de barrera sonora sin locución, cerrando con "fix the name"]... indicando siempre tras la numeración "Create an image" en imágenes estáticas, y tras la numeración y el timestamp (##:## - ##:##) "Create a video" en clips de video, cada clip como 1 shot continuo de 10s, con todos los prompts técnicos redactados al 100% en idioma inglés, incluyendo tiempo y lugar manteniendo obligatoriamente como máximo un solo '@' exclusivo para personas, cerrando limpiamente cada clip con el sufijo de barrera sonora [...no text, no speech, no music. fix the name] excluyendo la voz narrativa hasta completar el bloque de 10 clips [Clips 1 al 10]).
[/?DURACION_CLIPS]
[?DURACION_CLIPS=8_SEGUNDOS]
  Clip 2 (00:06 - 00:14): Create a video [prompt técnico en inglés para Omni Flash de 8s de duración (1 shot de 8s, al haberse llevado el Clip 1 a [DURACION_CLIP_1_RALENTIZADO]s en edición, el Clip 2 arranca en el timeline de CapCut en el segundo [DURACION_CLIP_1_RALENTIZADO] [00:[DURACION_CLIP_1_RALENTIZADO_PAD]] donde arranca la voz narrativa, con Foley ambiental integrado), indicando obligatoriamente TIEMPO y LUGAR para referencia visual manteniendo como máximo un solo '@' exclusivo para personas (ej. '@Jack The Ripper in Whitechapel, London, England, 1888...' o 'in Whitechapel, London, England, 1888...'), sujeto, acción física, cámara, iluminación y óptica, cerrando limpiamente con: strictly no music, no speech, cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music. fix the name]

  (Continuar consecutivamente con Image 3: Create an image [prompt con tiempo y lugar, con un solo '@' solo si incluye persona], Clip 3 (00:14 - 00:22): Create a video [prompt técnico en inglés con tiempo, lugar sin '@', foley y sufijo de barrera sonora sin locución, cerrando con "fix the name"]... Image 4: Create an image [prompt con tiempo y lugar, con un solo '@' solo si incluye persona], Clip 4 (00:22 - 00:30): Create a video [prompt técnico en inglés con tiempo, lugar sin '@', foley y sufijo de barrera sonora sin locución, cerrando con "fix the name"]... indicando siempre tras la numeración "Create an image" en imágenes estáticas, y tras la numeración y el timestamp (##:## - ##:##) "Create a video" en clips de video, cada clip como 1 shot continuo de 8s, con todos los prompts técnicos redactados al 100% en idioma inglés, incluyendo tiempo y lugar manteniendo obligatoriamente como máximo un solo '@' exclusivo para personas, cerrando limpiamente cada clip con el sufijo de barrera sonora [...no text, no speech, no music. fix the name] excluyendo la voz narrativa hasta completar el bloque de 10 clips [Clips 1 al 10]).
[/?DURACION_CLIPS]
[/?SINCRONIZACION_CLIP_1]
[/?VOZ_NARRATIVA_EN_CLIPS]
-> ALTO INQUEBRANTABLE: La IA entrega el bloque de 10 clips y concluye su respuesta deteniéndose. Espera la confirmación del usuario para entregar el siguiente bloque (Clips 11 al 13 o restantes, el cual iniciará directamente con Image 11: Create an image [prompt], Clip 11 (01:36 - 01:46): Create a video [prompt], sin la orden operativa). Una vez completados y entregados todos los clips de video del proyecto, la IA pasará obligatoriamente a la Etapa 8 (Metadata para Subir el Video). NO generes la metadata de publicación en esta etapa.

ETAPA 8: METADATA PARA SUBIR EL VIDEO (ENTREGA POSTERIOR)
Una vez completada y confirmada la entrega de todos los clips de video de la Etapa 7, en una interacción posterior la IA generará la metadata de publicación en formato "Todo Corrido" y SIN encabezados de sección (cero "Título:", cero "Descripción:", cero "Comentario Fijado:"):
...
[/?TIPO_PRODUCCION]
[?SINCRONIZACION_CLIP_1=RALENTIZAR_CAPCUT]
Sincronización de Clip 1 y Comienzo de Voz: El primer clip sin voz narrativa se creará de [DURACION_CLIP_1] segundos pero en ediciones CapCut yo le bajaré la velocidad y lo llevaré a [DURACION_CLIP_1_RALENTIZADO] segundos (Clip 1 cubre 00:00 - 00:[DURACION_CLIP_1_PAD] ralentizado a [DURACION_CLIP_1_RALENTIZADO]s [00:00 - 00:[DURACION_CLIP_1_RALENTIZADO_PAD]], Clip 2 comienza en 00:[DURACION_CLIP_1_RALENTIZADO_PAD] y arranca directamente con la voz narrativa).
[/?SINCRONIZACION_CLIP_1]
[?SINCRONIZACION_CLIP_1=VOZ_EN_CLIP_2]
Sincronización de Clip 1 y Comienzo de Voz: El primer clip sin voz narrativa se creará de [DURACION_CLIP_1] segundos y la voz narrativa comenzará a partir de los primeros 2 segundos del segundo clip (Clip 1 cubre 00:00 - 00:[DURACION_CLIP_1_PAD], Clip 2 inicia en 00:[DURACION_CLIP_1_PAD] y la voz entra a los 2 segundos de haber iniciado el segundo clip).
[/?SINCRONIZACION_CLIP_1]
[?TEXTO_PANTALLA_CLIP_1=IA_CLIP_1]
Texto en Pantalla del Clip 1: El texto en pantalla del primer clip lo creará la IA dentro del Clip 1 (integrado directamente en el prompt de video de Clip 1 con tipografía cinematográfica; Imagen 1 con 'no text').
[/?TEXTO_PANTALLA_CLIP_1]
[?TEXTO_PANTALLA_CLIP_1=CAPCUT_MANUAL]
Texto en Pantalla del Clip 1: El texto en pantalla del primer clip lo insertaré en edición manual en CapCut (los prompts de Banana Pro y Omni Flash llevan estrictamente 'no text'; la IA proporciona las opciones de texto en la Etapa 6 para montaje manual).
[/?TEXTO_PANTALLA_CLIP_1]
[?DURACION_CLIPS=10_SEGUNDOS]
...
[/?TIPO_PRODUCCION]
[?TIPO_PRODUCCION=REELS][?TEXTO_PANTALLA_CLIP_1=CAPCUT_MANUAL]Texto en Pantalla y Diseño para Reproducción en Silencio (Primeros 6 Segundos - Edición Manual en CapCut): Alrededor del 70% de los usuarios ven los primeros segundos sin audio, por lo que subtítulos dinámicos y apoyo visual claro son obligatorios. Durante los primeros 6 segundos del video (Clip 1 de [DURACION_CLIP_1]s + primeros 2s de Clip 2, ventana que transcurre sin voz en off), se coloca un texto o letrero en pantalla para enganchar visualmente al espectador. Dicho texto debe estructurarse obligatoriamente incluyendo: Ciudad, País, Tiempo (años en dígitos o siglos en romanos) en la línea superior, y justo debajo la frase de Gancho intrigante o perturbadora. Dicho texto NO debe insertarse en los prompts de IA (los cuales llevan estrictamente 'no text'), sino que la IA debe acordar con el usuario la selección del texto en pantalla del Clip 1 previamente en la Etapa 6 (tras validar las imágenes de referencia y antes de los prompts de imágenes iniciales y clips de video), proponiendo de 2 a 3 opciones con esta estructura para ser colocado manualmente en CapCut durante el montaje. El resto del video permanece completamente limpio sin texto en pantalla.[/?TEXTO_PANTALLA_CLIP_1][?TEXTO_PANTALLA_CLIP_1=IA_CLIP_1]Texto en Pantalla y Diseño para Reproducción en Silencio (Primeros 6 Segundos - Generado por IA en Clip 1): Alrededor del 70% de los usuarios ven los primeros segundos sin audio, por lo que subtítulos dinámicos y apoyo visual claro son obligatorios. El texto en pantalla para los primeros 6 segundos se selecciona previamente con el usuario en la Etapa 6 (antes de los prompts de imágenes iniciales y clips) y va ÚNICA Y EXCLUSIVAMENTE en el prompt del Clip 1 de video ([DURACION_CLIP_1]s), generado directamente por la IA tipo comienzo de un documental cinematográfico con tipografía cinematográfica integrada (Ciudad, País, Tiempo en la primera línea y justo debajo el Gancho intrigante). Dicho texto NO debe ir en el prompt de la Imagen 1 (la cual lleva estrictamente 'no text'). En la edición posterior, el usuario baja la velocidad del Clip 1 y lo lleva a [DURACION_CLIP_1_RALENTIZADO] segundos de duración. Los clips restantes no llevan texto en pantalla.[/?TEXTO_PANTALLA_CLIP_1][/?TIPO_PRODUCCION][?TIPO_PRODUCCION=TIMELAPSE][?TEXTO_PANTALLA_CLIP_1=CAPCUT_MANUAL]Queda estrictamente prohibido incluir cualquier tipo de texto en pantalla para estos videos cortos; la imagen debe permanecer completamente limpia y visual.[/?TEXTO_PANTALLA_CLIP_1][?TEXTO_PANTALLA_CLIP_1=IA_CLIP_1]Texto en Pantalla en Timelapse (Generado por IA en Clip 1): El texto en pantalla para los primeros 6 segundos va exclusivamente en el prompt del Clip 1 de [DURACION_CLIP_1] segundos (tipo comienzo de un documental cinematográfico), NO en el prompt de la Imagen 1 (que lleva estrictamente 'no text'). Luego en edición el usuario baja la velocidad del Clip 1 y lo lleva a [DURACION_CLIP_1_RALENTIZADO] segundos. Los clips restantes permanecen completamente limpios y visuales.[/?TEXTO_PANTALLA_CLIP_1][/?TIPO_PRODUCCION][?TIPO_PRODUCCION=INMERSIVO_CONTEMPLATIVO][?TEXTO_PANTALLA_CLIP_1=CAPCUT_MANUAL]Texto en Pantalla (Edición Manual en CapCut): El texto en pantalla será exclusivo del Clip 1 e incluirá lugar, tiempo (año/siglo) y título que resuma con gancho de qué va el video. Este texto NO debe ser generado por herramientas de IA ni insertado en los prompts visuales (los prompts deben incluir estrictamente 'no text'). La IA debe especificar claramente en la ficha del Clip 1 qué texto colocar manualmente en CapCut durante la edición posterior. Los clips 2 y 3 no llevan texto en pantalla.[/?TEXTO_PANTALLA_CLIP_1][?TEXTO_PANTALLA_CLIP_1=IA_CLIP_1]Texto en Pantalla (Generado por IA en Clip 1): El texto en pantalla será exclusivo del Clip 1 e incluirá lugar, tiempo (año/siglo) y título que resuma con gancho de qué va el video, generado directamente por la IA en el prompt de video del Clip 1 ([DURACION_CLIP_1]s) tipo comienzo de documental cinematográfico. Dicho texto va ÚNICAMENTE en el prompt de video del Clip 1, NO en el prompt de la Imagen 1 (que lleva estrictamente 'no text'). En la edición posterior, el usuario baja la velocidad del Clip 1 para llevarlo a [DURACION_CLIP_1_RALENTIZADO] segundos de duración. Los clips 2 y 3 no llevan texto en pantalla.[/?TEXTO_PANTALLA_CLIP_1][/?TIPO_PRODUCCION]
[?TIPO_PRODUCCION=TIMELAPSE]
...
[?TEXTO_PANTALLA_CLIP_1=CAPCUT_MANUAL]
    ...
    4. Prompt de Movimiento de Video (con Audio Foley Integrado): En idioma inglés para 'omni flash' (comenzando obligatoriamente con la numeración, el timestamp y la orden en inglés: "Clip 1 (00:00 - 00:[DURACION_CLIP_1_PAD]): Create a video ", con diseño foley acústico integrado dentro del propio prompt, incluyendo obligatoriamente tiempo y lugar como referencia visual, y agregando obligatoriamente al final "fix the name").
...
[?TEXTO_PANTALLA_CLIP_1=IA_CLIP_1]
    ...
    4. Prompt de Movimiento de Video con Texto Integrado (con Audio Foley Integrado): En idioma inglés para 'omni flash' (comenzando obligatoriamente con la numeración, el timestamp y la orden en inglés: "Clip 1 (00:00 - 00:[DURACION_CLIP_1_PAD]): Create a video ", con diseño foley acústico integrado, tiempo y lugar como referencia visual, integrando el texto cinematográfico de apertura tipo comienzo de documental cinematográfico, y cerrando obligatoriamente con "fix the name"). En edición posterior se baja la velocidad a [DURACION_CLIP_1_RALENTIZADO] segundos.
    5. Texto en Pantalla (Generado por IA en Clip 1): Ciudad, País, Tiempo (año/siglo) y Título Gancho integrado en el prompt de video del Clip 1 (no en Imagen 1). Indicación de edición: bajar la velocidad de [DURACION_CLIP_1]s a [DURACION_CLIP_1_RALENTIZADO]s.
[/?TEXTO_PANTALLA_CLIP_1]
...
rename everything adding _ as the blank spaces between words
from 1 to 9 change them to 01 to 09
(Aclaración Fundamental: Las imágenes con '@' creadas previamente en la Etapa 5 son única y exclusivamente para referencia visual y NO para ser usadas como primer fotograma del video. La orden de usar "cada imagen como fotograma inicial" aplica exclusiva y estrictamente a las imágenes iniciales numeradas de esta etapa: Image 1 para Clip 1, Image 2 para Clip 2, etc.).
(Esta orden operativa NO se repite en el Bloque 2 ni en entregas posteriores). Seguida obligatoriamente de la secuencia de prompts en formato limpio y consecutivo: [?SINCRONIZACION_CLIP_1=VOZ_EN_CLIP_2]Image 1: Create an image [prompt], Clip 1 (00:00 - 00:[DURACION_CLIP_1_PAD]): Create a video [prompt de [DURACION_CLIP_1]s de duración cerrando con fix the name], Image 2: Create an image [prompt], [?DURACION_CLIPS=10_SEGUNDOS]Clip 2 (00:04 - 00:14): Create a video [prompt de 10s (1 shot de 10s) cerrando con fix the name], Image 3: Create an image [prompt], Clip 3 (00:14 - 00:24): Create a video [prompt de 10s (1 shot de 10s) cerrando con fix the name][/?DURACION_CLIPS][?DURACION_CLIPS=8_SEGUNDOS]Clip 2 (00:04 - 00:12): Create a video [prompt de 8s (1 shot de 8s) cerrando con fix the name], Image 3: Create an image [prompt], Clip 3 (00:12 - 00:20): Create a video [prompt de 8s (1 shot de 8s) cerrando con fix the name][/?DURACION_CLIPS], etc.[/?SINCRONIZACION_CLIP_1][?SINCRONIZACION_CLIP_1=RALENTIZAR_CAPCUT]Image 1: Create an image [prompt], Clip 1 (00:00 - 00:[DURACION_CLIP_1_PAD]): Create a video [prompt de [DURACION_CLIP_1]s[?TEXTO_PANTALLA_CLIP_1=IA_CLIP_1] con texto integrado[/?TEXTO_PANTALLA_CLIP_1] (bajar a [DURACION_CLIP_1_RALENTIZADO]s en edición) cerrando con fix the name], Image 2: Create an image [prompt], [?DURACION_CLIPS=10_SEGUNDOS]Clip 2 (00:06 - 00:16): Create a video [prompt de 10s (1 shot de 10s) comenzando con la voz narrativa en el segundo 6 cerrando con fix the name], Image 3: Create an image [prompt], Clip 3 (00:16 - 00:26): Create a video [prompt de 10s (1 shot de 10s) cerrando con fix the name][/?DURACION_CLIPS][?DURACION_CLIPS=8_SEGUNDOS]Clip 2 (00:06 - 00:14): Create a video [prompt de 8s (1 shot de 8s) comenzando con la voz narrativa en el segundo 6 cerrando con fix the name], Image 3: Create an image [prompt], Clip 3 (00:14 - 00:22): Create a video [prompt de 8s (1 shot de 8s) cerrando con fix the name][/?DURACION_CLIPS], etc.[/?SINCRONIZACION_CLIP_1] Prompt visual para generar la imagen inicial estática utilizando el modelo "banana pro" ([?SUB_OPCION_REELS=9X16]9:16[/?SUB_OPCION_REELS][?SUB_OPCION_REELS=16X9]16:9[/?SUB_OPCION_REELS] con 'no text', redactado al 100% en inglés, comenzando obligatoriamente tras la numeración con "Image [número]: Create an image [prompt]" o "Imagen [número]: Create an image [prompt]", incluyendo obligatoriamente tiempo y lugar como anclaje y referencia visual histórica con prefijo '@' en personas y lugares), y prompt técnico de movimiento con Foley integrado para generar el clip de video utilizando el modelo "omni flash" (redactado al 100% en inglés, comenzando obligatoriamente con la numeración, el intervalo de tiempo exacto que cubre cada clip en el timeline de CapCut en formato (##:## - ##:##) y la orden de acción obligatoria en inglés "Create a video": "Clip [número] (##:## - ##:##): Create a video [prompt técnico en inglés...]", incluyendo obligatoriamente tiempo y lugar de referencia visual histórica con prefijo '@' en personas y lugares, [?VOZ_NARRATIVA_EN_CLIPS=INCLUIR]cerrando tras el sufijo de barrera sonora en inglés, incluyendo al final de todo el prompt la porción correspondiente de la voz narrativa colocada directamente como una oración más sin comillas ("") ni paréntesis (()), y agregando obligatoriamente al final "fix the name", ej. [?SINCRONIZACION_CLIP_1=VOZ_EN_CLIP_2][?DURACION_CLIPS=10_SEGUNDOS]"Clip 2 (00:04 - 00:14): Create a video [prompt en inglés con tiempo, lugar con '@', foley y sufijo]. Año 1888, callejón de Whitechapel, Londres, Inglaterra. El laberinto donde operaba... fix the name"[/?DURACION_CLIPS][?DURACION_CLIPS=8_SEGUNDOS]"Clip 2 (00:04 - 00:12): Create a video [prompt en inglés con tiempo, lugar con '@', foley y sufijo]. Año 1888, callejón de Whitechapel, Londres, Inglaterra. El laberinto donde operaba... fix the name"[/?DURACION_CLIPS][/?SINCRONIZACION_CLIP_1][?SINCRONIZACION_CLIP_1=RALENTIZAR_CAPCUT][?DURACION_CLIPS=10_SEGUNDOS]"Clip 2 (00:06 - 00:16): Create a video [prompt en inglés con tiempo, lugar con '@', foley y sufijo]. Año 1888, callejón de Whitechapel, Londres, Inglaterra. El laberinto donde operaba... fix the name"[/?DURACION_CLIPS][?DURACION_CLIPS=8_SEGUNDOS]"Clip 2 (00:06 - 00:14): Create a video [prompt en inglés con tiempo, lugar con '@', foley y sufijo]. Año 1888, callejón de Whitechapel, Londres, Inglaterra. El laberinto donde operaba... fix the name"[/?DURACION_CLIPS][/?SINCRONIZACION_CLIP_1], quedando terminantemente prohibido omitir "Create an image" o "Create a video", incluir términos en español en los descriptores técnicos del prompt, omitir tiempo y lugar, encerrar la voz narrativa entre comillas o paréntesis, u omitir "fix the name" al final[/?VOZ_NARRATIVA_EN_CLIPS][?VOZ_NARRATIVA_EN_CLIPS=EXCLUIR]cerrando limpiamente tras el sufijo de barrera sonora en inglés (...no text, no speech, no music. fix the name), excluyendo terminantemente el texto de la voz narrativa de los prompts de video, ej. [?SINCRONIZACION_CLIP_1=VOZ_EN_CLIP_2][?DURACION_CLIPS=10_SEGUNDOS]"Clip 2 (00:04 - 00:14): Create a video [prompt en inglés con tiempo, lugar con '@', foley y sufijo]. fix the name"[/?DURACION_CLIPS][?DURACION_CLIPS=8_SEGUNDOS]"Clip 2 (00:04 - 00:12): Create a video [prompt en inglés con tiempo, lugar con '@', foley y sufijo]. fix the name"[/?DURACION_CLIPS][/?SINCRONIZACION_CLIP_1][?SINCRONIZACION_CLIP_1=RALENTIZAR_CAPCUT][?DURACION_CLIPS=10_SEGUNDOS]"Clip 2 (00:06 - 00:16): Create a video [prompt en inglés con tiempo, lugar con '@', foley y sufijo]. fix the name"[/?DURACION_CLIPS][?DURACION_CLIPS=8_SEGUNDOS]"Clip 2 (00:06 - 00:14): Create a video [prompt en inglés con tiempo, lugar con '@', foley y sufijo]. fix the name"[/?DURACION_CLIPS][/?SINCRONIZACION_CLIP_1], quedando terminantemente prohibido omitir "Create an image" o "Create a video", incluir términos en español en los descriptores técnicos del prompt, omitir tiempo y lugar, omitir "fix the name", o añadir texto de locución al final del clip[/?VOZ_NARRATIVA_EN_CLIPS]).
[?TEXTO_PANTALLA_CLIP_1=CAPCUT_MANUAL]
- Consulta y Selección Previa de Texto en Pantalla (Apertura del Video - Edición Manual en CapCut): Previamente en la Etapa 6 (tras validar las imágenes de referencia y antes de los prompts de imágenes iniciales y clips de video), la IA preguntará obligatoriamente al usuario qué texto colocar durante la apertura del video en el Clip 1, proponiéndole de 2 a 3 opciones de gancho visual estructuradas obligatoriamente en: Ciudad, País, Tiempo en la primera línea, y justo debajo la frase de Gancho intrigante, para ser aplicadas manualmente en CapCut (los prompts de Banana Pro y Omni Flash se mantienen estrictamente con 'no text').
[/?TEXTO_PANTALLA_CLIP_1]
[?TEXTO_PANTALLA_CLIP_1=IA_CLIP_1]
- Texto en Pantalla en la Apertura del Video Generado por IA en Clip 1 ([DURACION_CLIP_1]s a [DURACION_CLIP_1_RALENTIZADO]s en Edición): El texto en pantalla para la apertura del video se selecciona previamente con el usuario en la Etapa 6 y es generado directamente por la IA en el prompt técnico del Clip 1 de [DURACION_CLIP_1] segundos (tipo comienzo de un documental cinematográfico con Ciudad, País, Tiempo en la primera línea y justo debajo el Gancho intrigante). Dicho texto va ÚNICA Y EXCLUSIVAMENTE en el prompt del Clip 1, NO en el prompt de la Imagen 1 (la cual lleva estrictamente 'no text'). Recuerda al usuario la instrucción: "En edición, bajar la velocidad del Clip 1 de [DURACION_CLIP_1]s y llevarlo a [DURACION_CLIP_1_RALENTIZADO] segundos de duración".
[/?TEXTO_PANTALLA_CLIP_1]
[/?TIPO_PRODUCCION]

VOLUMEN V: INGENIERÍA DE PROMPTS Y GENERACIÓN VISUAL
Capítulo 12: Reglas de "Text para Flow" (Gestión del Prompter)
El operario o especialista en ingeniería de prompts encargado de alimentar el sistema de IA (Text para Flow) debe adherirse textual, estricta e incondicionalmente a las siguientes directrices de ejecución para salvaguardar la arquitectura del guion, la estabilidad de los servidores de generación y el orden del archivo [Instrucción de Usuario]:Cero Modificaciones: "No modifiques los prompts que te mando, mándalos así mismo y no les hagas cambios". La ingeniería semántica ya ha sido optimizada en la preproducción; la intervención del operario durante el copiado y pegado altera la matriz matemática de los descriptores.Nomenclatura Estricta de Archivos: "Cambia los nombres de los clips a las primeras 6 palabras literales del prompt proveído pegado y enviado que incluyen la numeración y los códigos de tiempo", "rename everything adding _ as the blank spaces between words" y "from 1 to 9 change them to 01 to 09". Esta regla es vital para la sincronización inversa del editor; permite ubicar el clip visual instantáneamente dentro del timeline del audio sin espacios conflictivos y con numeración correlativa estandarizada (01 a 09).Tolerancia a Fallos: "No reintentes clips que hayan fallado, espera a ver si se generan primero". Saturar el motor con reintentos simultáneos degrada la calidad de renderizado general del servidor.Generación por Lotes (Batches): "Genera los clips en batches de 10". El ecosistema de producción se maneja en bloques controlados para auditar la calidad progresiva.Refrigeración del Motor: "Espera 20 segundos entre cada batch". Esta pausa técnica previene la asfixia del sistema de generación y asegura tiempos de respuesta óptimos.Coherencia Visual Perenne: "Asegúrate de mantener continuidad visual a lo largo de la historia". Si un batch de 10 clips desvía drásticamente la paleta de colores, la materialidad o la arquitectura respecto al bloque anterior, el especialista debe reportar la anomalía para ajustar la semilla, en lugar de continuar ciegamente.
...
Inclusión Obligatoria de Tiempo y Lugar en Cada Prompt y Regla Estricta de '@' Exclusivo para Personas (Máximo un Solo '@' por Prompt): En CADA prompt de imagen estática (Banana Pro) y en CADA prompt de clip de video (Omni Flash), la IA tiene la obligación inquebrantable de incluir explícitamente el TIEMPO (año exacto en números/dígitos o época histórica precisa, ej: '1888', '1943', 'Victorian era', 'ancient Rome, 44 BC') y el LUGAR (ciudad, país, entorno geográfico o locación arquitectónica específica redactado estrictamente sin '@', ej: 'Whitechapel, London, England', 'Normandy, France', 'Kyoto, Japan'). Cuando se mencione a un personaje o figura histórica principal modelada previamente en la Etapa 5, se antepondrá obligatoriamente el prefijo '@' en dicho personaje (ej. '@Jack The Ripper in Whitechapel, London, England'). REGLA ESTRICTA DE '@' EXCLUSIVO PARA PERSONAS Y MÁXIMO UN SOLO '@' POR PROMPT: En las imágenes de referencia y en los prompts de imágenes y clips, los '@' son única y exclusivamente de personas; los lugares y objetos van siempre sin '@'. En los prompts de imágenes y clips solo habrá como máximo un '@' por cada uno. Queda terminantemente prohibido colocar más de un símbolo '@' dentro del mismo prompt, y queda terminantemente prohibido colocar '@' a lugares u objetos. Si la escena incluye al personaje, lleva '@' el personaje; si es un paisaje o arquitectura sin personaje, se redacta sin ningún '@'. Esta referencia visual histórica con un único '@' para personas es indispensable para que el motor generador configure con fidelidad documental la escena sin saturación de etiquetas.
...
[?VOZ_NARRATIVA_EN_CLIPS=INCLUIR]
Regla Inquebrantable: Inclusión de la Voz Narrativa al Final como una Oración Más (Sin Comillas ni Paréntesis): En cada prompt de clip de video entregado que tenga locución asignada (Clip 2 en adelante), la IA debe incluir la parte exacta de la voz narrativa que le corresponde según el intervalo de tiempo del timeline de CapCut (##:## - ##:##) compensando los +6 segundos. Dicho texto de locución DEBE COLOCARSE OBLIGATORIA Y ESTRICTAMENTE AL FINAL DE TODO EL PROMPT como una oración más, cerrando inmediatamente después del sufijo de barrera sonora en inglés (...no text, no speech, no music. [Texto de la locución]. fix the name). Queda TERMINANTEMENTE PROHIBIDO encerrar la voz narrativa entre comillas (""), ponerla entre paréntesis (()), o anteponer etiquetas burocráticas como '(Voz narrativa: ...)'. El texto del guion se añade limpiamente antes de "fix the name". Para clips sin locución (Clip 1 de 00:00 - 00:[DURACION_CLIP_1_PAD] con duración obligatoria de [DURACION_CLIP_1] segundos), el prompt concluye directamente con el sufijo de barrera sonora y "fix the name" sin oración de voz en off.
[/?VOZ_NARRATIVA_EN_CLIPS]
[?VOZ_NARRATIVA_EN_CLIPS=EXCLUIR]
Regla Estricta: Exclusión de la Voz Narrativa de los Prompts de Clips (Prompts Limpios): En cada prompt de clip de video entregado (Clip 1 en adelante), la IA DEBE EXCLUIR TOTALMENTE el texto de la voz narrativa o locución. El prompt concluye obligatoria y directamente con el sufijo de barrera sonora en inglés (...no text, no speech, no music. fix the name). Queda TERMINANTEMENTE PROHIBIDO anexar el texto del guion o voz en off al final de los prompts de video. La voz narrativa permanece exclusivamente en el guion de la Etapa 4 para locución y sincronización manual en el software de edición (CapCut).
[/?VOZ_NARRATIVA_EN_CLIPS]
[?SINCRONIZACION_CLIP_1=VOZ_EN_CLIP_2]
Compensación de Timestamps (+6s) en los Intervalos de los Clips (##:## - ##:##): La numeración de los intervalos de tiempo en el timeline de CapCut (##:## - ##:##) debe reflejar con exactitud la sincronización: [?DURACION_CLIPS=10_SEGUNDOS]Clip 1 cubre 00:00 - 00:[DURACION_CLIP_1_PAD] ([DURACION_CLIP_1]s de duración sin voz), Clip 2 cubre 00:04 - 00:14 (primeros 2s sin voz, segundo 6 donde entra la voz), Clip 3 cubre 00:14 - 00:24, etc.[/?DURACION_CLIPS][?DURACION_CLIPS=8_SEGUNDOS]Clip 1 cubre 00:00 - 00:[DURACION_CLIP_1_PAD] ([DURACION_CLIP_1]s de duración sin voz), Clip 2 cubre 00:04 - 00:12 (primeros 2s sin voz, segundo 6 donde entra la voz), Clip 3 cubre 00:12 - 00:20, etc.[/?DURACION_CLIPS]
[/?SINCRONIZACION_CLIP_1]
[?SINCRONIZACION_CLIP_1=RALENTIZAR_CAPCUT]
Compensación de Timestamps (+6s) en los Intervalos de los Clips (##:## - ##:##): La numeración de los intervalos de tiempo en el timeline de CapCut (##:## - ##:##) debe reflejar con exactitud la sincronización: [?DURACION_CLIPS=10_SEGUNDOS]Clip 1 cubre en el prompt 00:00 - 00:[DURACION_CLIP_1_PAD] ([DURACION_CLIP_1]s de duración sin voz, indicando bajar la velocidad en edición a [DURACION_CLIP_1_RALENTIZADO]s para cubrir 00:00 - 00:[DURACION_CLIP_1_RALENTIZADO_PAD]), Clip 2 cubre 00:06 - 00:16 (al haberse llevado Clip 1 a [DURACION_CLIP_1_RALENTIZADO]s en edición, el Clip 2 comienza directamente con la voz narrativa en el segundo 6 [00:06]), Clip 3 cubre 00:16 - 00:26, etc.[/?DURACION_CLIPS][?DURACION_CLIPS=8_SEGUNDOS]Clip 1 cubre en el prompt 00:00 - 00:[DURACION_CLIP_1_PAD] ([DURACION_CLIP_1]s de duración sin voz, indicando bajar la velocidad en edición a [DURACION_CLIP_1_RALENTIZADO]s para cubrir 00:00 - 00:[DURACION_CLIP_1_RALENTIZADO_PAD]), Clip 2 cubre 00:06 - 00:14 (al haberse llevado Clip 1 a [DURACION_CLIP_1_RALENTIZADO]s en edición, el Clip 2 comienza directamente con la voz narrativa en el segundo 6 [00:06]), Clip 3 cubre 00:14 - 00:22, etc.[/?DURACION_CLIPS]
[/?SINCRONIZACION_CLIP_1]
...
- Orden Operativa en una Sola Oración para Prompts de Referencia (Etapa 5): Al inicio obligatorio de la entrega de los prompts de imágenes modelo de referencia de personas, lugares y objetos, la IA debe colocar obligatoriamente como preámbulo inicial en una sola oración la siguiente instrucción textual:
  Cambia los nombres y ponles @ seguido del nombre de la persona correspondiente.
- Regla Estricta: Los '@' en las Imágenes de Referencia son Solo de Personas y Máximo un Solo '@' por Prompt (Etapa 5 y Etapa 7): Los '@' en las imágenes de referencia son ÚNICA Y EXCLUSIVAMENTE DE PERSONAS. Queda terminantemente prohibido colocar el símbolo '@' en nombres de lugares u objetos en las imágenes de referencia (los lugares y objetos se crean y nombran estrictamente sin '@'). Asimismo, tanto en los prompts de imágenes modelo de referencia de personas (Etapa 5) como en los prompts de imágenes iniciales y clips de video (Etapa 7), SOLO HABRÁ COMO MÁXIMO UN ÚNICO SÍMBOLO '@' POR CADA PROMPT, correspondiente exclusivamente al personaje principal (ej. '@Jack The Ripper in Whitechapel, London, England'). Si una escena o clip no incluye personajes con '@', el lugar y tiempo se redactan limpiamente sin ningún '@' (ej. 'in Whitechapel, London, England, 1888...'). En los prompts de imágenes y clips, solo habrá un '@' por cada uno y será únicamente de personas.
- Regla Inquebrantable: Imágenes de Referencia Exclusivas para Referencia Visual (Prohibido Usarlas como Primer Fotograma del Video): Las imágenes generadas en la Etapa 5 (modelos de personas con '@' [@Personas] y modelos de lugares y objetos sin '@') son ÚNICA Y EXCLUSIVAMENTE para referencia visual en la herramienta de IA (actúan como activos de referencia / asset references para mantener consistencia fisonómica, arquitectónica y de objetos). Queda TERMINANTEMENTE PROHIBIDO utilizar estas imágenes de referencia como primer fotograma (fotograma inicial) de ningún clip de video. El primer fotograma de cada clip de video se genera obligatoria y exclusivamente en la Etapa 7 con su prompt numerado correspondiente (Image 1 para Clip 1, Image 2 para Clip 2, etc.).
- Orden Operativa Exclusiva al Inicio del Primer Envío de Prompts: Al inicio obligatorio del primer envío de prompts de imágenes y videos (Bloque 1 si se eligió de 10 en 10, o al inicio de la entrega si se eligió todos juntos), la IA debe colocar obligatoriamente como preámbulo inicial la siguiente orden operativa textual (quedando estrictamente prohibido repetirla en bloques posteriores si se entrega de 10 en 10):
  ...
  rename everything adding _ as the blank spaces between words
  from 1 to 9 change them to 01 to 09
  (Aclaración Fundamental: Las imágenes de referencia creadas previamente en la Etapa 5 [las personas creadas con '@' y los lugares u objetos sin '@'] son única y exclusivamente para referencia visual y NO para ser usadas como primer fotograma del video. La orden de usar "cada imagen como fotograma inicial" aplica estricta y únicamente a las imágenes iniciales numeradas de esta etapa: Image 1 para Clip 1, Image 2 para Clip 2, etc.).
- Prompts de Imagen Inicial con "Create an image", Tiempo, Lugar y Regla de un Solo '@' Exclusivo para Personas: Todo prompt para generar la imagen fija inicial debe estar redactado al 100% en idioma inglés, comenzando obligatoriamente tras la numeración con la frase: "Image [número]: Create an image " (o "Imagen [número]: Create an image "), e incluir obligatoriamente el TIEMPO y LUGAR como anclaje histórico visual. Si aparece un personaje principal modelado en la Etapa 5, se incluye con '@' (ej. '@Jack The Ripper in Whitechapel, London, England, 1888...'), y si no hay personaje, el lugar y tiempo van sin '@' (ej. 'in Whitechapel, London, England, 1888...'), manteniendo estrictamente que los '@' sean solo de personas y como máximo un único '@' en todo el prompt.
[?VOZ_NARRATIVA_EN_CLIPS=INCLUIR]
- Prompts de Clips de Video con Intervalo Temporal (##:## - ##:##), "Create a video", Tiempo, Lugar, un Solo '@' para Personas, Voz Narrativa y "fix the name" al Final: Todo prompt técnico de movimiento para generar el video con Foley integrado debe estar redactado al 100% en idioma inglés para los comandos y la descripción técnica cinematográfica, comenzando obligatoriamente indicando la numeración, el intervalo de tiempo exacto que cubre cada clip en el timeline de CapCut en formato (##:## - ##:##) y la orden de acción literal en inglés "Create a video ": ("Clip [número] (##:## - ##:##): Create a video [prompt técnico en inglés...]"), incluir obligatoriamente dentro de la descripción técnica en inglés el TIEMPO y LUGAR como referencia visual histórica manteniendo estrictamente que los '@' sean solo de personas y como máximo un solo '@' por cada prompt (en los prompts de imágenes y clips, solo habrá un '@' por cada uno y solo para personas, ej. '@Jack The Ripper in Whitechapel, London, England, 1888...' o 'in Whitechapel, London, England, 1888...'), cerrar la descripción con el sufijo obligatorio de barrera sonora (...no text, no speech, no music.), colocar la porción correspondiente de la voz narrativa como una oración más sin comillas ("") ni paréntesis (()), y agregar obligatoriamente al final "fix the name". Queda estrictamente prohibido omitir la orden "Create a video", incluir términos en español en la orden o descripción técnica del video, colocar '@' a lugares u objetos, colocar múltiples '@', encerrar la voz narrativa entre comillas o paréntesis, u omitir "fix the name" al final. (Ejemplos: [?SINCRONIZACION_CLIP_1=VOZ_EN_CLIP_2][?DURACION_CLIPS=10_SEGUNDOS]"Clip 1 (00:00 - 00:[DURACION_CLIP_1_PAD]): Create a video [prompt técnico en inglés de [DURACION_CLIP_1]s de duración con tiempo, lugar sin '@', foley, sufijo y fix the name]", "Clip 2 (00:04 - 00:14): Create a video [prompt técnico en inglés con tiempo, lugar, un solo '@' para persona si aplica, foley y sufijo]. Año 1888, callejón de Whitechapel, Londres, Inglaterra. El laberinto donde operaba... fix the name"[/?DURACION_CLIPS][?DURACION_CLIPS=8_SEGUNDOS]"Clip 1 (00:00 - 00:[DURACION_CLIP_1_PAD]): Create a video [prompt técnico en inglés de [DURACION_CLIP_1]s de duración con tiempo, lugar sin '@', foley, sufijo y fix the name]", "Clip 2 (00:04 - 00:12): Create a video [prompt técnico en inglés con tiempo, lugar, un solo '@' para persona si aplica, foley y sufijo]. Año 1888, callejón de Whitechapel, Londres, Inglaterra. El laberinto donde operaba... fix the name"[/?DURACION_CLIPS][/?SINCRONIZACION_CLIP_1][?SINCRONIZACION_CLIP_1=RALENTIZAR_CAPCUT][?DURACION_CLIPS=10_SEGUNDOS]"Clip 1 (00:00 - 00:[DURACION_CLIP_1_PAD]): Create a video [prompt técnico en inglés de [DURACION_CLIP_1]s[?TEXTO_PANTALLA_CLIP_1=IA_CLIP_1] con texto cinematográfico[/?TEXTO_PANTALLA_CLIP_1], foley, sufijo (en edición bajar a [DURACION_CLIP_1_RALENTIZADO]s) y fix the name]", "Clip 2 (00:06 - 00:16): Create a video [prompt técnico en inglés con tiempo, lugar, un solo '@' para persona si aplica, foley y sufijo]. Año 1888, callejón de Whitechapel, Londres, Inglaterra. El laberinto donde operaba... fix the name"[/?DURACION_CLIPS][?DURACION_CLIPS=8_SEGUNDOS]"Clip 1 (00:00 - 00:[DURACION_CLIP_1_PAD]): Create a video [prompt técnico en inglés de [DURACION_CLIP_1]s[?TEXTO_PANTALLA_CLIP_1=IA_CLIP_1] con texto cinematográfico[/?TEXTO_PANTALLA_CLIP_1], foley, sufijo (en edición bajar a [DURACION_CLIP_1_RALENTIZADO]s) y fix the name]", "Clip 2 (00:06 - 00:14): Create a video [prompt técnico en inglés con tiempo, lugar, un solo '@' para persona si aplica, foley y sufijo]. Año 1888, callejón de Whitechapel, Londres, Inglaterra. El laberinto donde operaba... fix the name"[/?DURACION_CLIPS][/?SINCRONIZACION_CLIP_1], etc.).
[/?VOZ_NARRATIVA_EN_CLIPS]
[?VOZ_NARRATIVA_EN_CLIPS=EXCLUIR]
- Prompts de Clips de Video con Intervalo Temporal (##:## - ##:##), "Create a video", Tiempo, Lugar, un Solo '@' para Personas, Exclusión de Voz y "fix the name" al Final (Prompts Limpios): Todo prompt técnico de movimiento para generar el video con Foley integrado debe estar redactado al 100% en idioma inglés para los comandos y la descripción técnica cinematográfica, comenzando obligatoriamente indicando la numeración, el intervalo de tiempo exacto que cubre cada clip en el timeline de CapCut en formato (##:## - ##:##) y la orden de acción literal en inglés "Create a video ": ("Clip [número] (##:## - ##:##): Create a video [prompt técnico en inglés...]"), incluir obligatoriamente dentro de la descripción técnica en inglés el TIEMPO y LUGAR como referencia visual histórica manteniendo estrictamente que los '@' sean solo de personas y como máximo un solo '@' por cada prompt (en los prompts de imágenes y clips, solo habrá un '@' por cada uno y solo para personas, ej. '@Jack The Ripper in Whitechapel, London, England, 1888...' o 'in Whitechapel, London, England, 1888...'), y cerrar la descripción estrictamente con el sufijo obligatorio de barrera sonora y la directiva al final (...no text, no speech, no music. fix the name), excluyendo terminantemente cualquier texto de locución o voz narrativa al final del prompt. Queda estrictamente prohibido omitir la orden "Create a video", incluir términos en español en la orden o descripción técnica del video, colocar '@' a lugares u objetos, colocar múltiples '@', omitir "fix the name" al final, o agregar texto de voz en off al final del clip. (Ejemplos: [?SINCRONIZACION_CLIP_1=VOZ_EN_CLIP_2][?DURACION_CLIPS=10_SEGUNDOS]"Clip 1 (00:00 - 00:[DURACION_CLIP_1_PAD]): Create a video [prompt técnico en inglés de [DURACION_CLIP_1]s de duración con tiempo, lugar sin '@', foley, sufijo y fix the name]", "Clip 2 (00:04 - 00:14): Create a video [prompt técnico en inglés con tiempo, lugar, un solo '@' para persona si aplica, foley y sufijo y fix the name]"[/?DURACION_CLIPS][?DURACION_CLIPS=8_SEGUNDOS]"Clip 1 (00:00 - 00:[DURACION_CLIP_1_PAD]): Create a video [prompt técnico en inglés de [DURACION_CLIP_1]s de duración con tiempo, lugar sin '@', foley, sufijo y fix the name]", "Clip 2 (00:04 - 00:12): Create a video [prompt técnico en inglés con tiempo, lugar, un solo '@' para persona si aplica, foley y sufijo y fix the name]"[/?DURACION_CLIPS][/?SINCRONIZACION_CLIP_1][?SINCRONIZACION_CLIP_1=RALENTIZAR_CAPCUT][?DURACION_CLIPS=10_SEGUNDOS]"Clip 1 (00:00 - 00:[DURACION_CLIP_1_PAD]): Create a video [prompt técnico en inglés de [DURACION_CLIP_1]s[?TEXTO_PANTALLA_CLIP_1=IA_CLIP_1] con texto cinematográfico[/?TEXTO_PANTALLA_CLIP_1], foley, sufijo (en edición bajar a [DURACION_CLIP_1_RALENTIZADO]s) y fix the name]", "Clip 2 (00:06 - 00:16): Create a video [prompt técnico en inglés con tiempo, lugar, un solo '@' para persona si aplica, foley y sufijo]. fix the name"[/?DURACION_CLIPS][?DURACION_CLIPS=8_SEGUNDOS]"Clip 1 (00:00 - 00:[DURACION_CLIP_1_PAD]): Create a video [prompt técnico en inglés de [DURACION_CLIP_1]s[?TEXTO_PANTALLA_CLIP_1=IA_CLIP_1] con texto cinematográfico[/?TEXTO_PANTALLA_CLIP_1], foley, sufijo (en edición bajar a [DURACION_CLIP_1_RALENTIZADO]s) y fix the name]", "Clip 2 (00:06 - 00:14): Create a video [prompt técnico en inglés con tiempo, lugar, un solo '@' para persona si aplica, foley y sufijo]. fix the name"[/?DURACION_CLIPS][/?SINCRONIZACION_CLIP_1], etc.).
[/?VOZ_NARRATIVA_EN_CLIPS]
...
[?TEXTO_PANTALLA_CLIP_1=CAPCUT_MANUAL]
- Regla de Texto en Pantalla en Prompts (Edición Manual en CapCut): Todos los prompts de imagen y video se mantienen estrictamente con la directriz 'no text'. El texto de apertura se selecciona previamente con el usuario en la Etapa 6 y se coloca manualmente en edición en CapCut durante el montaje.
[/?TEXTO_PANTALLA_CLIP_1]
[?TEXTO_PANTALLA_CLIP_1=IA_CLIP_1]
- Regla de Texto en Pantalla en Prompts (Generado por IA en Clip 1): El texto en pantalla para la apertura se selecciona previamente con el usuario en la Etapa 6 y va ÚNICA Y EXCLUSIVAMENTE en el prompt de video del Clip 1 de [DURACION_CLIP_1] segundos, generado directamente por la IA tipo comienzo de un documental cinematográfico (Ciudad, País, Tiempo en la primera línea y justo debajo el Gancho intrigante con tipografía cinematográfica integrada). Queda TERMINANTEMENTE PROHIBIDO incluir el texto en el prompt de la Imagen 1 (la Imagen 1 lleva estrictamente 'no text'). Asimismo, la IA debe incluir la indicación operativa: "En edición, bajar la velocidad del Clip 1 de [DURACION_CLIP_1]s para llevarlo a [DURACION_CLIP_1_RALENTIZADO] segundos de duración". Los prompts de video restantes van limpios sin texto en pantalla.
[/?TEXTO_PANTALLA_CLIP_1]
...
La publicación del episodio requiere una estrategia algorítmica tan precisa como su creación visual, orientada a dominar el CTR (Click-Through Rate) y la retención profunda.1. Dirección de Arte para Miniaturas, Regla del Logo "8K" en Dorado al 5% y Logo Oficial de la Página:
...
Regla Inquebrantable del Logo "8K" en Dorado al 5% (Generado Directamente por IA) y Logo Oficial de la Página como Imagen de Referencia: Todas las miniaturas llevarán obligatoriamente en la parte superior derecha un logo pequeño al 5% que diga 8K en dorado (metallic gold) creado directamente por la inteligencia artificial, y mantendrán además el logo oficial de la página proporcionado como imagen de referencia, especificados ambos directamente en el prompt de la miniatura. En el prompt técnico en inglés para Banana Pro ([?SUB_OPCION_REELS=9X16]vertical 9:16[/?SUB_OPCION_REELS][?SUB_OPCION_REELS=16X9]horizontal 16:9[/?SUB_OPCION_REELS]), la IA debe incluir de forma explícita y obligatoria: 1) 'a small discreet 5% scale logo in the top right corner displaying "8K" in metallic gold' (o 'small 5% size metallic gold 8K logo in the upper right corner') creado de forma nativa por el motor de IA; y 2) 'official page logo cleanly integrated from provided reference image' manteniendo el logo oficial de la página provisto como referencia visual. Queda terminantemente prohibido omitir estas especificaciones técnicas en el prompt de la miniatura.
Formato del Prompt de la Miniatura: Al generar o solicitar el prompt de la miniatura, se redactará al 100% en inglés iniciando con 'Thumbnail: Create an image [descripción visual de alto impacto cinematográfico, sujeto, atmósfera, tiempo y lugar, contradicción visual, composición segura para móviles, texto conciso de 1 a 3 palabras si aplica, y obligatoriamente: a small discreet 5% scale logo in the top right corner displaying "8K" in metallic gold, official page logo cleanly integrated from provided reference image, cinematic documentary realism, safe framing composition, no CGI look, no modern objects]'.
...
const PromptGenerator = () => {
  ...
  useEffect(() => {
    const key = 'huellas_master_template_v130';
  ...
  const { conditionals, radioGroups } = useMemo(() => {
    ...
    const groupKeys = Object.keys(groups).sort((a, b) => {
      ...
      if (a === 'SINCRONIZACION_CLIP_1') return -1;
      if (b === 'SINCRONIZACION_CLIP_1') return 1;
      if (a === 'TEXTO_PANTALLA_CLIP_1') return -1;
      if (b === 'TEXTO_PANTALLA_CLIP_1') return 1;
    ...
    groupKeys.forEach(k => {
      ...
      } else if (k === 'SINCRONIZACION_CLIP_1') {
        const order = ['RALENTIZAR_CAPCUT', 'VOZ_EN_CLIP_2'];
        arr.sort((a, b) => {
          const idxA = order.indexOf(a);
          const idxB = order.indexOf(b);
          return (idxA === -1 ? 99 : idxA) - (idxB === -1 ? 99 : idxB);
        });
      } else if (k === 'TEXTO_PANTALLA_CLIP_1') {
  ...
  useEffect(() => {
    setFormData(prev => {
      ...
      const newData = { ...prev };
      if (!newData.DURACION_CLIP_1) {
        newData.DURACION_CLIP_1 = '4';
      }
  ...
  const visibleVariables = useMemo(() => {
    ...
    while ((match = varRegex.exec(activeText)) !== null) {
      if (
        match[1].trim() !== '' && 
        match[1] !== 'DURACION_CLIP_1' && 
        match[1] !== 'DURACION_CLIP_1_PAD' &&
        match[1] !== 'DURACION_CLIP_1_RALENTIZADO' &&
        match[1] !== 'DURACION_CLIP_1_RALENTIZADO_PAD'
      ) {
        vars.add(match[1]);
      }
    }
  ...
  const compileTemplate = () => {
    ...
    // Garantizar que la duración del primer clip y su ralentizado se reflejen en la plantilla
    const duracionNum = parseInt(formData.DURACION_CLIP_1 || '4', 10) || 4;
    const duracionVal = String(duracionNum);
    const duracionPad = String(duracionVal).padStart(2, '0');
    const duracionRalentizada = duracionNum + 2;
    const duracionRalentizadaVal = String(duracionRalentizada);
    const duracionRalentizadaPad = String(duracionRalentizadaVal).padStart(2, '0');

    compiled = compiled.replace(/\[DURACION_CLIP_1\]/g, duracionVal);
    compiled = compiled.replace(/\[DURACION_CLIP_1_PAD\]/g, duracionPad);
    compiled = compiled.replace(/\[DURACION_CLIP_1_RALENTIZADO\]/g, duracionRalentizadaVal);
    compiled = compiled.replace(/\[DURACION_CLIP_1_RALENTIZADO_PAD\]/g, duracionRalentizadaPad);
    compiled = compiled.replace(/(Sincronización de Clip 1 y Comienzo de Voz: El primer clip sin voz narrativa se creará de )\d+( segundos)/g, `$1${duracionVal}$2`);
              ...
              <div style={{ marginBottom: '2rem', padding: '1rem', backgroundColor: 'rgba(197, 160, 89, 0.1)', border: '1px solid var(--border-color)' }}>
                ...
                {Object.keys(radioGroups).map(group => {
                  ...
                  const groupTitle = group === 'TIPO_PRODUCCION' ? 'Tipo de Producción' :
                                     ...
                                     group === 'SINCRONIZACION_CLIP_1' ? 'Sincronización de Clip 1 y Comienzo de Voz Narrativa' :
                                     group === 'TEXTO_PANTALLA_CLIP_1' ? 'Texto en Pantalla del Primer Clip (Clip 1)' :
                  ...
                  const duracionNum = parseInt(formData.DURACION_CLIP_1 || '4', 10) || 4;
                  const duracionSecsText = `${duracionNum} segundo${duracionNum === 1 ? '' : 's'}`;
                  const duracionRalentizada = duracionNum + 2;
                  const duracionRalentizadaText = `${duracionRalentizada} segundo${duracionRalentizada === 1 ? '' : 's'}`;

                  return (
                    <div className="form-group" key={group} style={{ marginBottom: '1.25rem' }}>
                      <label style={{ fontWeight: 'bold' }}>{groupTitle}</label>

                      {group === 'SINCRONIZACION_CLIP_1' && (
                        <div style={{
                          marginTop: '0.75rem',
                          marginBottom: '1rem',
                          ...
                          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', flexWrap: 'wrap' }}>
                            <button
                              type="button"
                              onClick={() => {
                                const current = parseInt(formData.DURACION_CLIP_1 || '4', 10) || 4;
                                if (current > 1) {
                            ...
                            <input
                              ...
                              min="1"
                              max="60"
                              value={formData.DURACION_CLIP_1 !== undefined ? formData.DURACION_CLIP_1 : '4'}
                              onChange={(e) => {
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', marginTop: '0.5rem' }}>
                        {radioGroups[group].map(val => {
                          const isChecked = formData[group] === val;

                          let labelText = val.replace(/_/g, ' ');
                          if (val === 'REELS') labelText = 'Reels';
                          else if (val === '9X16') labelText = '9:16 (Vertical)';
                          else if (val === '16X9') labelText = '16:9 (Horizontal)';
                          else if (val === 'INMERSIVO_CONTEMPLATIVO') labelText = 'Inmersivo Contemplativo';
                          else if (val === 'TIMELAPSE') labelText = 'Timelapse';
                          else if (val === 'TODO_INCLUIDO') labelText = 'Todo Incluido';
                          else if (val === 'RALENTIZAR_CAPCUT') {
                            labelText = `El primer clip sin voz narrativa se creará de ${duracionSecsText} pero en ediciones CapCut yo le bajaré la velocidad y lo llevaré a ${duracionRalentizadaText}`;
                          } else if (val === 'VOZ_EN_CLIP_2') {
                            labelText = `El primer clip sin voz narrativa se creará de ${duracionSecsText} y la voz narrativa comenzará a partir de los primeros 2 segundos del segundo clip`;
                          } else if (val === 'IA_CLIP_1') {
                            labelText = 'El texto en pantalla del primer clip lo creará la IA dentro del Clip 1';
                          } else if (val === 'CAPCUT_MANUAL') {
                            labelText = 'El texto en pantalla del primer clip lo insertaré en edición manual en CapCut';
                          } else if (val === '10_SEGUNDOS') labelText = '10 segundos (1 shot de 10s)';
                          else if (val === '8_SEGUNDOS') labelText = '8 segundos (1 shot de 8s)';
                          else if (val === 'INCLUIR') labelText = 'Incluir texto de la voz narrativa al final de los prompts de los clips (como una oración más sin comillas ni paréntesis)';
                          else if (val === 'EXCLUIR') labelText = 'Excluir texto de la voz narrativa de los prompts de los clips (prompts limpios cerrando solo con el sufijo "no text, no speech, no music")';
                          ...
                          return (
                            <label 
                              ...
                              style={{ 
                                ...
                                gap: '0.5rem', 
                                cursor: 'pointer',
                                padding: isChecked && (group === 'SINCRONIZACION_CLIP_1' || group === 'TEXTO_PANTALLA_CLIP_1') ? '0.4rem 0.6rem' : '0.2rem 0',
                                borderRadius: '4px',
                                backgroundColor: isChecked && (group === 'SINCRONIZACION_CLIP_1' || group === 'TEXTO_PANTALLA_CLIP_1') ? 'rgba(197, 160, 89, 0.15)' : 'transparent',
                                border: isChecked && (group === 'SINCRONIZACION_CLIP_1' || group === 'TEXTO_PANTALLA_CLIP_1') ? '1px solid rgba(197, 160, 89, 0.4)' : '1px solid transparent',
