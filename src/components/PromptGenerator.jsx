...
No comiences a escribir hasta que el usuario te indique ambas elecciones.
[/?TIPO_PRODUCCION]
...
- Promesa Narrativa y Slogan Completo en Párrafo Aparte Antes del Segundo 30 de Video (~segundos 20–30): Antes del segundo 30 de video (~segundos 20–30 de metraje), la voz narrativa debe articular obligatoriamente la Promesa Narrativa y el Slogan Completo, estructurados de forma estricta de la siguiente manera:
  1. Comienza obligatoria y literalmente con la frase: "En los próximos minutos..."
  2. Justo entre "En los próximos minutos..." y el slogan, va obligatoriamente la EXPLICACIÓN BREVE de lo que estará pasando en el documental (el enigma histórico, el conflicto, la tensión o los hechos que el espectador descubrirá si se queda hasta el final; ej. "En los próximos minutos descubrirás cómo una sola decisión militar selló el destino de todo un imperio...", "En los próximos minutos revelaremos el enigma que la policía victoriana jamás pudo resolver...").
  3. Inmediatamente después de dicha explicación breve, el slogan completo oficial DEBE COLOCARSE OBLIGATORIAMENTE SEPARADO EN UN PÁRRAFO APARTE dentro del guion de locución: "Si quieres seguir cruzando el umbral del tiempo para vivir la historia desde dentro, dale like a este video, compártelo y suscríbete. Cada historia deja una huella. Aquí seguimos sus rastros."
  (Estructura obligatoria en el guion de voz en off:
  [Párrafo inicial con hook y contexto]: "... En los próximos minutos [explicación breve de lo que estará pasando en el documental]."

  [Párrafo aparte exclusivo para el slogan completo]: "Si quieres seguir cruzando el umbral del tiempo para vivir la historia desde dentro, dale like a este video, compártelo y suscríbete. Cada historia deja una huella. Aquí seguimos sus rastros."

  [Párrafo siguiente donde continúa la historia principal]).
...
Promesa Narrativa y Slogan Completo en Párrafo Aparte (Antes del segundo 30 de video / "En los próximos minutos [explicación breve de lo que estará pasando en el documental]" + Slogan Completo en Párrafo Aparte): [PROMESA_NARRATIVA]
...
[?TIPO_PRODUCCION=TIMELAPSE]
Capítulo 2: La Promesa Narrativa antes del Segundo 30 con el Slogan Completo en Párrafo Aparte, el Slogan Corto al Final y los Micro-Ganchos cada 90 Segundos
Todo episodio que aspire a construir una audiencia leal requiere una promesa clara y transparente. Esta debe aparecer obligatoriamente antes del segundo 30 de video (~segundos 20–30) de cada episodio, comenzando obligatoria y estrictamente con la frase: "En los próximos minutos...". Justo entre "En los próximos minutos..." y el slogan, la voz narrativa debe insertar una explicación breve de lo que estará pasando en el documental (el enigma histórico, la contradicción central o los hechos cruciales que se develarán), articulando inmediatamente a continuación el slogan completo oficial ubicado obligatoriamente en un párrafo aparte: "Si quieres seguir cruzando el umbral del tiempo para vivir la historia desde dentro, dale like a este video, compártelo y suscríbete. Cada historia deja una huella. Aquí seguimos sus rastros." (Fórmula unificada en el guion de locución: tras "En los próximos minutos [explicación breve de lo que estará pasando en el documental].", se inserta en un párrafo aparte exclusivo el slogan completo: "Si quieres seguir cruzando el umbral del tiempo para vivir la historia desde dentro, dale like a este video, compártelo y suscríbete. Cada historia deja una huella. Aquí seguimos sus rastros."). No es un simple truco de marketing; es un contrato donde le aseguramos al espectador que no recibirá una clase de historia tradicional. Debe dejar claro de qué trata el episodio, qué enigma histórico, tensión social o perspectiva inédita descubrirá si se queda hasta el final, prometiéndole habitar el pasado desde adentro. Al concluir el episodio, la locución cierra obligatoriamente con el slogan corto ("Cada historia deja una huella. Aquí seguimos sus rastros.") ubicado obligatoriamente separado en un párrafo aparte.
...
const PromptGenerator = () => {
  ...
  useEffect(() => {
    const key = 'huellas_master_template_v106';
