...
- Formato Estricto de los Prompts (Orden Operativa EXCLUSIVA en el Primer Bloque):
  ...
  Clip 2 (00:06 - 00:16): [prompt técnico en inglés para Omni Flash de 10s de duración (1 shot de 10s o 2 shots de 5s+5s según dinamismo, con Foley integrado; la locución arranca exactamente en el segundo 00:06 de video comenzando obligatoriamente por TIEMPO, LUGAR, CIUDAD Y PAÍS, y DESCRIPCIÓN BREVE del tema/suceso/personaje), cerrando con: strictly no music, no speech, cinematic documentary realism, safe framing composition, no modern objects, no CGI look, no text, no speech, no music.] (Voz narrativa: "[Fragmento exacto del guion de locución correspondiente a los primeros 10s de voz (00:00 - 00:10 de tu app de audio), ej. '1888, en el callejón de Whitechapel, Londres, Inglaterra...']")

  (Continuar consecutivamente con Imagen 3: prompt, Clip 3 (00:16 - 00:26): prompt (Voz narrativa: "[bloque 00:10 - 00:20 de voz]")... Imagen 4: prompt, Clip 4 (00:26 - 00:36): prompt (Voz narrativa: "[bloque 00:20 - 00:30 de voz]")... indicando siempre en cada clip de video el tiempo de CapCut en formato (##:## - ##:##) y la porción de la voz narrativa que le corresponde hasta completar el bloque de 10 clips [Clips 1 al 10]).
...
Inclusión Obligatoria de la Voz Narrativa Correspondiente en Cada Clip de Video y Compensación de +6s: En cada prompt de clip de video entregado, la IA debe incluir obligatoriamente la parte exacta de la voz narrativa (locución del guion) que le corresponde según el intervalo de tiempo del timeline de CapCut que cubre dicho clip (##:## - ##:##). Dado que el software de audio y transcripción arranca desde 00:00 y en edición la voz se posiciona en el segundo 00:06 del timeline, la IA compensa automáticamente +6 segundos (el bloque de voz 00:00 - 00:10 corresponde a Clip 2 de 00:06 - 00:16, etc.). Esto garantiza una sincronización inversa milimétrica entre el relato auditivo y la acción cinematográfica visual para el editor y los generadores de video. Debe estructurarse al final del prompt en formato: (Voz narrativa: "[texto exacto de la locución que cubre este clip]"). Para clips sin locución (Clip 1 de 00:00 a 00:06), debe indicarse explícitamente: (Voz narrativa: Sin voz en off / Hook de puro Foley).
...
- Prompts de Clips de Video con Intervalo Temporal (##:## - ##:##) y Voz Narrativa Correspondiente: Todo prompt técnico de movimiento para generar el video con Foley integrado debe comenzar obligatoriamente indicando la numeración y el intervalo de tiempo exacto que cubre cada clip en el timeline de CapCut en formato (##:## - ##:##) seguido de dos puntos ("Clip [número] (##:## - ##:##): [prompt]") y finalizar obligatoriamente incluyendo la porción de la voz narrativa que le corresponde entre paréntesis en formato (Voz narrativa: "[texto del guion]") (o "(Voz narrativa: Sin voz en off / Hook de puro Foley)" para clips sin locución, como Clip 1). (Ejemplos: "Clip 1 (00:00 - 00:06): [prompt...] (Voz narrativa: Sin voz en off / Hook de puro Foley)", "Clip 2 (00:06 - 00:16): [prompt...] (Voz narrativa: \"1888, en el callejón de Whitechapel...\")", etc.).
...
const PromptGenerator = () => {
  ...
  useEffect(() => {
    const key = 'huellas_master_template_v84';
